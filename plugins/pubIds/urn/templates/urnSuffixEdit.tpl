		...
		<div id="pub-id::other::urn">
			...
			{if !$excludeURN}
				...
				{elseif $storedPubId}
					...
					<p class="u-mb-16 u-mt-16">{translate key="plugins.pubIds.urn.editor.urnClear.description" pubObjectType=$translatedObjectType}</p>
				{else}
					<p class="u-mb-16 bold">
						<span class="action">{$pubIdPlugin->getPubId($pubObject, true)|escape}</span>
					</p>
					{capture assign=translatedObjectType}{translate key="plugins.pubIds.urn.editor.urnObjectType"|cat:$pubObjectType}{/capture}
					<p class="u-mb-16 u-mt-16">{translate key="plugins.pubIds.urn.editor.urnNotYetGenerated" pubObjectType=$translatedObjectType}</p>
				{/if}
				<br />
			{/if}
			...
			<p class="u-mb-24">
				...
				{capture assign=translatedObjectType}{translate key="plugins.pubIds.urn.editor.urnObjectType"|cat:$pubObjectType}{/capture}
				<span>{translate key="plugins.pubIds.urn.editor.excludePubObject" pubObjectType=$translatedObjectType}</span>
			</p>
