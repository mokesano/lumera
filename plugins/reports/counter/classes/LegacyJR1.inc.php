...
class LegacyJR1 {
     ...
     * @param array $entries
     */
    private function _formColumns(array &$cols, array $entries) {
        $allMonthsTotal = 0;
        $currTotal = 0;
        $htmlTotal = 0;
        $pdfTotal = 0;
     ...
     * @return array
     */
    private function _getMonthlyLogRange($journalId, string $begin, string $end, bool $useLegacyStats = false): array {
    ...
    /**
     * Retrieve a monthly log entry range for totals.
     * @param string $begin
     * @param string $end
     * @param bool $useLegacyStats Use the old counter plugin data.
     * @return array
     */
    private function _getMonthlyTotalRange(string $begin, string $end, bool $useLegacyStats = false): array {
