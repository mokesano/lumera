...
<script type="text/javascript">
	...
	function updateAbstractRequired() {
		var a = {/literal}{$sectionAbstractsRequired|json_encode}{literal};
	...
	<div id="submission" style="margin: 0 10px 0 10px;">
		...
		<div id="authors">
			...
			{foreach name=authors from=$authors key=authorIndex item=author}
				...
				<table width="100%" class="data">
					...
					Deklarasi di bawah). *}
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="authors-$authorIndex-creditRoles" key="author.credit.label"}</td>
						<td width="70%" class="value">
					...
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="authors-$authorIndex-biography" key="user.biography"}</td>
						<td width="70%" class="value"><textarea name="authors[{$authorIndex|escape}][biography][{$formLocale|escape}]" class="textArea" id="authors-{$authorIndex|escape}-biography" rows="5" cols="40">{$author.biography[$formLocale]|escape}</textarea>
			...
			{foreachelse}
				...
				<table width="100%" class="data">
					...
					<tr valign="top">
						...
						<td width="80%" class="value"><input type="text" class="textField" name="authors[0][orcid]" id="authors-0-orcid" size="30" maxlength="90" />
					...
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="authors-0-creditRoles" key="author.credit.label"}</td>
						<td width="70%" class="value">
							<div class="creditRolesGrid">
							{foreach from=$allCreditRoles item=roleCode}
								<label class="creditRoleOption">
					...
					{/if}
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="authors-0-biography" key="user.biography"}</td>
						<td width="70%" class="value"><textarea name="authors[0][biography][{$formLocale|escape}]" class="textArea" id="authors-0-biography" rows="5" cols="40"></textarea>
							<span class="instruct">{translate key="user.biography.description"}</span>
						</td>
					</tr>
				</table>
			...
			<table width="100%" class="data">
				{if $journal->getSetting('metaDiscipline')}
					<tr valign="top">
						...
						<td width="70%" class="value"><input type="text" class="textField" name="discipline[{$formLocale|escape}]" id="discipline" value="{$discipline[$formLocale]|escape}" size="40" maxlength="255" />
							{if $journal->getLocalizedSetting('metaDisciplineExamples')}
							<span class="instruct">{$journal->getLocalizedSetting('metaDisciplineExamples')|escape}</span>
							{/if}
						</td>
					</tr>
					<tr valign="top">
				...
				<tr valign="top">
					...
					<td width="70%" class="value"><input type="text" class="textField" name="language" id="language" value="{$language|escape}" size="5" maxlength="10" />
				...
				<tr valign="top">
					...
					<td width="70%" class="value">
						...
						{if $sponsor[$formLocale]}
							...
							Action::saveMetadata() untuk penjelasan lengkap. *}
							<br />
		...
		<div id="funders">
			...
			{foreach name=funders from=$funders key=funderIndex item=funder}
				...
				<table width="100%" class="data">
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="funders-$funderIndex-funderName" required="true" key="author.submit.funderName"}</td>
						<td width="70%" class="value"><input type="text" class="textField" name="funders[{$funderIndex|escape}][funderName]" id="funders-{$funderIndex|escape}-funderName" value="{$funder.funderName|escape}" size="40" maxlength="255" /></td>
					</tr>
					<tr valign="top">
						<td width="30%" class="label">{fieldLabel name="funders-$funderIndex-awardNumber" key="author.submit.awardNumber"}</td>
						<td width="70%" class="value"><input type="text" class="textField" name="funders[{$funderIndex|escape}][awardNumber]" id="funders-{$funderIndex|escape}-awardNumber" value="{$funder.awardNumber|escape}" size="40" maxlength="255" />
					...
					{/if}
					<tr valign="top">
						<td width="70%" class="value" colspan="2"><input type="submit" name="delFunder[{$funderIndex|escape}]" value="{translate key="author.submit.deleteFunder"}" class="button" /></td>
					</tr>
				</table>
			{foreachelse}
		...
		<div id="declarations">
			...
			<table width="100%" class="data">
				<tr valign="top">
					<td width="30%" class="label">{fieldLabel name="competingInterest" key="author.submit.competingInterestLabel"}</td>
					<td width="70%" class="value"><textarea name="competingInterest[{$formLocale|escape}]" id="competingInterest" class="textArea" rows="5" cols="60">{$competingInterest[$formLocale]|escape}</textarea></td>
				</tr>
				<tr valign="top">
					<td width="30%" class="label">{fieldLabel name="ethicalApproval" key="author.submit.ethicalApprovalLabel"}</td>
					<td width="70%" class="value"><textarea name="ethicalApproval[{$formLocale|escape}]" id="ethicalApproval" class="textArea" rows="5" cols="60">{$ethicalApproval[$formLocale]|escape}</textarea></td>
				</tr>
				<tr valign="top">
					<td width="30%" class="label">{fieldLabel name="generativeAiDeclaration" key="author.submit.generativeAiDeclarationLabel"}</td>
					<td width="70%" class="value"><textarea name="generativeAiDeclaration[{$formLocale|escape}]" id="generativeAiDeclaration" class="textArea" rows="5" cols="60">{$generativeAiDeclaration[$formLocale]|escape}</textarea></td>
				</tr>
			</table>
		</div> <!-- /declarations -->
