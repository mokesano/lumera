...
class DOIExportDom {
    ...
    /**
     * Retrieve all the publication objects containing the data required to generate the given O4DOI schema.
    ...
    /**
     * Try to translate an ISO language code to an App locale.
