...
class DOIExportDom {
     ...
     * @return array
     */
    public function retrieveArticlesByIssue($issue) {
        $cache = $this->getCache();
     ...
     * @return array
     */
    public function retrieveGalleysByArticle($article) {
        $cache = $this->getCache();
    ...
    /**
     * Try to translate an ISO language code to an Lumera locale.
     ...
     * @return string
     */
    public function getProprietaryId($journal, $issue = null, $articleOrArticleFile = null, $articleFile = null) {
     ...
     * @return array
     */
    public function getSubjectClass($article, $objectLocalePrecedence) {
        $journal = $this->getJournal();
     ...
     * @return string|null
     */
    public function getFileType($articleFile) {
