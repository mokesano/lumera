...
class DataciteDoiExportPlugin extends ImportExportPlugin {
	...
	private ?PubObjectCache $_cache = null;
	...
	/**
	 * Get a string representation of the object being exported.
	 * @param int $exportType
	 * @return string
	 */
	...
	/**
	 * Hook callback that returns the "registeredDoi" setting's name.
	...
	/**
	 * Display execution errors and command-line usage information.
	 * @param string $scriptName
