...
<footer>
    <div id="footer">
        ...
        <div id="c-journal-footer" class="u-hide">
        ...
        <div id="footer-nav" class="u-hide section">
        <div id="footer-nav-misc" class="text-xs u-padding-s-hor u-padding-m-hor-from-sm u-padding-l-hor-from-md">
            ...
            <div id="pageFooter" class="srm-footer text-xs u-padding-s-hor u-padding-m-hor-from-sm u-padding-l-hor-from-md u-padding-l-ver u-margin-l-top u-margin-xl-top-from-sm u-margin-l-top-from-md">
                ...
                <div id="standardFooter" class="srm-footer-content">
                    ...
                    {elseif $currentJournal && $currentJournal->getSetting('printIssn')}
                    	{assign var=issn value=$currentJournal->getSetting('printIssn')}
                    {/if}            
                    <p class="srm-lisensing" style="margin-bottom: 0;">{$currentJournal->getLocalizedTitle()|strip_tags|escape} {if $printIssn}{else if $onlineIssn}{if $currentJournal->getSetting('printIssn')}ISSN: <a class="anchor" href="https://issn.org/resource/issn/{$currentJournal->getSetting('printIssn')}" target="_blank"><span class="anchor-text">{$currentJournal->getSetting('printIssn')}</span></a> (Print) {/if}ISSN: {if $currentJournal->getSetting('onlineIssn')}<a class="anchor" href="https://issn.org/resource/issn/{$currentJournal->getSetting('onlineIssn')}" target="_blank"><span class="anchor-text">{$currentJournal->getSetting('onlineIssn')}</span></a> (Online){else}on proccess (Online){/if}{/if}, under the terms of the <a class="anchor" href="https://creativecommons.org/licenses/by/4.0/" target="_blank"><span class="anchor-text">Creative Commons Attribution 4.0</span></a> License.</p>
                    <span class="srm-lisensing">Powered by <a class="anchor" href="https://pkp.sfu.ca/" target="_blank"><span class="anchor-text">Public Knowledge Project (PKP)</span></a> within <a class="anchor" href="https://pkp.sfu.ca/ojs/" target="_blank"><span class="anchor-text">Open Journal System (OJS)</span></a> and <a class="anchor" href="https://github.com/masonpublishing/OJS-Theme" target="_blank"><span class="anchor-text">Mason Publishing</span></a> theme.</span>
