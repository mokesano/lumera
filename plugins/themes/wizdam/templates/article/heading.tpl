...
<header class="u-hide lm-masthead Wrapper-4206806225" role="banner">
    <div class="lm-live-area">
    	<div class="lm-column">
    		<h1 class="lm-brand"><a rel="noreferrer noopener" href="//www.sangia.org" target="_blank"><img loading="lazy" src="//www.assets.sangia.org/img/sangia_logo_dark.svg" alt="Sangia Research Media" width="140" height="40"></a></h1>
    		<nav class="lm-additional-nav u-font-sans-sang">
            <ul >
    			{if $siteCategoriesEnabled}
    			<li id="categories" class=""><a rel="noreferrer noopener" href="/">{translate key="navigation.otherJournals"}</a></li>
    			{/if}{* $categoriesEnabled *}
    			...
    			{if !$hideRegisterLink}
    			<li class="u-hide" id="userRegister"><a rel="noreferrer noopener" href="{url page="user" op="register"}" >{translate key="navigation.register"}</a></li>
    			    {/if}
        		{/if}{* $isUserLoggedIn *}
    		</ul>
		</nav>
            <form class="lm-site-search" method="GET" id="search-bar" action="{url page="search" op="search"}">
            	<div class="ms-search-field">
            		<input type="text" id="query" name="query" value="" placeholder="Search in this journal" class="lm-search-term">
            	</div>
    ...
    <div id="screen-reader-main-content" class="Toolbar medium-bar">
        <div class="toolbar-container">
        	...
        	<div class="buttons text-s">
        		...
        		<div id="download-pdf-popover" class="popover PdfDownloadButton download-pdf-popover">
        		    <div id="popover-trigger-download-pdf-popover">
        		        <button id="pdfLink" class="button button-anchor u-padding-0-left" role="button" aria-expanded="false" aria-haspopup="true" aria-label="Download PDF options" type="button">
        		            ...
        		            {if $galley && $subscriptionRequired && $showGalleyLinks && $restrictOnlyPdf}
        		            <span class="button-text"><a rel="noreferrer noopener" class="pdf-file" href="{url page="article" op="view" path=$article->getBestArticleId($currentJournal)|to_array:$galley->getBestGalleyId($currentJournal)}" target="_blank" >
        		                <span id="articleFullText" class="pdf-download-label u-show-inline-from-lg">{if $article->getAccessStatus() == $smarty.const.ARTICLE_ACCESS_OPEN || !$galley->isPdfGalley()}Download fulltext {$galley->getLabel()|escape}{else}Get Access{/if}</span>
        		                <span class="pdf-download-label-short u-hide-from-lg">{if $article->getAccessStatus() == $smarty.const.ARTICLE_ACCESS_OPEN || !$galley->isPdfGalley}Download{else}Get Access{/if}</span></a>
        		            </span>
        		            {else}
        		            <span class="button-text"><a rel="noreferrer noopener" class="pdf-file" href="{url page="article" op="view" path=$article->getBestArticleId($currentJournal)|to_array:$galley->getBestGalleyId($currentJournal)}" target="_blank">
                ...
                {elseif !$galley->isPdfGalley() && $galley->isHTMLGalley() || !$galley->isPdfGalley() && !$galley->isHTMLGalley()}
        	    ...
        	    <div id="check-access-popover" class="popover PdfDownloadButton check-access-popover">
        	       <div id="popover-trigger-check-access-popover">
        	           ...
        	           <span class="button-text">
        	               ...
        	               <span class="pdf-download-label-short u-hide-from-lg">Coming Soon!</span>
        	               {else}
        	               <a rel="noreferrer noopener" class="pdf-file" href="#" target="_blank" ><span class="pdf-download-label u-show-inline-from-lg">PDF Unavailable!</span>
	...
	<div class="sidebar">
		<div class="u-show-from-lg col-lg-6 l-side">
			...
			<div class="TableOfContents u-margin-l-bottom" lang="{$article->getLanguage()|escape}">            	
                ...
                <div id="submitter" class="cms-person author-group">
                	...
                	<div id="submitter" class="overview">
                    	 ...
                    	 <dl>{$submitterAffiliation|escape}, {$submitter->getCountry()}</dl>
			...
			<div class="TableOfContents u-margin-l-bottom" lang="{$article->getLanguage()|escape}">
			    ...
			    {if $showCoverPage || $article->getGalleys() && $galley->isHTMLGalley() && $galley->getImageFiles()}
                <div class="Figures u-mb-16" id="toc-figures">
                    <h2 class="u-h4 u-font-sans-sang">Figures</h2>
                    <ol>
                        ...
                        <li><span><div><img loading="lazy" itemprop="image" alt="Fig. {$key+1}" src="{url page="editor" op="viewFile" path=$articleId|to_array:$imageFile->getFileId()}" style="max-width: 140px; max-height: 163px;"></div></span>
                        </li>
                        {/foreach}
                        {/if}
                        <li class="hide"><span><div><img loading="lazy" itemprop="image" alt="{$article->getLocalizedCoverPageAltText()}" src="{$publicFilesDir}/{$article->getLocalizedFileName()}" style="max-width: 219px; max-height: 105px;"></div></span>
                        </li>
                    </ol>
                    {if $imageFile|@count >= 1}
                    <button class="button button-anchor" data-aa-button="sd:product:journal:article:type=menu:name=show-figures" type="button"><span class="button-text text-s">Show all figures</span><svg focusable="false" viewBox="0 0 92 128" height="20" width="17.25" class="icon icon-navigate-down"><path d="m1 51l7-7 38 38 38-38 7 7-45 45z"></path></svg></button>
                    {/if}
                </div>
                <div class="PageDivider"></div>
                {/if}
                ...
                <div id="submitter" class="p-separator cms-person author-group">
                    <h3 class="u-h5 article-span u-mb-4 u-font-sans-sang">Submitted by</h3>
                	{assign var="submitter" value=$article->getUser()}
                	{assign var=submitterFirstName value=$submitter->getFirstName()}
                    {assign var=submitterMiddleName value=$submitter->getMiddleName()}
                    {assign var=submitterLastName value=$submitter->getLastName()}
                	...
                	<div id="submitter" class="overview">
                    	 <h3 class="u-h4 u-fonts-sans" itemprop="name"><span class="u-hide text" itemprop="full-name">{$submitter->getFullName()}</span>{if $submitterFirstName !== $submitterLastName}<span class="text" itemprop="given-name">{$submitterFirstName}</span>{/if}{if $submitterMiddleName}<span class="text" itemprop="middle-name">{$submitterMiddleName}</span>{/if}<span class="text" itemprop="surname">{$submitterLastName}</span></h3>
                    	 <dl>{if $submitterAffiliation}{$submitterAffiliation}{else}<i class="text-s">Submitter Affiliation Not available</i>{/if}, {$submitterCountry}</dl>
                    	 {if $submitter->getData('orcid')}<svg viewBox="0 0 72 72" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="vertical-align: middle;" width="16" height="14"><!-- Generator: sketchtool 53.1 (72631) - https://sketchapp.com --><title>Orcid logo</title><g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="hero" transform="translate(-924.000000, -72.000000)" fill-rule="nonzero"><g id="Group-4"><g id="vector_iD_icon" transform="translate(924.000000, 72.000000)"><path d="M72,36 C72,55.884375 55.884375,72 36,72 C16.115625,72 0,55.884375 0,36 C0,16.115625 16.115625,0 36,0 C55.884375,0 72,16.115625 72,36 Z" id="Path" fill="#000" fill-opacity="0.9"></path><g id="Group" transform="translate(18.868966, 12.910345)" fill="#FFFFFF"><polygon id="Path" points="5.03734929 39.1250878 0.695429861 39.1250878 0.695429861 9.14431787 5.03734929 9.14431787 5.03734929 22.6930505 5.03734929 39.1250878"></polygon><path d="M11.409257,9.14431787 L23.1380784,9.14431787 C34.303014,9.14431787 39.2088191,17.0664074 39.2088191,24.1486995 C39.2088191,31.846843 33.1470485,39.1530811 23.1944669,39.1530811 L11.409257,39.1530811 L11.409257,9.14431787 Z M15.7511765,35.2620194 L22.6587756,35.2620194 C32.49858,35.2620194 34.7541226,27.8438084 34.7541226,24.1486995 C34.7541226,18.1301509 30.8915059,13.0353795 22.4332213,13.0353795 L15.7511765,13.0353795 L15.7511765,35.2620194 Z" id="Shape"></path><path d="M5.71401206,2.90182329 C5.71401206,4.441452 4.44526937,5.72914146 2.86638958,5.72914146 C1.28750978,5.72914146 0.0187670918,4.441452 0.0187670918,2.90182329 C0.0187670918,1.33420133 1.28750978,0.0745051096 2.86638958,0.0745051096 C4.44526937,0.0745051096 5.71401206,1.36219458 5.71401206,2.90182329 Z" id="Path"></path></g></g></g></g></g></svg><a rel="noreferrer noopener" title="Go to view {$fullname|escape} orcid-ID profile" href="{$submitter->getData('orcid')|escape}" target="_blank" class="icon extern anchor"> <span class="anchor-text">{$submitter->getData('orcid')|escape}</span></a>{esle}{/if}
            	...
            	<div id="correspondence" class="cms-person author-group">
                    <h3 class="u-h5 article-span u-mb-4 u-font-sans-sang">Correspondence</h3>
                	...
                	<div id="correspondence" class="overview">
                    	 <h3 class="author u-h4 u-fonts-sans" itemprop="name">{if $authorFirstName !== $authorLastName}<span class="text" itemprop="given-name">{$authorFirstName}</span>{/if}{if $authorMiddleName}<span class="text" itemprop="middle-name">{$authorMiddleName}</span>{/if}<span class="text" itemprop="surname">{$authorLastName}</span></h3>
                ...
                <div class="readers-over-time__StyledWrapper-t9k07n-0 dvZQao">
                    <div class="card__Container-dzzdii-1 hxUoxW">
                        <h2 data-name="readers over time-title" id="readers over time-title" class="card__StyledTitle-dzzdii-0 TaRhM u-font-sans-sang">Readers over time</h2>
                        <div class="recharts-responsive-container">
                        <script type='text/javascript' id='clustrmaps' src='//cdn.clustrmaps.com/map_v2.js?cl=cccccc&w=a&t=n&d=gMTGzEsrc5ErNZhsB9jIvjEngVXbckUKQxTUz1ZDcs8&co=ffffff&cmo=3acc3a&cmn=ff5353&ct=808080'></script>
                        </div>
                    </div>
                    <div class="p-separator PageDivider"></div>
                </div>
		...
		<div class="u-show-from-md col-lg-6 col-md-8 pad-right side-r">
			<aside class="RelatedContent c-article--view c-article--view-m">
               ...
               {if $issue && $issue->getShowTitle() && $issue->getVolume()}
                ...
                <div class="side-article-impact{if $issue && $issue->getShowTitle()} u-mt-16{/if}">
                    ...
                    <a type="button" title="Article Impact powered by Wizdom.ai" class="btn-sangia btn-default hidden-sm hidden-xs btn-impact" data-test-id="view-article-impact" href="//www.wizdom.ai/publication/{$article->getPubId('doi')}" target="_blank"><span class="icon-impact"><i class="fa fa-line-chart"></i></span> View Article Impact</a>
                </div>
                ...
                <section class="SidePanel u-margin-s-bottom u-padding-s-bottom articleInfo">
			        <details class="details-summary-2566262091"{if $issue && !$issue->getShowTitle()} open=""{/if}>
			            <summary class="details-summary-label-617948308">    
        			        <header id="citing-articles-header" class="side-panel-header">
        			            <div class="u-font-sans" type="button">
        			                <span class="button-link-text">
        			                    <h2 class="section-title u-h4 u-font-sans-sang">Article Metrics <span class="fileSize u-show-inline-from-lg">by Journal System</span></h2>
        			                </span>
        			                <svg width="32" height="32" viewBox="0 0 32 32" class="details-marker-1174223415 icon"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z"></path></svg>
        			            </div>    			            
        			        </header>
			        ...
			        <details class="details-summary-2566262091 u-margin-s-bottom">
			            <summary class="details-summary-label-617948308">    
        			        <header id="citing-articles-header" class="side-panel-header">
        			            <div class="u-font-sans" type="button">
        			                <span class="button-link-text">
        			                    <h2 class="section-title u-h4 u-font-sans-sang">Article Impact<span class="fileSize u-show-inline-from-lg"> Powered by <span class="Dimension">Dimension</span></span></h2>   
        			                </span>
        			                <svg width="32" height="32" viewBox="0 0 32 32" class="details-marker-1174223415 icon"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z"></path></svg>
        			            </div>    			            
        			        </header>
                ...
                <section class="SidePanel link externals">
			    	<div class="js-shown u-padding-s-bottom">
                        ...
                        <!-- end AddThis -->
                        {else}
			    		<h2 class="section-title u-h4 u-margin-s-bottom u-font-sans-sang">Share this article</h2>
			    ...
			    <section class="u-hide SidePanel u-margin-s-bottom">
			        <header id="recommended-articles-header" class="side-panel-header u-margin-s-bottom"><button class="button-link side-panel-toggle is-up button-link-primary" aria-expanded="true" data-aa-button="sd:product:journal:article:location=recommended-articles:type=close" type="button"><span class="button-link-text">
			            <h2 class="section-title u-h4 u-font-sans-sang">Recommended articles</h2></span><svg focusable="false" viewBox="0 0 92 128" width="17.25" height="24" class="icon icon-navigate-down"><path d="m1 51l7-7 38 38 38-38 7 7-45 45z"></path></svg></button></header>
			    ...
			    <section class="SidePanel u-margin-s-bottom details-44861495">
			        <details class="details-summary-2566262091 u-margin-s-bottom">
			            ...
			            <!-- Scopus citation -->
    			        <object class="u-margin-s-top details-summary-2566262091 metrics-details" height="50" data="https://api.elsevier.com/content/abstract/citation-count?doi={$article->getPubId('doi')}&apiKey=73e21cba2e777a3093e24a781e0ee1a9&httpAccept=text/html" title="Go to view citing articles powered by Scopus"></object>
    			        <!-- /Scopus citation -->
