...
{if (!$article->getHideAuthor() == !$smarty.const.AUTHOR_TOC_DEFAULT) || $article->getHideAuthor() == !$smarty.const.AUTHOR_TOC_SHOW}{foreach name="authors" from=$article->getAuthors() item=author}
...
{if $article->getLocalizedAbstract()}
	<meta name="citation_description" content="{$article->getLocalizedAbstract()|strip_tags|nl2br|escape}" />
{/if}
...
{if $article->getPages()}
	...
	{/if}
{else}
    <meta name="citation_firstpage" content="{$article->getID()|escape|string_format:"%07d"}"/>
{/if}
