...
{foreach name=checklist from=$submissionChecklist[$formLocale] key=checklistId item=checklistItem}
	...
	<tr valign="top">
		...
		<td width="85%" class="value"><textarea name="submissionChecklist[{$formLocale|escape}][{$checklistId|escape}][content]" id="submissionChecklist-{$checklistId|escape}" rows="3" cols="40" class="textArea" width="100%">{$checklistItem.content|escape}</textarea></td>
