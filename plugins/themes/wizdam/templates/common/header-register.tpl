...
<div id="body" class="sangia">

{if $leftSidebarCode || $rightSidebarCode}
	<div id="sidebar">
		{if $leftSidebarCode}
			<div id="leftSidebar" class="slide" role="complementary"></div>
		{/if}
		{if $rightSidebarCode}
			<div id="rightSidebar" class="slide" role="complementary">
				{include file="common/submit.tpl"}
				<div class="c-separator c-separator--top c-separator--heavy" itemscope="" itemtype="http://schema.org/Organization">
					...
					<ul class="c-list-group c-list-group--bordered c-list-group c-list-group--md">
						<li class="c-list-group__item">
							<a href="mailto:admin@stipwunaraha.ac.id" itemprop="email">admin@stipwunaraha.ac.id</a>
						</li>
						<li class="c-list-group__item">
							<a href="https://www.biomedcentral.com/about/contact-us" target="_blank">Get more details</a>
						</li>
					</ul>
				</div>
			</div>
...
<div id="main" class="content-registerForm" role="main" tabindex="-1">
...
<div id="content" class="content-registerForm" >
