...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$baseUrl}/plugins/themes/stipwunaraha/css/modern-forms.css" />
...
<div class="journal-page sangia">
<div class="live-area-wrapper">
	<div class="row">

    {if $leftSidebarCode || $rightSidebarCode}
	<section class="sidebar c-header__side">
		
		{if $rightSidebarCode}
			<aside class="column medium-5" role="complementary">
			    
				{** include file="common/submit.tpl" **}
				
				<div class="c-separator c-separator--heavy" itemscope="" itemtype="http://schema.org/Organization">
					<h3 class="p-section-title">
						Contact <span itemprop="department">Support Team</span>
					</h3>
					<ul class="c-list-group c-list-group--bordered c-list-group c-list-group--md">
						<li class="c-list-group__item">
							<a href="mailto:admin@sangia.org" itemprop="email">admin@sangia.org</a>
						</li>
						<li class="c-list-group__item">
    ...
    <div id="main" class="column {if $pageTitle == 'user.login' || $currentPage == 'login'}medium-5{else}medium-6{/if} content-registerForm" role="main" tabindex="-1">
        ...
        <div id="content" class="content welcome content-registerForm" >
