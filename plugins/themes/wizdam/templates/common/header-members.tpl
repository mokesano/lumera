...
<head>
	...
	<style rel="stylesheet" type="text/css">@import url(//www.assets.sangia.org/css/subscribe.css);</style>
...
<body id="sangia" class="members subscribe">
