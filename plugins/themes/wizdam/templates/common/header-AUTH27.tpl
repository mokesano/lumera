...
<head>
    <title>{$firstName|escape} {if $middleName} {$middleName|escape}{/if} {$lastName|escape}  - {$currentJournal->getLocalizedTitle()|strip_tags|escape} | Sangia</title>
    ...
    <div class="author-content" role="main">
        <div class="live-area-wrapper">
            <div class="profile row">
                <div class="column medium-2 null">
                	<div class="jUaFts">
