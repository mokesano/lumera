	...
	<div class="row">
	    ...
	    <div class="sidebar">
    		...
    		<div class="column medium-3">
				<section class="box">
					<section><h4 class="headline-524909129">Want discussion with us?</h4></section>
					<a href="{url page="submission" op="submit"}" target="_blank" data-track="click" class="button-base-2906877647">
						<span class="button-label-1281676810">Go to Discussion Forum</span>
	        ...
	        {if $rightSidebarCode}
			<aside class="column medium-3 u-hide">
				<section class="box">
					<section><h4 class="headline-524909129">Want discussion with us?</h4></section>
					<a href="{url page="submission" op="submit"}" target="_blank" data-track="click" class="button-base-2906877647">
						<span class="button-label-1281676810">Go to Discussion Forum</span>
