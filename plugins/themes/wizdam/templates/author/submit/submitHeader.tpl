...
<div class="pseudoMenu">
    <ul class="steplist menu">
        ...
        {translate key="author.submit.stepLabel.metadata"}{if $submitStep != 1 && $submissionProgress >= 1}</a>{/if}</li>
        ...
        {translate key="author.submit.stepLabel.authors"}{if $submitStep != 2 && $submissionProgress >= 2}</a>{/if}</li>
        ...
        {translate key="author.submit.stepLabel.declarations"}{if $submitStep != 3 && $submissionProgress >= 3}</a>{/if}</li>
        ...
        {translate key="author.submit.stepLabel.upload"}{if $submitStep != 4 && $submissionProgress >= 4}</a>{/if}</li>
        ...
        {translate key="author.submit.stepLabel.overview"}{if $submitStep != 5 && $submissionProgress >= 5}</a>{/if}</li>
    </ul>
</div>