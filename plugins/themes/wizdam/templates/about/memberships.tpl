            ...
            <dl class="MetaGrid-2932877531">
                <div data-section-outline-level="3"class="Type-270967514" data-section-layout-level="1">
                    ...
                    <dd data-section-outline-level="3">
						...
						{if $currentJournal->getSetting('onlineIssn')}<span class="item">{$currentJournal->getSetting('onlineIssn')} (Online)</span>{else}<span class="item">on proccess (Online)</span>{/if}
						{/if}
                ...
                <div data-section-outline-level="3" class="Type-2225587032" data-section-layout-level="1">
                    <dt data-section-outline-level="3"><b data-section-outline-level="3">{translate key="about.membersLength"}:</b>
                    </dt>
                    ...
                    <dd data-section-outline-level="3" data-section-layout-level="1">1 Year {$membershipFeeName|escape} with {$issuePerVolume|escape} Issues (plus online access to all articles starting {$firstYear|escape})</dd>
                </div>
                <div data-section-outline-level="3" class="Type-1803463199" data-section-layout-level="1">
                    ...
                    <dd data-section-outline-level="3" data-section-layout-level="1">{if $onlineIssn} {else if $printIssn}{if $currentJournal->getSetting('onlineIssn')}Online{/if}{/if}{if $currentJournal->getSetting('printIssn')} &amp; Print{/if}</dd>
                </div>         
            </dl>
        </div>
    </div>
            ...
            <details data-section-outline-level="2" class="Details-2932877531" data-section-layout-level="2" open="">
                <summary class="subscription-type NoneDetailsMarker-270967514" data-section-outline-level="2" data-section-layout-level="2">
                    <div data-section-outline-level="2" class="SummaryStyle-2218521826" data-section-layout-level="2"><svg width="14px" height="14px" viewBox="0 0 32 32" class="details-marker Marker-1664207171" data-section-outline-level="2" data-section-layout-level="2"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z" data-section-outline-level="2" data-section-layout-level="2"></path></svg>
                        <span data-section-outline-level="2" class="SubscriptionName-411063136" data-section-layout-level="2">{translate key="about.memberships"}</span>
                        <span data-section-outline-level="2" class="SummaryPrice-3689769601" data-section-layout-level="2">{$membershipFee|string_format:"%.2f"|number_format:2:",":"."}&nbsp;{$currency|escape}</span>
                    </div>
                </summary>
                <article data-section-outline-level="3" data-section-layout-level="2">
                    <div class="input-field PriceInfoBox-2218521826 checked" style="position: relative" data-section-outline-level="3" data-section-layout-level="3"><input type="radio" id="input-PS-Journal-subscription" class="radio-checked RadioCircle-1664207171" name="subscription-type" value="PS" checked="checked" style="display: none" data-original-index="0" data-section-outline-level="3" data-section-layout-level="4">
                        <label class="price-info Flex-411063136" for="input-PS-Journal-subscription" data-section-outline-level="3" data-section-layout-level="3">
                            <div class="prices-total  TotalPriceRow-3898465696" data-section-outline-level="3" data-section-layout-level="3">
                                <div data-section-outline-level="3" class="Type-3344151041" data-section-layout-level="3">{if $onlineIssn} {else if $printIssn}{if $currentJournal->getSetting('onlineIssn')}Online{/if}{/if}</div>
                                <div id="effective-price" data-section-outline-level="3" class="BasketEffectivePriceCell-538306978" data-section-layout-level="3">{$membershipFee|string_format:"%.2f"|number_format:2:",":"."}&nbsp;{$currency|escape}</div>
                                <div class="single-issue BasketRegularPriceCell-3978918244" data-section-outline-level="3" data-section-layout-level="3">only {math|number_format:2:",":"." equation="x / y" x=$membershipFee|string_format:"%.2f" y=$issuePerVolume|escape}&nbsp;{$currency|escape} per issue</div>
                            </div>
                        </label>
                    </div>
                    ...
                    <ul class="usps-list ListInset-3866894855" id="usps" data-section-outline-level="4" data-section-layout-level="2">
            			...
            			{assign var=issuePerVolume value=$currentJournal->getSetting('issuePerVolume')}
            			{assign var=firstYear value=$currentJournal->getSetting('initialYear')}
                        <li data-section-outline-level="4" class="ListElement-1282713543" data-section-layout-level="2">1 Year {$membershipFeeName|escape} with {$issuePerVolume|escape} Issues (plus online access to all articles starting {$firstYear|escape})</li>
                    </ul>
                </article>
            </details>
        </form>
...
<section class="SubscriberFooter-1037694867">
    <div class="GridLiveArea-2081012695">
        ...
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 data-section-outline-level="3" class="Type-1552298965" data-section-layout-level="2">{$membershipFeeName|escape}</h3>
            <p data-section-outline-level="3" class="Type-2407621270" data-section-layout-level="2">{$membershipFeeDescription|nl2br}</p>
            <p data-section-outline-level="3" class="FooterLink-269378647" data-section-layout-level="2">Find out more: <a href="#" data-section-outline-level="3" data-section-layout-level="2">sangia.org/librarian</a></p>
        </section>
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 data-section-outline-level="3" class="Type-1552298965" data-section-layout-level="2">Foreign transaction fees</h3>
            <p data-section-outline-level="3" class="Type-2407621270" data-section-layout-level="2">If you use a debit or credit card to pay for Sangia Research Media & Publishing {$membershipFeeName|escape} you may be charged a Foreign Purchase Fee by your bank or card issuer.</p>
