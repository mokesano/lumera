    ...
    <div class="c-header__container" data-test="navigation-row">
        <div class="c-header__split">
            <div class="c-header__split">
                <ul class="c-header__menu c-header__menu--journal lm-nav-root">
                    <li class="c-header__item c-header__item--dropdown-menu">
                        ...
                        <nav id="explore" class="u-hide-print c-header-expander has-tethered lm-nav-sub" aria-labelledby="Explore-content" data-test="Explore-content" data-track-component="nature-150-split-header" hidden="">
                            <div class="c-header-expander__container">
                                ...
                                <ul class="c-header-expander__list">
                                    ...
                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url op="category" path=$category->getId()}" data-track="click" data-track-label="link" data-test="explore-nav-item">{$category->getLocalizedName()|escape}</a> ({$categoryArray.journals|@count})</li>
                                    {/foreach}

                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url page="index"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="navigation.home"}</a></li>
                                            		
                                    {if $siteCategoriesEnabled}
                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url journal="index" page="search" op="categories"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="navigation.categories"}</a></li>
                                    {/if}{* $categoriesEnabled *}
                                        
                                    {if $currentJournal && $currentJournal->getSetting('publishingMode') != $smarty.const.PUBLISHING_MODE_NONE}
                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url page="issue" op="archive"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="navigation.categories.browse"}</a></li>
                                    {/if}
                                        
                                    {if $enableAnnouncements}
                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url page="announcement"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="announcement.announcements"}</a></li>
                                    {/if}{* enableAnnouncements *}
                                        
                                    <li class="u-hide c-header-expander__item"><a class="c-header-expander__link" href="{url page="browseSearch" op="identifyTypes"}" data-track="click" data-track-label="link" data-test="explore-nav-item">View Article Type</a></li>
                    ...
                    <li class="c-header__item c-header__item--dropdown-menu">
                        ...
                        <nav id="explore" class="u-hide-print c-header-expander has-tethered lm-nav-sub" aria-labelledby="Explore-content" data-test="Explore-content" data-track-component="sangia-150-split-header" hidden="">
                            <div class="c-header-expander__container">
                                ...
                                <ul class="c-header-expander__list">
                                    <li class="c-header-expander__item"><a class="c-header-expander__link" href="{url page="about"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="navigation.about"}</a></li>
                                    ...
                                    {if $siteCategoriesEnabled}
                                    <li class="c-header-expander__item c-header-expander__item--keyline c-header-expander__item--keyline-first-item-only u-hide-at-lg"><a class="c-header-expander__link" href="{$oaiUrl}" data-track="click" data-track-action="OAI feed" data-track-label="link" target="_blank"><span>{translate key="navigation.otherJournals"}</span></a></li>
                                    {/if}{* $categoriesEnabled *}
                                </ul>
                            </div>
                        </nav>
            ...
            <ul class="c-header__menu c-header__menu--tools">
                ...
                <li class="u-hide c-header__item c-header__item--pipe">
