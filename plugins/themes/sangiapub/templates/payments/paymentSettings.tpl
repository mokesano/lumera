...
<div id="paymentSettings">
    ...
    <form name="paymentSettingsForm" method="post" action="{url op="savePaymentSettings"}">
        ...
        <div id="tax-discount" class="block">
            <h3>{translate key="manager.payment.taxDiscount"}</h3>
            <p>{translate key="manager.payment.taxDiscount.description"}</p>
            {* --- [WIZDAM UX] GLOBAL TAX & DISCOUNT SETTINGS --- *}
            <table width="100%" class="settings">
                <thead>
                    <th width="20%">{translate key="manager.payment.taxDiscount"}</th>
                    <th width="80%">{translate key="manager.payment.taxDiscount.description"}</th>
                </thead>
                <tr>
                    <td class="label" width="20%">{translate key="manager.payment.taxRate"}</td>
                    <td class="value" width="80%">
                        <input type="text" class="textField" name="paymentTax" id="paymentTax" size="10" value="{$paymentTax|escape}" />
                        <br />
                        <input type="checkbox" name="paymentTaxInclusive" id="paymentTaxInclusive" value="1" {if $paymentTaxInclusive}checked="checked"{/if} />
                        <label for="paymentTaxInclusive">{translate key="manager.payment.taxInclusive"}</label>
                        <span class="instruct">{translate key="manager.payment.taxRate.instruct"}</span>
                    </td>
                </tr>
                <tr>
                    <td class="label" width="20%">{translate key="manager.payment.discountNominal"}</td>
                    <td class="value" width="80%">
                        <input type="text" class="textField" name="paymentDiscount" id="paymentDiscount" size="20" value="{$paymentDiscount|escape}" />
                        <span class="instruct">{translate key="manager.payment.discount.instruct"}</span>
                    </td>
                </tr>
            </table>
            {* --- END WIZDAM UX --- *}
