{**
 * templates/document/loa/loaIndex.tpl
 *
 ...
 *}
{strip}
    {assign var="pageTitle" value="billing.loa.indexTitle"}
...
<table class="wizdam-table" width="100%" style="border-collapse: collapse;">
    ...
    <tbody>
        ...
        {foreachelse}
            <tr><td colspan="4" style="padding: 20px; text-align: center; color: #666;">{translate key="document.index.loaEmpty"}</td></tr>
        {/foreach}
    </tbody>
</table>
