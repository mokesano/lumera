...
<form id="enroll" onsubmit="return enrollUser(0)" action="{if $roleId}{url op="enroll" path=$roleId}{else}{url op="enroll"}{/if}" method="post">
	...
	<div id="users">
		<table width="100%" class="listing">
			...
			{if $users->eof()}
			<tr><td colspan="5" class="end separator">&nbsp;</td></tr>
			{/if}
			{/iterate}
			{if $users->wasEmpty()}
				<tr>
