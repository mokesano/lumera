...
<input type="button" value="{translate key="manager.groups.membership.addMember"}" class="button" onclick="document.location.href='{url op="addMembership" path=$group->getId()}'" />
</div>
