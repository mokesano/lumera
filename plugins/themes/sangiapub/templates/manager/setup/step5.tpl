...
<form id="setupForm" method="post" action="{url op="setup" path="5"}" enctype="multipart/form-data">
	...
	<div id="journalHomepageHeader" class="block">
		...
		<div id="journalTitleAndLogo">
			...
			{if $homeHeaderTitleImage[$formLocale]}
				...
				<img src="{$publicFilesDir}/{$homeHeaderTitleImage[$formLocale].uploadName|escape:"url"}" width="{$homeHeaderTitleImage[$formLocale].width|escape}" height="{$homeHeaderTitleImage[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.homePageHeader.altText"}" />
				<br />
				<table width="100%" class="data">
					<tr valign="top">
		...
		<div id="journalLogoImage">
			...
			{if $homeHeaderLogoImage[$formLocale]}
				...
				<br />
				<img src="{$publicFilesDir}/{$homeHeaderLogoImage[$formLocale].uploadName|escape:"url"}" width="{$homeHeaderLogoImage[$formLocale].width|escape}" height="{$homeHeaderLogoImage[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.homePageHeaderLogo.altText"}" />
				<br />
				<table width="100%" class="data">
					<tr valign="top">
	...
	<div id="journalHomepageContent" class="block">
		...
		<div id="journalDescription">
			...
			<p><textarea id="description" name="description[{$formLocale|escape}]" rows="12" cols="60" class="textArea">{$description[$formLocale]|escape}</textarea></p>
		</div>
	...
	<div id="journalPageHeaderInfo" class="block">
		...
		<div id="pageHeaderTitle">
			...
			{if $pageHeaderTitleImage[$formLocale]}
				...
				<img src="{$publicFilesDir}/{$pageHeaderTitleImage[$formLocale].uploadName|escape:"url"}" width="{$pageHeaderTitleImage[$formLocale].width|escape}" height="{$pageHeaderTitleImage[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.pageHeader.altText"}" />
				<br />
				<table width="100%" class="data">
					<tr valign="top">
		...
		<div id="journalLogo">
			...
			{if $pageHeaderLogoImage[$formLocale]}
				...
				<br />
				<img src="{$publicFilesDir}/{$pageHeaderLogoImage[$formLocale].uploadName|escape:"url"}" width="{$pageHeaderLogoImage[$formLocale].width|escape}" height="{$pageHeaderLogoImage[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.pageHeaderLogo.altText"}" />
				<br />
				<table width="100%" class="data">
					<tr valign="top">
		...
		<div id="journalFavicon">
			...
			<table width="100%" class="data">
				<tr valign="top">
					<td width="20%" class="label">{translate key="manager.setup.useImageLogo"}</td>
					<td width="80%" class="value">
						<input type="file" name="journalFavicon" class="uploadField" />
						<input type="submit" name="uploadJournalFavicon" value="{translate key="common.upload"}" class="button" />
					</td>
				</tr>
			</table>
...
</div>{** Close content div opened in setup.tpl **}
