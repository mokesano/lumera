...
<form id="setupForm" method="post" action="{url op="setup" path="2"}">
	...
	<div id="peerReviewPolicy" class="block">
		...
		<div id="reviewOptions" class="block">
			...
			<p>
				...
				{translate key="manager.setup.reviewOptions.numWeeksPerReview"}: <input type="text" name="numWeeksPerReview" id="numWeeksPerReview" value="{$numWeeksPerReview|escape}" size="2" maxlength="8" class="textField" /> {translate key="common.weeks"}
			</p>
