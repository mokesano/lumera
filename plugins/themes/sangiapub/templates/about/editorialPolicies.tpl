...
<ul class="c-nav-menu">
	{if $currentJournal->getLocalizedSetting('focusScopeDesc') != ''}<li id="linkFocusScopeDesc" class="c-nav__link"><a href="{url op="editorial-policies" anchor="focusAndScope"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.focusAndScope"}</a></li>{/if}
	<li id="linkEditorialPolicies" class="c-nav__link"><a href="{url op="editorial-policies" anchor="sectionPolicies"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.sectionPolicies"}</a></li>
	{if $currentJournal->getLocalizedSetting('reviewPolicy') != ''}<li id="linkReviewPolicy" class="c-nav__link"><a href="{url op="editorial-policies" anchor="peerReviewProcess"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.peerReviewProcess"}</a></li>{/if}
	{if $currentJournal->getLocalizedSetting('pubFreqPolicy') != ''}<li id="linkPubFreqPolicy" class="c-nav__link"><a href="{url op="editorial-policies" anchor="publicationFrequency"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.publicationFrequency"}</a></li>{/if}
	{if $currentJournal->getSetting('publishingMode') == $smarty.const.PUBLISHING_MODE_OPEN && $currentJournal->getLocalizedSetting('openAccessPolicy') != ''}<li id="linkOpenAccessPolicy" class="c-nav__link"><a href="{url op="editorial-policies" anchor="openAccessPolicy"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.openAccessPolicy"}</a></li>{/if}
	{if $currentJournal->getSetting('publishingMode') == $smarty.const.PUBLISHING_MODE_SUBSCRIPTION}
		{if $currentJournal->getSetting('enableAuthorSelfArchive')}<li id="linkenabledAuthorSelfArchive" class="c-nav__link"><a href="{url op="editorial-policies" anchor="authorSelfArchivePolicy"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.authorSelfArchive"}</a></li>{/if}
		{if $currentJournal->getSetting('enableDelayedOpenAccess')}<li id="linkenabledDelayedOpenAccess" class="c-nav__link"><a href="{url op="editorial-policies" anchor="delayedOpenAccessPolicy"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.delayedOpenAccess"}</a></li>{/if}
		{if $paymentConfigured && $currentJournal->getSetting('journalPaymentsEnabled') && $currentJournal->getSetting('acceptSubscriptionPayments') && $currentJournal->getSetting('purchaseIssueFeeEnabled') && $currentJournal->getSetting('purchaseIssueFee') > 0}<li id="linkpurchaseIssue" class="c-nav__link"><a href="{url op="editorial-policies" anchor="purchaseIssue"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.purchaseIssue"}</a></li>{/if}
	...
	{/if}
	{if $currentJournal->getSetting('enableLockss') && $currentJournal->getLocalizedSetting('lockssLicense') != ''}<li id="linkLockssLicense" class="c-nav__link"><a href="{url op="editorial-policies" anchor="archiving"}" data-track="click" data-track-label="link" data-test="explore-nav-item">{translate key="about.archiving"}</a></li>{/if}
	{foreach key=key from=$currentJournal->getLocalizedSetting('customAboutItems') item=customAboutItem}
		{if !empty($customAboutItem.title)}
			<li id="link{$customAboutItem.title|replace:" ":""|escape}" class="c-nav__link"><a href="{url op="editorial-policies" anchor=$customAboutItem.title|replace:" ":""|escape}" data-track="click" data-track-label="link" data-test="explore-nav-item">{$customAboutItem.title|escape}</a></li>
		{/if}
	{/foreach}
</ul>
...
<section class="content u-mt-48">
	{if $currentJournal->getLocalizedSetting('focusScopeDesc') != ''}
		<div id="focusAndScope" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.focusAndScope"}</h2>
									...
									<li id="SE-{$sectionEditor->getId()|string_format:"%07d"}" class="app-editor-row__item editor-member">
										<div class="sangia-editor--profile member editor">
											<div class="section-editor-avatar cms-person">
												...
												{else}
												<picture>
													<source {if $sectionEditor->getGender() == "M"}srcset="{$baseUrl}/assets/img/contactPersonM.png?as=webp"{elseif $sectionEditor->getGender() == "F"}srcset="{$baseUrl}/assets/img/contactPersonF.png?as=webp"{elseif $sectionEditor->getGender() == "O"}srcset="//scholar.google.co.id/citations/images/avatar_scholar_128.png?as=webp"{elseif $sectionEditor->getGender() == ""}srcset="//loop.frontiersin.org/images/profile/479531/203?as=webp"{/if} type="image/webp">
													<img class="lazyload editor sangia-author" loading="lazy" id="editor-{$sectionEditor->getId()|string_format:"%07d"}" title="{$sectionEditor->getFullName()|escape}" {if $sectionEditor->getGender() == "M"}src="{$baseUrl}/assets/img/contactPersonM.png"{elseif $sectionEditor->getGender() == "F"}src="{$baseUrl}/assets/img/contactPersonF.png"{elseif $sectionEditor->getGender() == "O"}src="//scholar.google.co.id/citations/images/avatar_scholar_128.png"{elseif $sectionEditor->getGender() == ""}src="//loop.frontiersin.org/images/profile/479531/203"{/if} width="100" height="auto">
												</picture>	    			
												{/if}
											</div>
										</div>
	...
	{if $currentJournal->getLocalizedSetting('reviewPolicy') != ''}
		<div id="peerReviewProcess" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.peerReviewProcess"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header>
	...
	{if $currentJournal->getLocalizedSetting('pubFreqPolicy') != ''}
		<div id="publicationFrequency" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.publicationFrequency"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header>
	...
	{if $currentJournal->getSetting('publishingMode') == $smarty.const.PUBLISHING_MODE_OPEN && $currentJournal->getLocalizedSetting('openAccessPolicy') != ''} 
		<div id="openAccessPolicy" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.openAccessPolicy"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header>
	...
	{if $currentJournal->getSetting('publishingMode') == $smarty.const.PUBLISHING_MODE_SUBSCRIPTION && $currentJournal->getSetting('enableAuthorSelfArchive')} 
		<div id="authorSelfArchivePolicy" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.authorSelfArchive"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header> 
	...
	{if $currentJournal->getSetting('publishingMode') == $smarty.const.PUBLISHING_MODE_SUBSCRIPTION && $currentJournal->getSetting('enableDelayedOpenAccess')}
		<div id="delayedOpenAccessPolicy" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.delayedOpenAccess"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header> 
	...
	{if $currentJournal->getSetting('enableLockss') && $currentJournal->getLocalizedSetting('lockssLicense') != ''}
		<div id="archiving" class="block">
			<header class="c-anchored-heading">
				<h2>{translate key="about.archiving"}</h2>
				<a class="c-anchored-heading__helper" href="#menu">Back to top</a>
			</header>
