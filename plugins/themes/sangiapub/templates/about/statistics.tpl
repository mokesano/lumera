...
{/strip}
    ...
    {include file="common/featured/journal-timeline.tpl"}
    
    </div>
</div>

<div class="column medium-12 u-mt-48">
    {include file="common/featured/ArticleHeroAnalize.tpl"}
</div>
...
{include file="common/footer-parts/footer-general.tpl"}
