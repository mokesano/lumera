...
<form id="settings" method="post" action="{url op="saveSettings"}" enctype="multipart/form-data">
	...
	<div class="card-info">
		<h4>{fieldLabel name="formLocale" key="form.formLanguage"}</h4>
	...
	<div class="card-info">
		<h4 {if $pageHeaderTitleType[$formLocale] && $pageHeaderTitleImage[$formLocale]}rowspan="4"{else}rowspan="3"{/if}  class="label">{fieldLabel name="title" key="admin.settings.siteTitle" required="true"}</h4>
		<table class="data" width="100%">
			<tr valign="top">
	...
	<div class="card-info">
		<h4 class="label">{fieldLabel name="intro" key="admin.settings.introduction"}</h4>
		<table class="data" width="100%">
			<tr valign="top">
	...
	<div class="card-info">
		<h4 class="label">{fieldLabel name="redirect" key="admin.settings.journalRedirect"}</h4>
		<table class="data" width="100%">
			<tr valign="top">
	...
	<div class="card-info">
		<h4 class="label">{fieldLabel name="aboutField" key="admin.settings.aboutDescription"}</h4>
		<table class="data" width="100%">
			<tr valign="top">
	...
	<br />
	<div id="defaultMetricSelection" class="block">
