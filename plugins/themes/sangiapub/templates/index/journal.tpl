									...
									<div class="c-card c-card--flush u-full-height">
										<a class="c-card__image" href="{url page="issue" op="current"}" data-track="click" data-track-action="view current issue" data-track-label="image">
											...
											{elseif $displayHomepageImage && is_array($displayHomepageImage)}
												<picture>
													<source type="image/webp" srcset="{$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}?as=webp 450w, {$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}?as=webp 735w" sizes="(max-width: 1024px) 450px,(max-width: 100vw) 735px 735px">
													<img class="lazyload" loading="lazy" src="{$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}" alt="">
												</picture>
											{else}
												<picture>
						...
						<div class="row">
							<div class="columns medium-8" role="main">
									...
									<div class="column {if $issue}medium-8{else}medium-12{/if} insight">
										<ul class="journalinsights u-mb-16 u-fonts">
											...
											{if $currentJournal->getSetting('initials')}
												<li class="meta"><span class="c-meta__item"><span class="bold">Journal Initials:</span> {$currentJournal->getLocalizedInitials()|strip_tags|escape}</li></span>
											{/if}
											{if $currentJournal->getSetting('abbreviation')}
												<li class="meta"><span class="c-meta__item"><span class="bold">Abbreviation:</span> <span class="italic">{$currentJournal->getSetting('abbreviation', $currentJournal->getPrimaryLocale())}</span></span></li>
											{/if}
								...
								{if $currentJournal->getLocalizedSetting('history') != ''}
									<div id="journal-history-link" class="u-mb-32"><span class="icon-container info">This journal was previously published under other titles <a href="{url page="about" op="history" anchor=""}">(view Journal {translate key="about.history"})</a></span></div>
								{/if}
	...
	<div class="live-area">
		<section class="row raw">
			...
			<section class="medium-8 teaser-navigation" role="main">
				...
				<section class="column medium-3">
					...
					<nav class="journal-subnav journal-subnav--1">
						<div class="live">
							<ul class="ul">
								<li class="sub_menu"><a class="anchor" href="{url page="submission" op="submit"}"><span class="anchor-text">Submit your Paper</span></a></li>
			...
			<aside class="sangia-aside column medium-4">
				...
				{if $issue && $currentJournal->getSetting('publishingMode') != $smarty.const.PUBLISHING_MODE_NONE}
					<section class="sign-up-form box2-321956623 box">
						<div>
...
</div>{* END tag class journal-page *}
			    ...
			    <div class="columns small-12 ">
					<div class="cms-collection-list">
						<ul class="small-block-grid-1 medium-block-grid-3">
							<li>
								<div id="id19" class="">
									<a class="cms-teaser-text" href="{url page="about" op="editorialTeam"}" target="_blank">
										<div class="cms-teaser-box cms-teaser-box-with-icon cms-teaser-box-titled-icon" data-mh="mh-id3" >
							...
							<li>
								<div id="id1a" class="">
									<a class="cms-teaser-text" href="//twitter.com/SangiaNews" target="_blank">
										<div class="cms-teaser-box cms-teaser-box-with-icon" data-mh="mh-id3" >
											<div class="article-meta"></div>
											<div class="cms-font-icon">1</div>
											<h3>Follow @Sangia_Publishing</h3>
											<p>Follow Sangia Publishing Journals</p>
										</div>
									</a>
								</div>
							</li>
								...
								<div id="id1b" class="">
									<a class="cms-teaser-text" href="//www.facebook.com/sangiapublishing" target="_blank">
										<div class="cms-teaser-box cms-teaser-box-with-icon" data-mh="mh-id3" >
											...
											<p>Follow Fanpage Sangia Publishing group</p>
										</div>
									</a>
								</div>
							</li>
