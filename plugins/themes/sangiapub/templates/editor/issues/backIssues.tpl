...
{if $usesCustomOrdering}
	...
	<p class="info-message u-mb-8 u-mt-8">{translate key="editor.issues.resetIssueOrder" url=$resetUrl}</p>
{/if}
...
<table id="colspan-anchor" width="100%" style="margin-top: .7em">
	<tr >
		<td class="anchor" colspan="2" align="left">{page_info iterator=$issues}</td>
		<td class="anchor" colspan="3" align="right" style="text-align: right;">{page_links anchor="issues" name="issues" iterator=$issues}</td>
	</tr>
</table>
{/if}
