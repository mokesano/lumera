 ...
 *}
{strip}
    {assign var="pageTitleTranslated" value="Most Cited Article"}
    ...
    <div class="row raw">
        <div id="articles-cited" class="c-article-most__popular">
            <div class="u-container c-slice-heading">
                ...
                <span class="u-display-block u-font-sans">Last update: {if $lastUpdateDate}{$lastUpdateDate|date_format:"%d %B %Y, %H:%M"}{else}N/A{/if}. (Smart detection updates. Regular updates weekly.)</span>
            </div>
        </div>
