{**
 * templates/common/trend/trendsArticlePublisher.tpl
 *
 * Copyright (c) 2018-2026 Sangia Publishing House
 * Copyright (c) 2018-2026 Rochmady andTeam
 * Distributed under the GNU GPL v3.
 *
 * Trends Articles in Publisher
 *
 *}
<section id="latest-popular" class="live-area u-mb-48" data-track-component="latest popular grid" >
    <div class="row raw">
