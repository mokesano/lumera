 ...
 *}
    ...
    <footer class="composite-layer" role="contentinfo">
        ...
        <div itemscope="" itemtype="http://schema.org/Periodical">
            {if $currentJournal}
                {assign var="publisherName" value=$currentJournal->getSetting('publisherInstitution')}
            {else}
                {assign var="publisherName" value=$siteTitle}
            {/if}
    ...
    <script type="text/javascript" src="{$baseUrl}/assets/js/sintaScore.js"></script>
    <script type="text/javascript" src="{$baseUrl}/assets/js/lazyload.js"></script>
    <script type="text/javascript" src="{$baseUrl}/assets/js/editorgender.js"></script>
    <script type="text/javascript" src="{$baseUrl}/assets/js/sangiastyle.js"></script>
