{**
 * templates/common/footer-parts/footer-login.tpl
 *
 ...
 *}
    ...
    <footer class="composite-layer" role="contentinfo">
        ...
        {if $homepageImage && !$setupStep}
            ...
            <div class="u-mt-16 u-mb-16">
                <div class="u-container">
                    <p class="c-meta u-ma-0">Top headline image: {if $homepageImageAltText != ''}{$homepageImageAltText|escape}{else}{translate key="common.journalHomepageImage.altText"}{/if}</p>
                </div>
            </div>
            {/if}
        {/if}
