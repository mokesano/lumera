...
{**
 * @file templates/common/header-PROF27.tpl
 *
...
{/strip}
<head>
    <title>{if $user->getSalutation()}{$user->getSalutation()|escape} {/if}{if $user->getFirstName() !== $user->getLastName()}{$user->getFirstName()|escape} {/if}{if $user->getMiddleName()}{$user->getMiddleName()|escape} {/if}{$user->getLastName()|escape}{if $user->getSuffix()}, {$user->getSuffix()|escape}{/if} | Sangia Publishing</title>
...
<body id="sangia.org" class="sangiaorg">
