    ...
    <div id="articles-downloaded" class="c-article-most__downloaded">
        <div class="u-container c-section-heading c-slice-heading">
            <h2 class="titles u-ma-0">
                ...
                <a class="c-section-heading__link" data-track="click" data-track-action="view all" data-track-label="button" href="{url page="trends" op="download"}"><svg class="c-section-heading__icon" aria-hidden="true" focusable="false" height="20" width="20" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="m4.08573416 5.70052374 2.48162731-2.4816273c.39282216-.39282216 1.02197315-.40056173 1.40306523-.01946965.39113012.39113012.3914806 1.02492687-.00014045 1.41654791l-4.17620791 4.17620792c-.39120769.39120768-1.02508144.39160691-1.41671995-.0000316l-4.17639421-4.1763942c-.39122513-.39122514-.39767006-1.01908149-.01657797-1.40017357.39113012-.39113012 1.02337105-.3930364 1.41951348.00310603l2.48183447 2.48183446.99770587 1.01367533z" transform="matrix(0 -1 1 0 2.081146 11.085734)"></path></svg>
                </a>    
            </h2>
        ...
        <ul class="u-list-reset{if $issue && $currentJournal->getSetting('publishingMode') != $smarty.const.PUBLISHING_MODE_NONE && $articleCount >= 5} app-reviews-row{/if}">
            <li class="app-reviews-row__main">
                <ul class="app-reviews-row__grid">
                    ...
                    {if $topDownloadedArticle && count($topDownloadedArticle) > 0}
                    ...
                    {* Second Tier Downloaded Articles (Klaster Kedua) - FIXED *}
                    {if $secondTierDownloadedArticles && count($secondTierDownloadedArticles) > 0}
            ...
            {if $thirdTierDownloadedArticles && count($thirdTierDownloadedArticles) > 0}
            <li>
                <ul class="app-reviews-row__side">
                {* Third Tier Downloaded Articles (Klaster Ketiga) - FIXED *}
                    {foreach from=$thirdTierDownloadedArticles item=article}
