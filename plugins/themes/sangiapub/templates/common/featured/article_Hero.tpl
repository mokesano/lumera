...
<article>
    <div data-track-component="hero" class="u-container content-loaded">
        <div class="c-hero c-hero--flush-md-max">
	    	...
	    	<picture><source type="image/webp" srcset="{$article.cover_image.file_url}?as=webp 450w, {$article.cover_image.file_url}?as=webp 735w" sizes="(max-width: 1024px) 450px,(max-width: 100vw) 735px 735px"><img src="{$article.cover_image.file_url}" alt="{if $article.cover_image.alt_text != ''}{$article.cover_image.alt_text|escape}{else}{$article.title|escape}{/if}" itemprop="image" loading="lazy">
	    	</picture>
	    	</div>
            {elseif $issue->getLocalizedFileName() && $issue->getShowCoverPage($locale) && !$issue->getHideCoverPageArchives($locale)}
  			...
  			<picture>
  				...
  				<img class="lazyload" loading="lazy" src="{$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}" title="Cover Homepage Image" alt="Cover Homepage Image" itemprop="image">
  			</picture>
  			</div>
  			{else}
  			<div class="c-hero__image">
  			<picture>
  				...
  				<img class="lazyload" loading="lazy" src="//assets.sangia.org/img/img-default_v2.png" title="Cover Image Default" alt="Cover Image Default" itemprop="image">
  			</picture>
  			</div>
	    	{/if}
    ...
    <div data-track-component="hero" class="u-container">
        <div class="c-hero c-hero--flush-md-max u-mb-0 u-position-relative">
		    <div class="c-hero__image">
		        ...
		        <picture><source type="image/webp" srcset="{$publicFilesDir}/{$displayPageHeaderTitle.uploadName|escape:"url"}?as=webp 450w, {$publicFilesDir}/{$displayPageHeaderTitle.uploadName|escape:"url"}?as=webp 735w" sizes="(max-width: 1024px) 450px,(max-width: 100vw) 735px 735px"><img class="lazyload" loading="lazy" src="{$publicFilesDir}/{$displayPageHeaderTitle.uploadName|escape:"url"}" alt="Cover Header Image">
		        </picture>
		        {else}
		        <picture><source type="image/webp" srcset="//assets.sangia.org/static/images/not-available.webp 450w, //assets.sangia.org/static/images/not-available.webp 735w" sizes="(max-width: 1024px) 450px,(max-width: 100vw) 735px 735px"><img class="lazyload" loading="lazy" src="//assets.sangia.org/static/images/not-available.webp" alt="Cover Default">
		        </picture>
		        {/if}
		    </div>
		    <div class="c-hero__copy">
					...
					<article class="u-full-height c-card c-card--flush" itemscope="" itemtype="http://schema.org/ScholarlyArticle">
						<div class="c-card__layout u-full-height">
							...
							<picture>
								...
								<img class="lazyload" loading="lazy" src="{$article.cover_image.file_url}" alt="{if $article.cover_image.alt_text != ''}{$article.cover_image.alt_text|escape}{else}{$article.title|escape}{/if}" itemprop="image">
							</picture>
							</div>
							{/if}
				...
				<div class="c-card c-card--flush u-full-height">
					<a class="c-card__image" href="{url page="issue" op="current"}" data-track="click" data-track-action="view current issue" data-track-label="image">
						...
						<picture>
							...
							<img class="lazyload" loading="lazy" src="{$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}" title="Cover Issue" alt="Cover issue" itemprop="image">
						</picture>
						{else}
						<picture>
							<source srcset="//assets.sangia.org/img/img-default_v2.png?as=webp" type="image/webp">
							<img class="lazyload" loading="lazy" src="//assets.sangia.org/img/img-default_v2.png" title="" alt="Cover Default" itemprop="image">
						</picture>
						{/if}
					</a>
					<div class="c-card__body u-display-flex u-flex-direction-column">
