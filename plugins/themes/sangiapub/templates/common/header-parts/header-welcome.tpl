...
{**
 * @file templates/common/header-parts/header-welcome.tpl
 *
 * Copyright (c) 2017-2026 Sangia Publishing House
 * Copyright (c) 2017-2026 Rochmady
 * Distributed under the GNU GPL v3.
 *
 * Header for Welcome Login/Register header.
 *
 *}
{strip}
...
<div id="sidebar" class="sidebar">
	...
	<aside class="column medium-4">
		...
		<section class="sangia-button">
		    <a href="{url page="submission" op="submit"}" target="_blank" data-track="click" class="button-base-47711979">
