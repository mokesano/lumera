...
{**
 * @file templates/common/header-parts/header-reader.tpl
 *
...
<head>
	...
	<link rel="stylesheet" href="{$baseUrl}/assets/static/styles/main-notif.css" type="text/css" />
...
<h1 class="c-page-title">{$pageTitleTranslated}</h1>
