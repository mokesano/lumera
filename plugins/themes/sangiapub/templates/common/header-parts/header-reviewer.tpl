...
{**
 * @file templates/common/header-parts/header-reviewer.tpl
 *
...
<head>
	...
	<script type="text/javascript" src="{$baseUrl}/assets/js/dev/perfect-sync-editor.js"></script>
	...
	<link rel="stylesheet" href="{$baseUrl}/assets/js/dev/submission-progress.css" type="text/css" />
