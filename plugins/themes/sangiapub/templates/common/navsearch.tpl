{**
 * @file templates/common/navsearch.tpl
 *
...
<div class="c-header__container">
    ...
    <div class="c-header__flush"><a class="c-header__link" href="{$url page="search" op="search"}" data-track="click" data-track-action="advanced search" data-track-label="link">Advanced search</a></div>
