...
<form method="GET" id="sub-search" action="{$searchFormUrl|strtok:"?"|escape}">
	...
	<div class="c-facet c-facet--small u-mb-16" data-facet="" data-test="search-filter-box">
	    ...
	    <div class="c-facet__container">
                ...
                <div id="journal-target" data-test="journal-target" data-facet-analytics="journal" class="c-facet-expander u-js-hide" hidden="">
                    ...
                    <ul class="c-facet-expander__list">
                        ...
                        <li class="u-hide c-facet-expander__list-item">
                            ...
                            <label class="c-facet-expander__link" for="journal-{$currentUrl|replace:$baseUrl:""|lower}">span>{$journalName} ({$articleCount})</span></label>
                        </li>
                        {/foreach}
                    </ul>
                    <p class="u-mb-0 u-mt-16">
            ...
            <fieldset class="c-facet__item u-pa-0" data-test="field-set-article-type">
                <legend>
                    ...
                    <span class="grade-c-hide u-js-show">
                        <button type="button" class="c-facet__button c-facet__button--border" aria-labelledby="article-legend" data-facet-expander="" data-facet-target="#article-type-target" data-track="click" data-track-action="article type filter" data-track-label="button" aria-expanded="false">
                            <span class="c-facet__ellipsis">All</span><svg class="c-facet__icon" role="img" aria-hidden="true" focusable="false" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m5.58578644 3-3.29289322-3.29289322c-.39052429-.39052429-.39052429-1.02368927 0-1.41421356s1.02368927-.39052429 1.41421356 0l4 4c.39052429.39052429.39052429 1.02368927 0 1.41421356l-4 4c-.39052429.39052429-1.02368927.39052429-1.41421356 0s-.39052429-1.02368927 0-1.41421356z" transform="matrix(0 1 -1 0 11 3)"></path></svg>
                        </button>
                </span>
                </legend>
                <span class="u-visually-hidden">Check one or more article types to show results from those article types only.</span>
                <div id="article-type-target" data-test="article-type-target" data-facet-analytics="article type" class="c-facet-expander u-js-hide" hidden="">
                    <div class="c-facet-expander__button-container">
                        <button class="c-facet__submit">Apply filters</button>
                        <button class="c-facet-expander__clear-selection">Clear selection</button>
                    </div>
            ...
            <fieldset class="c-facet__item u-pa-0" data-test="field-set-subjects">
                <legend>
                    ...
                    <span class="grade-c-hide u-js-show">
                        <button type="button" class="c-facet__button c-facet__button--border" aria-labelledby="subject-legend" data-facet-expander="" data-facet-target="#subject-target" data-track="click" data-track-action="subject filter" data-track-label="button" aria-expanded="false">
                            <span class="c-facet__ellipsis">All</span>
                            <svg class="c-facet__icon" role="img" aria-hidden="true" focusable="false" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m5.58578644 3-3.29289322-3.29289322c-.39052429-.39052429-.39052429-1.02368927 0-1.41421356s1.02368927-.39052429 1.41421356 0l4 4c.39052429.39052429.39052429 1.02368927 0 1.41421356l-4 4c-.39052429.39052429-1.02368927.39052429-1.41421356 0s-.39052429-1.02368927 0-1.41421356z" transform="matrix(0 1 -1 0 11 3)"></path></svg>
                        </button>
                    </span>
                ...
                <div id="subject-target" data-test="subject-target" data-facet-analytics="subject" class="c-facet-expander u-js-hide" hidden="">
                    <div class="c-facet-expander__button-container">
                        <button class="c-facet__submit">Apply filters</button>
                        <button class="c-facet-expander__clear-selection">Clear selection</button>
                    </div>
            ...
            <fieldset class="c-facet__item u-pa-0" data-test="field-set-date">
                <legend>
                    ...
                    <span class="grade-c-hide u-js-show">
                        <button type="button" class="c-facet__button c-facet__button--border" aria-labelledby="date-legend" data-facet-expander="" data-facet-target="#date-target" data-track="click" data-track-action="date filter" data-track-label="button" aria-expanded="false">
                            <span class="c-facet__ellipsis">All</span>
                            <svg class="c-facet__icon" role="img" aria-hidden="true" focusable="false" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m5.58578644 3-3.29289322-3.29289322c-.39052429-.39052429-.39052429-1.02368927 0-1.41421356s1.02368927-.39052429 1.41421356 0l4 4c.39052429.39052429.39052429 1.02368927 0 1.41421356l-4 4c-.39052429.39052429-1.02368927.39052429-1.41421356 0s-.39052429-1.02368927 0-1.41421356z" transform="matrix(0 1 -1 0 11 3)"></path></svg>
                        </button>
                    </span>
                ...
                <div id="date-target" data-test="date-target" data-facet-analytics="date" class="c-facet-expander u-js-hide" hidden="">
                    <div class="c-facet-expander__button-container">
                        <button class="c-facet__submit">Apply filters</button>
                        <button class="c-facet-expander__clear-selection">Clear selection</button>
                    </div>
    	...
    	<fieldset class="c-sort-by u-pa-0" data-sort-by="">
    	    ...
    	    <div class="c-sort-by__input-container">
    	        <input id="sort-by-relevance" class="c-sort-by__input" name="order" value="relevance" type="radio" checked="" data-test="order-relevance" />
                <label class="c-sort-by__label" for="sort-by-relevance">Relevance</label>
    	    </div>
    	    <div class="c-sort-by__input-container">
    	        <input id="sort-by-date_desc" class="c-sort-by__input" name="order" value="date_desc" type="radio" checked="" data-test="order-date_desc" />
                <label class="c-sort-by__label" for="sort-by-date_desc">Date Published (newest to oldest)</label>
    	    </div>
    	    <div class="c-sort-by__input-container">
    	        <input id="sort-by-date_asc" class="c-sort-by__input" name="order" value="date_asc" type="radio" checked="" data-test="order-date_asc" />
                <label class="c-sort-by__label" for="sort-by-date_asc">Date Published (oldest to newest)</label>
    	    </div>
    	    <div class="c-sort-by__input-container">
    	        <input id="results-only-access-checkbox" class="c-sort-by__input" type="checkbox" checked="checked" aria-describedby="preview-tooltip" />
                <span class="tooltip" id="preview-tooltip" role="tooltip">
	...
	<div class="c-list-header">
	    <div class="u-mb-0">
            <span data-test="results-data" class="u-display-flex"><span>Showing {if $results && is_object($results)}{page_info iterator=$results}{/if} results.</span></span>
        </div>
    </div>
