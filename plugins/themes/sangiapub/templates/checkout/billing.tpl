{**
 * templates/checkout/billing.tpl
 *
 * [WIZDAM EDITION]
 * Tahap 2: SPA (Single Page Application) untuk Billing Details & Review Order
 *}
{include file="common/header-parts/header-payment.tpl" pageTitle="checkout.billing.title"}
    ...
    <div class="wizdam-checkout-container">
        ...
        <div class="wizdam-checkout-main">
            ...
            <div id="container-step-1">
                ...
                <div class="contact-info">
                    <strong>{$userFullName|escape}</strong><br>
                    {$userEmail|escape}
                </div>
                ...
                <form id="wizdam-billing-form" onsubmit="return false;">
                    <div class="form-group">
                        ...
                        <select id="input-country" class="wizdam-select" required>
                            ...
                            {html_options options=$countries selected=$defaultAddress.country}
                        </select>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="input-city" class="wizdam-input" value="{$defaultAddress.city|escape}" required>
                        </div>
                        <div class="form-group">
                            <label class="wizdam-label">Zip/Postal Code <span>*</span></label>
                            <input type="text" id="input-zip" class="wizdam-input" value="{$defaultAddress.postal_code|escape}" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="wizdam-label">Street Address <span>*</span></label>
                        <input type="text" id="input-street" class="wizdam-input" value="{$defaultAddress.address|escape}" required>
                    </div>
            ...
            <div id="container-step-2" style="display: none;">
                ...
                <form action="{url page="checkout" op="billing" path=$queuedPaymentId}" method="POST" id="final-payment-form">
        ...
        <div class="wizdam-checkout-sidebar">
            ...
            <div class="summary-row">
                <span>Subtotal</span>
                <span>{$summary.currency} {$summary.subtotal|number_format:2}</span>
            </div>
            
            {if $summary.discount > 0}
            <div class="summary-row" style="color: #28a745;">
                <span>Discount ({$summary.promo_code})</span>
                <span>- {$summary.currency} {$summary.discount|number_format:2}</span>
            </div>
            {/if}

            <div class="summary-row">
                <span>Tax ({$summary.tax_rate}%)</span>
                <span>{$summary.currency} {$summary.tax_amount|number_format:2}</span>
            </div>

            <div class="summary-total">
                <span>Today's charge</span>
                <span>{$summary.currency} {$summary.grand_total|number_format:2}</span>
            </div>
