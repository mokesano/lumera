...
<div id="submissionEventLog">
    ...
    <p>
        <a href="{url op="submissionEventLog" path=$submission->getId()}" class="link-button">{translate key="submission.history.viewLog"}</a>{if $isEditor} |
        <a href="{url page="editor" op="clearSubmissionEventLog" path=$submission->getId()}" class="link-button" onclick="return confirm('{translate|escape:"jsparam" key="submission.event.confirmClearLog"}')">{translate key="submission.history.clearLog"}</a>{/if}
    </p>
</div>
...
<div id="submissionEmailLog">
    ...
    <p class="">
        <a class="link-button" href="{url op="submissionEmailLog" path=$submission->getId()}">{translate key="submission.history.viewLog"}</a>{if $isEditor} |
        <a class="link-button" href="{url page="editor" op="clearsubmissionEmailLog" path=$submission->getId()}" onclick="return confirm('{translate|escape:"jsparam" key="submission.email.confirmClearLog"}')">{translate key="submission.history.clearLog"}</a>{/if}
    </p>
</div>
...
<div id="submissionNotes">
    ...
    <div class="block">
        <a class="link-button" href="{url op="submissionNotes" path=$submission->getId()}">{translate key="submission.notes.viewNotes"}</a> |
        <div style="display:inline" id="expandNotes"><a class="link-button" href="javascript:toggleNoteAll()">{translate key="submission.notes.expandNotes"}</a></div><div style="display: none" id="collapseNotes"><a class="link-button" href="javascript:toggleNoteAll()">{translate key="submission.notes.collapseNotes"}</a></div> |
        <a class="link-button" href="{url op="submissionNotes" path=$submission->getId()|to_array:"add"}">{translate key="submission.notes.addNewNote"}</a> |
        <a class="link-button" href="{url op="clearAllSubmissionNotes" articleId=$submission->getId()}" onclick="return confirm('{translate|escape:"jsparam" key="submission.notes.confirmDeleteAll"}')">{translate key="submission.notes.clearAllNotes"}</a>
    </div>
