        ...
        <div class="u-container">        
            <div class="srm-footer text-xs u-padding-l-ver">
                <div class="u-margin-m-bottom u-margin-0-bottom-from-md u-margin-m-right-from-md u-margin-l-right-from-lg">
                    <img src="//assets.sangia.org/img/sangia-mono-branded-72x89-v2.svg" loading="lazy" alt="Sangia Publishing Group" width="68" height="78" />
                </div>
