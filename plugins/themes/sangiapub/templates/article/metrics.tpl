                ...
                <section class="app-article-metrics-container">
                    <div class="app-article-metrics-box">
                        <div class="app-article-metrics-box__main">
                            ...
                            <p>Citation counts are provided by {if $citationSourceDetail}{$citationSourceDetail|escape}{else}OpenAlex and Dimension{/if}, and depend on their data availability. Counts will update daily, once available.</p>
                        </div>
                        <div class="app-article-metrics-box__side">
