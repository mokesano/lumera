                ...
                <section class="app-article-metrics-container">
                    <div class="app-article-metrics-box">
                        <div class="app-article-metrics-box__main">
                            ...
                            {if $citationSourceNames}<p>Citation counts are provided by {$citationSourceNames|escape}, and depend on their data availability. Counts will update daily, once available.</p>{/if}
                        </div>
                        <div class="app-article-metrics-box__side">
