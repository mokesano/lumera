...
<div id="footer">
        ...
        <div id="footer-nav-misc">
            <div id="footer-our-content" class="block" role="navigation">
                ...
                <ul>
                    ...
                    <li><a title="View Journals by Subject" href="{$baseUrl}/index.php/index/search/categories" target="_blank">Category</a></li>
                    <li><a title="View All Articles" href="{$baseUrl}/index.php/index/search/titles" target="_blank">Articles</a></li>
                    <li><a title="View Authors Index" href="{$baseUrl}/index.php/index/search/authors" target="_blank">Author Index</a></li>
                </ul>
            </div>
            <div id="footer-other-sites" class="block" role="navigation">
                ...
                <ul>
                    ...
                    <li><a title="Visit Sangia Blogs" href="http://www.blog.sangia.org/" target="_blank">Sangia Blogs</a></li>
                    <li><a title="Visit COSIRE Indonesia" href="http://www.cosire.sangia.org/" target="_blank">COSIRE Indonesia</a></li>
    ...
    <div id="footer-legal" class="section" role="contentinfo">
        <div id="legal" role="contentinfo">
            ...
            <span id="footer-copyright">© 2017-{$smarty.now|date_format:"%Y"} <a href="//www.publishing.sangia.org">Sangia Publishing</a> unless otherwise stated. Part of <a target="_blank" rel="noreferrer noopener" href="//www.sangia.org">Sangia Research Media + Publishing Group</a>.</span>
...
{/strip}
<script type="text/javascript" src="{$baseUrl}/plugins/themes/sangia/js/menu.js"></script>
