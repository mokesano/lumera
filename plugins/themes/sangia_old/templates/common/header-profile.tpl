...
<html xmlns="http://www.w3.org/1999/xhtml" class="js svg" lang="{$currentLocale|replace:"_":"-"}" xml:lang="{$currentLocale|replace:"_":"-"}">
    <head>
        <title>{$pageTitleTranslated} - Stipwunaraha</title>
				...
				<dd id="abstract-about-additional-links" class="portlet-value">
					<ul class="listToOpenLayer">
						<li class="listItemToOpenLayer">
							<a class="external linkToOpenLayer" href="{url page="about" op="editorialPolicies" anchor="focusAndScope"}" ><span>About This Journal</span></a>
						</li>
						<li class="listItemToOpenLayer">
