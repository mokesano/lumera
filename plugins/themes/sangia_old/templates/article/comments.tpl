 ...
 *
 *}
<div id="comment" class="comment col-lg-12">
	<h6 class="sub-title u-h3 u-font-serif">{translate key="comments.commentsOnArticle"}</h6>
	<span class="u-font-serif">By submitting a comment you agree to abide by our Terms and Community Guidelines. If you find something abusive or that does not comply with our terms or guidelines please flag it as inappropriate.</span>
