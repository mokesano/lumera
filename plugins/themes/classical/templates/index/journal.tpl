    		...
    		<div class="expander-content-inner">
    			<div class="summary">
    				<dl>
    					...
    					<dd id="abstract-about-publisher">{$currentJournal->getSetting('publisherInstitution')}{else}Sangia Research Media + Publishing</dd>
    					{/if}
    				</dl>
    				...
    				<dl>
    					...
    					<dd id="abstract-about-additional-links">
    						<ul>
    							...
    							<li>
    								<a class="external" href="{url page="about" op="editorial-team"}" target="_blank" title="It opens in new window">{translate key="about.editorialTeam"}</a>
    							</li>
    							<li>
    								<a class="external" href="{url page="about" op="editorialPolicies"}" target="_blank" title="It opens in new window">{translate key="navigation.about"} This Journal</a>
    							</li>
    							<li>
