...
<div id="announcementList" class="app-announcement-list-row announcements intro">
...
<article class="app-announcement-list-row__item c-card--flush announcement">
	<div class="c-card__layout u-full-height intro">
		<div class="c-card__body u-display-flex u-flex-direction-column">
		    <div itemprop="description" class="c-card__summary u-mb-16 u-hide-sm-max description">{$announcementsIntroduction|nl2br}</div>
		</div>
	</div>
</article>
{/if}
...
<article class="app-announcement-list-row__item c-card--flush announcements">
    <div class="c-card__layout u-full-height">
        {if $announcement->getTypeId()}
        <div class="c-card__image u-hide">
            <picture>
        ...
        <div class="c-card__body u-display-flex u-flex-direction-column">
            ...
            {/if}
            <div itemprop="description" class="c-card__summary u-mb-24 u-hide-sm-max description">{$announcement->getLocalizedDescriptionShort()|nl2br}</div>
