...
{/strip}
<head>
    <title>{$currentJournal->getLocalizedTitle()|strip_tags|escape} - Sangia Publishing</title>
				...
				<ul class="ListStack ListStack--float">
                    ...
                    <li>
                    	...
                    	<span class="Meta_name">
                    	    <a id="open-access-view-articles-link" href="{url page="search" op="titles"}" data-journal-id="{$currentJournal->getJournalId()}" data-journal-title="{$currentJournal->getLocalizedTitle()|strip_tags|escape}">86 Articles</a>
                    	</span>
                    </li>
                </ul>
            </div>
