 ...
 *}
        ...
        <div id="footer-info" class="wunaraha">
            <div id="footer-nav-misc">
                <div id="footer-our-content" class="block" role="navigation">
                    <h2>Our Content</h2>
                    <ul>
                        <li><a title="View All Journals" href="{$baseUrl}" target="_blank">Journals</a></li>
                        <li><a title="View Journals by Subject" href="{$baseUrl}/index/search/categories" target="_blank">Category</a></li>
                        <li><a title="View All Articles" href="{$baseUrl}/index/search/titles" target="_blank">Articles</a></li>
                        <li><a title="View Authors Index" href="{$baseUrl}/index/search/authors" target="_blank">Author Index</a></li>
                    </ul>
                </div>
                <div id="footer-other-sites" class="block" role="navigation">
                    <h2>Other Sites</h2>
                    <ul>
                        <!-- <li><a title="Visit kumebani.com" href="#" target="_blank">kumebano.com</a></li> -->
                        <li><a title="Visit Sangia Blogs" href="http://blog.sangia.org/" target="_blank">Sangia Blogs</a></li>
                        <li><a title="Visit CSISC Indonesia" href="http://csisc.sangia.org/" target="_blank">CSISC Indonesia</a></li>
        ...
        <div id="footer-legal" class="section" role="contentinfo">
            <div id="legal" role="contentinfo">
                <a target="_blank" rel="noreferrer noopener" href="//www.stipwunaraha.ac.id">
                    <img src="{$baseUrl}/public/site/images/cosire-foother.svg" alt="SRM Publishing" width="auto" height="32">
                </a>
                <span id="footer-copyright">© <span>2017-</span>{$smarty.now|date_format:"%Y"} <a href="//publishing.sangia.org">Sangia Publishing</a> unless otherwise stated. Part of <a target="_blank" rel="noreferrer noopener" href="//www.sangia.org">Sangia Research Media & Publishing</a>.</span>
    ...
    {/strip}
        ...
        <script type="text/javascript" src="{$baseUrl}/plugins/themes/classical/js/classical-modern--style.js"></script>
        <script type="text/javascript" src="{$baseUrl}/plugins/themes/classical/js/auth-forms.js"></script>
