...
{/strip}
<head>
    <title>{$pageTitleTranslated} - All Volumes & Issues - Sangia Publishing</title>
...
<div id="content" >
<div id="journal-volumes-issues" class="document">
...
<div class="document-main layout-3">
	<div id="sidebar" class="col-aside" style="float: right; margin-right: 4.25531914894%">
		<div id="rightSidebar" class="slide" role="complementary">
			...
			<div>
				<div class="cover"><img class="look-inside-cover" src="{$publicFilesDir}/{$displayHomepageImage.uploadName|escape:"url"}" width="153" {if $homepageImageAltText != ''}alt="{$homepageImageAltText|escape}"{else}src="//media.stipwunaraha.ac.id/img/img-default.jpg" alt="Cover issue"{/if} title="{$homepageImageAltText|escape}" />
				</div>
			</div>
			{/if}
			...
			<div id="quick-facts-container" class="SideBox SideBox--neutralBorder SideBox--padding">
				<ul class="ListStack ListStack--float">
                    ...
                    <li>
                    	<span>Volumes</span>
                    	<span>{$issue->getVolume()|escape}</span>
                    </li>
                    {/if}
                    {if $issue->getNumber()}
                    <li>
                    ...
                    <li>
                    	...
                    	<span class="Meta_name"><a id="open-access-view-articles-link" href="#" data-journal-id="1" data-journal-title="{$currentJournal->getLocalizedTitle()|strip_tags|escape}">86 Articles</a></span>
                    </li>
                </ul>
            </div>
            {/if}
...
<h1 id="title">{$pageTitleTranslated}</h1>
