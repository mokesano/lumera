...
class BagIt
{
    ...
    public function __construct(
        ...
        $this->bagVersion = ['major' => 0, 'minor' => 96];
    ...
    private function _openBag()
    {
        ...
        if (count($files) > 0) {
            ...
            $manifestFile = findFirstExisting(
                ["$bagdir/manifest-sha1.txt", "$bagdir/manifest-md5.txt"],
