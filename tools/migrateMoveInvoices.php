...
/**
 * @file tools/migrateMoveInvoices.php
 *
 * Copyright (c) 2017-2026 Sangia Publishing House
 * Copyright (c) 2017-2026 Rochmady
 * Distributed under the GNU GPL v3.
 * 
 * @class MigrateMoveInvoices
 * @ingroup tools
 *
 ...
 * dijalankan dalam mode maintenance (tidak ada transaksi pembayaran aktif).
 */

require(__DIR__ . '/bootstrap.inc.php');

class MigrateMoveInvoices extends CommandLineTool {
...
$tool = new MigrateMoveInvoices($argv ?? []);
$tool->execute();