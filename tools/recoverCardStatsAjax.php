...
<head>
    ...
    <style>
        ...
        .progress-bar { height: 100%; background: linear-gradient(90deg, #2ed573, #7bed9f); width: 0%; transition: width 0.3s ease; text-align: center; line-height: 22px; color: #000; font-weight: bold; font-size: 13px; }
        ...
        .btn-spinner { display: none; width: 13px; height: 13px; border: 2px solid rgba(255,255,255,0.35); border-top-color: #fff; border-radius: 50%; animation: proc-spin 0.6s linear infinite; margin-left: 8px; vertical-align: middle; }
        .spinner { display: inline-block; width: 14px; height: 14px; border: 2px solid rgba(255,255,255,0.2); border-top-color: #1e90ff; border-radius: 50%; animation: proc-spin 0.7s linear infinite; }
...
<div class="container">
    ...
    <div class="step-panel">
        ...
        <div class="step-panel-section" id="panelProcess">
            ...
            <button onclick="startProcess()" id="btnStart" disabled><span class="btn-label">MULAI PROSES</span><span class="btn-spinner"></span></button>
        ...
        <div class="step-panel-section" id="panelGeo">
            ...
            <button onclick="startGeoProcess()" id="btnGeoStart" disabled><span class="btn-label">PROSES ULANG UNTUK LENGKAPI GEOLOCATION</span><span class="btn-spinner"></span></button>
...
<script>
    ...
    function startGeoProcess() {
        ...
        setBtnBusy('btnGeoStart', true, 'SEDANG BERJALAN...', 'PROSES ULANG UNTUK LENGKAPI GEOLOCATION');
    ...
    function geoProcessNext() {
        if (geoCurrentIndex >= geoFiles.length) {
            ...
            setBtnBusy('btnGeoStart', false, undefined, undefined);
            document.getElementById('btnGeoStart').querySelector('.btn-label').textContent = 'SELESAI';
            return;
        }
    ...
    function startProcess() {
        ...
        setBtnBusy('btnStart', true, 'SEDANG BERJALAN...', 'MULAI PROSES');
    ...
    function processNext() {
        if (currentIndex >= affectedFiles.length) {
            ...
            setBtnBusy('btnStart', false, undefined, undefined);
            document.getElementById('btnStart').querySelector('.btn-label').textContent = 'SELESAI';
            return;
        }
