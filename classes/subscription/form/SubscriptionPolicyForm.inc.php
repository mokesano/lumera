...
class SubscriptionPolicyForm extends Form {
    ...
    /** @var array validNumMonthsBeforeExpiry keys are valid expiry reminder months */     
    public $validNumMonthsBeforeExpiry;

    /** @var array validNumWeeksBeforeExpiry keys are valid expiry reminder weeks */     
    public $validNumWeeksBeforeExpiry;

    /** @var array validNumMonthsAfterExpiry keys are valid expiry reminder months */     
    public $validNumMonthsAfterExpiry;

    /** @var array validNumWeeksAfterExpiry keys are valid expiry reminder weeks */     
     ...
     */
    public function SubscriptionPolicyForm() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::SubscriptionPolicyForm(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
