...
class Install extends PKPInstall {
     ...
     */
    public function __construct(array $params, string $descriptor = 'install.xml', bool $isPlugin = false) {
    ...
    public function Install($params, $descriptor = 'install.xml', $isPlugin = false) {
        ...
        self::__construct($params, $descriptor, $isPlugin);
    }
     ...
     * @return array
     */
    public function getCreateDirectories(): array {
