<?php /* Smarty version 2.6.26, created on 2026-04-06 02:58:32
         compiled from issue/header-volumes.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'issue/header-volumes.tpl', 2, false),array('modifier', 'assign', 'issue/header-volumes.tpl', 14, false),array('modifier', 'strip_tags', 'issue/header-volumes.tpl', 27, false),array('modifier', 'escape', 'issue/header-volumes.tpl', 27, false),array('function', 'translate', 'issue/header-volumes.tpl', 14, false),array('function', 'call_hook', 'issue/header-volumes.tpl', 44, false),array('function', 'url', 'issue/header-volumes.tpl', 85, false),)), $this); ?>
<!DOCTYPE html>
...
<div class="column medium-12 cleared container-type-title" role="main" data-container-type="title">
    <div class="content mb20 mt20 mq1200-padded">
        <h1 class="content main-heading u-mb-16" itemprop="name"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "issue.volume"), $this);?>

            <span itemprop="volumeNumber"><?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getVolume())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
        </h1>
...
<?php endif; ?>
        <?php if ($this->_tpl_vars['pageSubtitleTranslated']): ?><h2 class="content sub-heading"><?php echo $this->_tpl_vars['pageSubtitleTranslated']; ?>
</h2><?php endif; ?>
    </div>
</div>
