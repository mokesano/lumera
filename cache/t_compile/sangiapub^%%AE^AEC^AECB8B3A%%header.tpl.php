...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'submission/comment/header.tpl', 2, false),array('modifier', 'escape', 'submission/comment/header.tpl', 14, false),array('function', 'translate', 'submission/comment/header.tpl', 13, false),array('function', 'url', 'submission/comment/header.tpl', 72, false),)), $this); ?>
<!DOCTYPE html>
...
<header>
    <img loading="lazy" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/img/wizdam-branded.svg" alt="Wizdam Editorial Systems" width="auto">
</header>
<div id="container">
	<nav>
		<div id="navbar"><a <?php if ($this->_tpl_vars['currentJournal']): ?>href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['currentJournal']->getPath()), $this);?>
"<?php else: ?>href="<?php echo $this->_tpl_vars['baseUrl']; ?>
"<?php endif; ?>><?php echo $this->_tpl_vars['siteTitle']; ?>
</a></div>
	</nav>
<div id="body">
<div id="main">
