<?php /* Smarty version 2.6.26, created on 2026-04-04 05:56:01
         compiled from common/footer-parts/footer-search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'call_hook', 'common/footer-parts/footer-search.tpl', 36, false),array('function', 'translate', 'common/footer-parts/footer-search.tpl', 46, false),array('function', 'url', 'common/footer-parts/footer-search.tpl', 178, false),array('function', 'get_debug_info', 'common/footer-parts/footer-search.tpl', 303, false),array('modifier', 'escape', 'common/footer-parts/footer-search.tpl', 40, false),array('modifier', 'regex_replace', 'common/footer-parts/footer-search.tpl', 40, false),array('modifier', 'strip_unsafe_html', 'common/footer-parts/footer-search.tpl', 70, false),array('modifier', 'nl2br', 'common/footer-parts/footer-search.tpl', 70, false),array('modifier', 'strip_tags', 'common/footer-parts/footer-search.tpl', 74, false),array('modifier', 'assign', 'common/footer-parts/footer-search.tpl', 253, false),array('modifier', 'date_format', 'common/footer-parts/footer-search.tpl', 256, false),)), $this); ?>
    ...
    <footer class="composite-layer" role="contentinfo">
        <?php if ($this->_tpl_vars['currentJournal']): ?>
            <?php if ($this->_tpl_vars['homepageImage'] && ! $this->_tpl_vars['setupStep']): ?>
...
?>
                    <?php if ($this->_foreach['sections']['iteration'] == 1): ?>
                        <?php $this->assign('reversedArticles', $this->_tpl_vars['section']['articles']); ?>
                        <?php $_from = $this->_tpl_vars['reversedArticles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['articles'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['articles']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['articles'] => $this->_tpl_vars['article']):
        $this->_foreach['articles']['iteration']++;
?>
                            <?php if ($this->_foreach['articles']['iteration'] == 1): ?>
                ...
                <div class="u-mt-16 u-mb-16">
                    <div class="u-container">
                        <p class="c-meta u-ma-0">Top headline image: <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedCoverPageAltText())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')))) ? $this->_run_mod_handler('regex_replace', true, $_tmp, '/&lt;(\/?i)&gt;/', '<$1>') : smarty_modifier_regex_replace($_tmp, '/&lt;(\/?i)&gt;/', '<$1>')); ?>
</p>
                    </div>
                </div>
                ...
                <div class="u-mt-16 u-mb-16">
                    <div class="u-container">
                        <p class="c-meta u-ma-0">Top headline image: <?php if ($this->_tpl_vars['issue']->getCoverPageAltText($this->_tpl_vars['locale']) != ''): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['issue']->getCoverPageAltText($this->_tpl_vars['locale']))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')))) ? $this->_run_mod_handler('regex_replace', true, $_tmp, '/&lt;(\/?i)&gt;/', '<$1>') : smarty_modifier_regex_replace($_tmp, '/&lt;(\/?i)&gt;/', '<$1>')); ?>
<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "issue.coverPage.altText"), $this);?>
<?php endif; ?></p>
                    </div>
                </div>
                ...
                <div class="u-mt-16 u-mb-16">
                    <div class="u-container">
                        <p class="c-meta u-ma-0">Top headline image: <?php if ($this->_tpl_vars['displayPageHeaderTitleAltText'] != ''): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['displayPageHeaderTitleAltText'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.pageHeader.altText"), $this);?>
<?php endif; ?></p>
                    </div>
                </div>
                <?php elseif ($this->_tpl_vars['homepageImage'] && ! $this->_tpl_vars['setupStep']): ?>
                <div class="u-mt-16 u-mb-16">
                    <div class="u-container">
                        <p class="c-meta u-ma-0">Top headline image: Cover image: <?php if ($this->_tpl_vars['homepageImageAltText'] != ''): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['homepageImageAltText'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.journalHomepageImage.altText"), $this);?>
<?php endif; ?></p>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="u-container">
                ...
                <?php if ($this->_tpl_vars['currentJournal']): ?>
                    <?php if ($this->_tpl_vars['issue'] && $this->_tpl_vars['currentJournal']->getSetting('publishingMode') != @PUBLISHING_MODE_NONE): ?>
                        <?php if ($this->_tpl_vars['homepageImage'] && ! $this->_tpl_vars['setupStep']): ?>
                        <p class="c-meta u-ma-0 u-mr-24 u-flex-shrink">Issue cover: <?php if ($this->_tpl_vars['issue']->getLocalizedCoverPageDescription()): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['issue']->getLocalizedCoverPageDescription())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<?php else: ?>SRM Publishing/Sangia Publishing<?php endif; ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                    <p class="c-meta u-ma-0 u-flex-shrink">
                        <span class="c-meta__item"><?php if ($this->_tpl_vars['currentJournal']->getLocalizedTitle()): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?> <?php if ($this->_tpl_vars['currentJournal']->getSetting('abbreviation')): ?>(<i><?php echo $this->_tpl_vars['currentJournal']->getSetting('abbreviation',$this->_tpl_vars['currentJournal']->getPrimaryLocale()); ?>
</i>)<?php endif; ?></span>
                        
                        <?php echo ''; ?><?php if ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')); ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('printIssn')); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['displayCreativeCommons']): ?><?php echo ''; ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.ccLicense"), $this);?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>

                        <?php if ($this->_tpl_vars['printIssn']): ?> <?php else: ?>
                        <?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?>
                        <span class="c-meta__item">
                            <abbr title="International Standard Serial Number">ISSN</abbr> <span itemprop="onlineIssn"><?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
</span> (print)</span><?php endif; ?>
                        <span class="c-meta__item">
                            <abbr title="International Standard Serial Number">ISSN</abbr> <?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><span itemprop="printIssn"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
</span><?php else: ?> <i>on proccess</i><?php endif; ?> (online)</span>
                        <?php endif; ?>
                    </p>
                <?php else: ?>
                    <p class="c-meta u-ma-0 u-flex-shrink">
                        <span class="c-meta__item"><?php echo $this->_tpl_vars['siteTitle']; ?>
</span>
                    </p>
                    <p class="c-meta u-ma-0 u-flex-shrink">
        ...
        <div itemscope="" itemtype="http://schema.org/Periodical">
            <?php if ($this->_tpl_vars['currentJournal']): ?>
                <?php $this->assign('publisherName', $this->_tpl_vars['currentJournal']->getSetting('publisherInstitution')); ?>
            <?php else: ?>
                <?php $this->assign('publisherName', $this->_tpl_vars['siteTitle']); ?>
            <?php endif; ?>
            <meta itemprop="publisher" content="<?php echo $this->_tpl_vars['publisherName']; ?>
">
            <div class="c-footer">
                <div class="u-container">
            ...
            <div id="footer-nav-misc" class="text-xs section-footer c-footer__grid">
                <div class="c-footer__group" role="navigation">
                    ...
                    <ul class="c-footer__list">
                        ...
                        <li class="c-footer__item"><a title="Browse Journals" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
" target="_blank">View Journals</a></li>
                        <li class="c-footer__item"><a title="View Journal Subject" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
/index/search/categories">Journals Subjects</a></li>
                        <li class="c-footer__item"><a title="View All Articles" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
/index/search/titles">All Articles</a></li>
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'browseSearch','op' => 'sections'), $this);?>
" title="Browse Section">Browse Section</a></li>
                        <li class="u-hide c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'browseSearch','op' => 'identifyTypes'), $this);?>
" title="Browse Article Type">Browse Article Type</a></li>
                        <li class="c-footer__item"><a title="View Authors Index" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
/index/search/authors" target="_blank">Authors Index</a></li>
                    </ul>
                </div>            
                ...
                <div class="c-footer__group" role="navigation">
                    ...
                    <ul class="c-footer__list">
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'aboutThisPublishingSystem'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.aboutThisPublishingSystem"), $this);?>
                        ...
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'information','op' => 'authors'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.infoForAuthors.long"), $this);?>
</a></li>
                        <?php if ($this->_tpl_vars['donationEnabled']): ?><li ><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'donations'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "payment.type.donation"), $this);?>
</a></li><?php endif; ?>
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'siteMap'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.siteMap"), $this);?>
</a></li> 
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'contact'), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.contact"), $this);?>
</a></li>
                ...
                <div class="c-footer__group" role="navigation">
                    ...
                    <ul class="c-footer__list">
                        ...
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'gateway','op' => 'lockss'), $this);?>
" target="_blank">LOCKSS Publisher Manifest</a></li>                    
                    </ul>
                </div>
                ...
                <div class="c-footer__group" role="navigation">
                    ...
                    <ul class="c-footer__list">
                        ...
                        <?php if ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getLocalizedSetting('privacyStatement') != ''): ?>
                        <li class="c-footer__item"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'submissions','anchor' => 'privacyStatement'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
        ...
        <div class="c-corporate-footer u-font-sans" role="contentinfo"> 
            <div id="pageFooter" class="u-container">
                <div class="sangia-footer text-xs u-padding-l-ver ">
                    <div class="u-margin-m-bottom u-margin-0-bottom-from-md u-margin-m-right-from-md u-margin-l-right-from-lg">
                        <picture loading="lazy" class="publisher-logo">
                            <source loading="lazy" srcset="//assets.sangia.org/img/sangia-mono-branded-72x89-v2.svg" alt="Sangia Publishing Group" width="68" height="78">
                            <img loading="lazy" src="//assets.sangia.org/img/sangia-mono-branded-72x89-v2.svg" alt="Sangia Publishing Group" width="68" height="78" />
                        </picture>
                    </div>
                    <div id="standardFooter" class="sangia-footer-content u-margin-l-right-from-lg u-margin-m-right-from-md">
                        ...
                        <p class="sangia-ads">We use cookies to enhance our service and ads. By using this website, you agree to our <a class="anchor" href="/ISLE/pages/view/Terms%20and%20Conditions"><span class="anchor-text">Terms and Conditions</span></a><?php if ($this->_tpl_vars['currentJournal']): ?>, <a class="anchor" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','anchor' => 'privacyStatement'), $this);?>
"><span class="anchor-text"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
</span></a><?php endif; ?> and <a class="anchor" href="/ISLE/pages/view/Cookies"><span class="anchor-text">Cookies</span></a> policy.</p>
 ...
 <?php if ($this->_tpl_vars['printIssn']): ?><?php else: ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?>ISSN: <a class="anchor" href="//portal.issn.org/resource/ISSN/<?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
</span></a> (Print) <?php endif; ?>ISSN: <?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><a class="anchor" href="//portal.issn.org/resource/ISSN/<?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
</span></a> (Online)<?php else: ?>on proccess (Online)<?php endif; ?>. <?php endif; ?>
                            <?php else: ?>
                                <?php echo $this->_tpl_vars['siteTitle']; ?>

                            <?php endif; ?>
                        <?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.openJournalSystems"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'applicationName') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'applicationName'));?>

                        <?php $this->assign('applicationName', "ScholarWizdam: Editorial Management System"); ?>
                        <span class="sangia-lisensing">Powered by <a class="anchor" href="//pkp.sfu.ca/software/ojs/download/archive/" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['applicationName']; ?>
</span></a> and <a class="anchor" href="//github.com/masonpublishing/OJS-Theme" target="_blank"><span class="anchor-text">Mason Publishing</span></a> theme.</span></p>
                        <p class="sangia-footer-copyright u-mb-0" style="margin-bottom:0">Copyright © 2017-<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y")); ?>
 <a class="anchor" href="//www.publishing.sangia.org" target="_blank"><span class="anchor-text">Sangia Publishing</span></a> unless otherwise stated. Part of <a class="anchor" href="//www.insw.go.id/nib" target="_blank"><span class="anchor-text">Sangia Research Media and Publishing</span></a> | NIB: 1111220205313.</p>
                        ...
                        <p class="footer-section anchor"><?php echo $this->_tpl_vars['pageFooter']; ?>
</p>       
                        <p id="diagnostic-info" class="footer-section">
                            <span id="diagnostic-login-status"><?php if ($this->_tpl_vars['isUserLoggedIn']): ?>You logged in<?php else: ?>Not logged in<?php endif; ?></span>
                            <span class="diagnostic-business-partners"><?php if ($this->_tpl_vars['isUserLoggedIn']): ?><?php if ($this->_tpl_vars['hasOtherJournals']): ?>Affiliated<?php endif; ?><?php else: ?>Unaffiliated<?php endif; ?></span>
                            <span id="diagnostic-ip" class="ip_diagnostic">Fetching IP address...</span>
                        </p>   
                    </div>
                    <div class="sangia-footer u-margin-0-top u-margin-m-top-from-xs u-margin-0-top-from-md"><a aria-label="Sangia Research Media home page (opens in a new tab)" href="//publishing.sangia.org/" target="_blank" rel="nofollow"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="93px" height="22px" viewBox="0 0 93 22" enable-background="new 0 0 93 22" xml:space="preserve"><image id="image0" width="93" height="22" x="0" y="0" href="//assets.sangia.org/image/sangia.png" class="lazyload" /></svg></a></div>
                </div>
            </div>
        </div>
    ...
    <button class="StickySideButton StickySideButton--feedback lazyload" onclick="FreshWidget.show();">
        ...
        <picture loading="lazy">
            <source loading="lazy" srcset="//assets.sangia.org/image/classical/freshdesk-support.png" />
            <img loading="lazy" src="//assets.sangia.org/image/classical/freshdesk-support.png" />
        </picture>
    </button>
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js" referrerpolicy="strict-origin-when-cross-origin"></script>
    
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/sintaScore.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/lazyload.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/editorgender.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/sangiastyle.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/wizdam_search.js"></script>

    <?php if ($this->_tpl_vars['reCaptchaEnabled'] && $this->_tpl_vars['reCaptchaVersion'] == 3): ?>
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        grecaptcha.ready(function() {
            grecaptcha.execute('<?php echo ((is_array($_tmp=$this->_tpl_vars['reCaptchaPublicKey'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
', {action: 'search'});
        });
    });
    </script>
