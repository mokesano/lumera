<?php /* Smarty version 2.6.26, created on 2026-04-04 06:08:33
         compiled from common/featured/editorial-timeline.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'common/featured/editorial-timeline.tpl', 14, false),array('modifier', 'strtotime', 'common/featured/editorial-timeline.tpl', 15, false),array('function', 'url', 'common/featured/editorial-timeline.tpl', 24, false),)), $this); ?>
...
<div id="__next" class="journal-metrics">
 ...
 preceding the current one. The data are processed without annual grouping to ensure greater accuracy, enabling a comprehensive median calculation based on the entire dataset rather than segmented yearly values. <span class="anchor u-display-block"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'statistics'), $this);?>
"><span class="anchor-text">For more click HERE</span></a><svg focusable="false" viewBox="0 0 8 8" height="10" aria-label="Opens in new window" class="icon icon-arrow-up-right-tiny arrow-external-link"><path d="M1.12949 2.1072V1H7V6.85795H5.89111V2.90281L0.784057 8L0 7.21635L5.11902 2.1072H1.12949Z"></path></svg></span></div></div>
                </div>
            </div>
        </h2>
    </div>
    ...
    <div class="max-width__MaxWidth-sc-1dxr8k6-0 metrics__Metrics-sc-ewcnzs-0 ilPtKO jFWzXz u-font-sangia-sans">
        ...
        <div class="metric__Wrapper-sc-1q1u28e-0 kzQOoQ">
            <div class="label__Wrapper-sc-11qqina-1 koaLwK">
                ...
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'statistics'), $this);?>
" rel="noreferrer noopener" target="_self" data-aa-name="Time to first decision" data-aa-region="metrics" class="label__DefaultLabel-sc-11qqina-0-a BKOrl metrics-time-to-first-decision anchor">
 ...
 (median)</div>
        ...
        <div class="metric__Wrapper-sc-1q1u28e-0 kzQOoQ">
            <div class="label__Wrapper-sc-11qqina-1 koaLwK">
                ...
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'statistics'), $this);?>
" rel="noreferrer noopener" target="_self" data-aa-name="Review time" data-aa-region="metrics" class="label__DefaultLabel-sc-11qqina-0-a BKOrl metrics-days-peer-review anchor">
 ...
 (median)</div>
        ...
        <div class="metric__Wrapper-sc-1q1u28e-0 kzQOoQ">
            <div class="label__Wrapper-sc-11qqina-1 koaLwK">
                ...
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'statistics'), $this);?>
" rel="noreferrer noopener" target="_self" data-aa-name="Submission to acceptance" data-aa-region="metrics" class="label__DefaultLabel-sc-11qqina-0-a BKOrl metrics-submission-to-acceptance anchor">
 ...
 (median)</div>
        ...
        <div class="metric__Wrapper-sc-1q1u28e-0 kzQOoQ">
            <div class="label__Wrapper-sc-11qqina-1 koaLwK">
                ...
                <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'statistics'), $this);?>
" rel="noreferrer noopener" target="_self" data-aa-name="Acceptance to publication" data-aa-region="metrics" class="label__DefaultLabel-sc-11qqina-0-a BKOrl metrics-acceptance-to-publication anchor">
