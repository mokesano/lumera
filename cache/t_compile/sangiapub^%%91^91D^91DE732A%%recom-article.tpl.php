    ...
    <details class="details-summary-2566262091 u-margin-s-bottom">
        ...
        <div class="u-margin-s-top metrics-details">
            <div id="recommended-articles">
                <ul class="recommended-by-wizdam">
                    <li class="SidePanelItem article-recommended">
                        <div class="sub-heading">
                            <h3 class="related-content-panel-list-entry-outline-padding text-s u-fonts-serif" id="recommended-articles-article1-title">
                            ...
                            <div class="article-source u-clr-grey6">
                                <div class="source">
                ...
                <button class="anchor button-link more-recommended-button u-margin-s-top button-link-primary button-link-icon-right" type="button">
