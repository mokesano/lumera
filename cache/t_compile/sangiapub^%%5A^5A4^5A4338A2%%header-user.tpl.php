<?php /* Smarty version 2.6.26, created on 2026-04-05 05:53:15
         compiled from common/header-parts/header-user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'common/header-parts/header-user.tpl', 2, false),array('modifier', 'assign', 'common/header-parts/header-user.tpl', 13, false),array('modifier', 'escape', 'common/header-parts/header-user.tpl', 23, false),array('modifier', 'string_format', 'common/header-parts/header-user.tpl', 137, false),array('modifier', 'date_format', 'common/header-parts/header-user.tpl', 164, false),array('function', 'translate', 'common/header-parts/header-user.tpl', 13, false),array('function', 'call_hook', 'common/header-parts/header-user.tpl', 39, false),array('function', 'url', 'common/header-parts/header-user.tpl', 80, false),)), $this); ?>
<!DOCTYPE html>
