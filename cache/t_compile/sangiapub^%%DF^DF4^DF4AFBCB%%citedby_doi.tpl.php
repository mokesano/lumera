<?php /* Smarty version 2.6.26, created on 2026-04-04 05:48:05
         compiled from article/citedby_doi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'article/citedby_doi.tpl', 49, false),)), $this); ?>
        ...
        <div class="u-margin-m-top metrics-details">
            <div id="citing-articles">
                ...
                <div id="citing-info" class="citing-info">
                    <span class="update-info">Updated: <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d %B %Y") : smarty_modifier_date_format($_tmp, "%d %B %Y")); ?>
</span>
                </div>
