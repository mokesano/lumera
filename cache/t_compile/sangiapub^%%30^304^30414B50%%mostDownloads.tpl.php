<?php /* Smarty version 2.6.26, created on 2026-04-04 06:08:33
         compiled from common/featured/mostDownloads.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'common/featured/mostDownloads.tpl', 26, false),array('function', 'url', 'common/featured/mostDownloads.tpl', 38, false),array('modifier', 'count', 'common/featured/mostDownloads.tpl', 26, false),array('modifier', 'date_format', 'common/featured/mostDownloads.tpl', 41, false),array('modifier', 'escape', 'common/featured/mostDownloads.tpl', 60, false),array('modifier', 'number_format', 'common/featured/mostDownloads.tpl', 74, false),)), $this); ?>
<?php 
...
<section id="latest-downloaded" class="live-area u-mt-48 u-mb-32" data-track-component="latest downloaded grid">
    ...
    <div id="articles-downloaded" class="c-article-most__downloaded">
        <div class="u-container c-section-heading c-slice-heading">
            <h2 class="titles u-ma-0">
                <span class="title">Most downloads</span>
...
"><svg class="c-section-heading__icon" aria-hidden="true" focusable="false" height="20" width="20" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="m4.08573416 5.70052374 2.48162731-2.4816273c.39282216-.39282216 1.02197315-.40056173 1.40306523-.01946965.39113012.39113012.3914806 1.02492687-.00014045 1.41654791l-4.17620791 4.17620792c-.39120769.39120768-1.02508144.39160691-1.41671995-.0000316l-4.17639421-4.1763942c-.39122513-.39122514-.39767006-1.01908149-.01657797-1.40017357.39113012-.39113012 1.02337105-.3930364 1.41951348.00310603l2.48183447 2.48183446.99770587 1.01367533z" transform="matrix(0 -1 1 0 2.081146 11.085734)"></path></svg>
            ...
            <span class="u-font-sans">Last update: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUpdateDate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d %b %Y, %H:%M") : smarty_modifier_date_format($_tmp, "%d %b %Y, %H:%M")); ?>
...
<li class="app-reviews-row__main">
    <ul class="app-reviews-row__grid">
        <?php if ($this->_tpl_vars['topDownloadedArticle'] && count ( $this->_tpl_vars['topDownloadedArticle'] ) > 0): ?>
        <?php $_from = $this->_tpl_vars['topDownloadedArticle']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?as=webp 290w,<?php echo $this->_tpl_vars['article']['cover_image']['file_url']; ?>
?as=webp 485w" sizes="(max-width: 768px) 290px,(max-width: 1200px) 485px,485px"><img src="<?php echo $this->_tpl_vars['article']['cover_image']['file_url']; ?>
" alt="<?php echo $this->_tpl_vars['article']['title']; ?>
" itemprop="image"></picture>
                            </div>
                            <?php else: ?>
                            <div class="c-card__image"><picture><source type="image/webp" srcset="//assets.sangia.org/static/images/not-available.webp 450w, //assets.sangia.org/static/images/not-available.webp 735w" sizes="(max-width: 1024px) 450px,(max-width: 100vw) 735px 735px"><img src="https://assets.sangia.org/static/images/not-available.webp" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" itemprop="image"></picture>
    				        </div>
                            <?php endif; ?>
                            <div class="c-card__body u-display-flex u-flex-direction-column">
                                <h3 class="c-card__title" itemprop="name headline"><a href="<?php echo $this->_tpl_vars['article']['article_url']; ?>
" class="c-card__link u-link-inherit" itemprop="url" data-track="click" data-track-action="view article" data-track-label="link"><?php echo $this->_tpl_vars['article']['title']; ?>
                                ...
                                <div class="c-card__section c-meta">
                                    <div>
                                        <?php if ($this->_tpl_vars['article']['authors'] && count ( $this->_tpl_vars['article']['authors'] ) > 0): ?><ul data-test="author-list" class="app-author-list app-author-list--compact"><?php $_from = $this->_tpl_vars['article']['authors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['authorLoop'] = array('total' => count($_from), 'iteration' => 0);
...
</span></span></li><?php endforeach; endif; unset($_from); ?></ul><?php endif; ?>
                                    </div>
...
</time><span class="c-meta__item rank">🏆 <?php echo ((is_array($_tmp=$this->_tpl_vars['article']['total_downloads'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
 times</span>
                                </div>
                            </div>
                        </div>
    ...
    <?php endif; ?>
        ...
        <?php if ($this->_tpl_vars['secondTierDownloadedArticles'] && count ( $this->_tpl_vars['secondTierDownloadedArticles'] ) > 0): ?>
        <?php $_from = $this->_tpl_vars['secondTierDownloadedArticles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['article']):
?>
...
?as=webp 290w" sizes="(max-width: 640px) 160px,(max-width: 1200px) 290px,290px"><img src="<?php echo $this->_tpl_vars['article']['cover_image']['file_url']; ?>
" alt="<?php echo $this->_tpl_vars['article']['title']; ?>
" itemprop="image"></picture>
                            </div>
                            <?php endif; ?>
...
if ($this->_foreach['authorLoop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['author']):
        $this->_foreach['authorLoop']['iteration']++;
?><li itemprop="creator" itemscope="" itemtype="http://schema.org/Person"><?php if ($this->_tpl_vars['author']['full_name']): ?><span class="u-hide" itemprop="full-name"><?php echo $this->_tpl_vars['author']['full_name']; ?>
</span><?php endif; ?><?php if ($this->_tpl_vars['author']['first_name'] !== $this->_tpl_vars['author']['last_name']): ?><span itemprop="given-name"><?php echo $this->_tpl_vars['author']['first_name']; ?>
</span><?php endif; ?><?php if ($this->_tpl_vars['author']['middle_name']): ?><span itemprop="middle-name"><?php echo $this->_tpl_vars['author']['middle_name']; ?>
</span><?php endif; ?><span itemprop="surname"><?php echo $this->_tpl_vars['author']['last_name']; ?>
</span></li><?php endforeach; endif; unset($_from); ?></ul><?php endif; ?>
                            </div>
                            <span class="c-meta__item" data-test="article.type"><span class="c-meta__type"><?php echo $this->_tpl_vars['article']['article_type']; ?>
...
<?php if ($this->_tpl_vars['thirdTierDownloadedArticles'] && count ( $this->_tpl_vars['thirdTierDownloadedArticles'] ) > 0): ?>
<li>
    <ul class="app-reviews-row__side">
            <?php $_from = $this->_tpl_vars['thirdTierDownloadedArticles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['article']):
?>
            ...
            <div class="u-full-height">
                <div class="u-full-height" data-native-ad-placement="false">
                    <article class="u-full-height c-card c-card--flush" itemscope="" itemtype="http://schema.org/ScholarlyArticle">
                        <div class="c-card__layout u-full-height">
                            <div class="c-card__body u-display-flex u-flex-direction-column">
                                <h3 class="c-card__title elipsis" itemprop="name headline"><a href="<?php echo $this->_tpl_vars['article']['article_url']; ?>
" class="c-card__link u-link-inherit" itemprop="url" data-track="click" data-track-action="view article" data-track-label="link"><?php echo $this->_tpl_vars['article']['title']; ?>
</a>
                                </h3>
                            </div>
