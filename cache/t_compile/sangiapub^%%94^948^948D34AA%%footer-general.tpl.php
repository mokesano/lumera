<?php /* Smarty version 2.6.26, created on 2026-04-04 19:37:22
         compiled from common/footer-parts/footer-general.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'call_hook', 'common/footer-parts/footer-general.tpl', 21, false),array('function', 'translate', 'common/footer-parts/footer-general.tpl', 25, false),array('function', 'url', 'common/footer-parts/footer-general.tpl', 152, false),array('function', 'get_debug_info', 'common/footer-parts/footer-general.tpl', 199, false),array('modifier', 'escape', 'common/footer-parts/footer-general.tpl', 25, false),array('modifier', 'regex_replace', 'common/footer-parts/footer-general.tpl', 25, false),array('modifier', 'strip_unsafe_html', 'common/footer-parts/footer-general.tpl', 48, false),array('modifier', 'nl2br', 'common/footer-parts/footer-general.tpl', 48, false),array('modifier', 'strip_tags', 'common/footer-parts/footer-general.tpl', 52, false),array('modifier', 'assign', 'common/footer-parts/footer-general.tpl', 164, false),array('modifier', 'date_format', 'common/footer-parts/footer-general.tpl', 167, false),)), $this); ?>
        ...
        <div class="c-corporate-footer u-font-sans" role="contentinfo"> 
            <div id="pageFooter" class="u-container">
                <div class="sangia-footer text-xs u-padding-l-ver ">
                    <div class="sangia-footer-sangia u-margin-m-bottom u-margin-0-bottom-from-md u-margin-s-right u-margin-m-right-from-md u-margin-l-right-from-lg"><img loading="lazy" src="//assets.sangia.org/img/sangia-mono-branded-72x89-v2.svg" alt="Sangia Publishing logo" width="68" height="auto" /></div>
...
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
 ...
 <a class="anchor" href="//publishing.sangia.org" target="_blank"><span class="anchor-text">Sangia Publishing</span></a> unless otherwise stated. Part of <a class="anchor" href="//www.insw.go.id/nib" target="_blank"><span class="anchor-text">Sangia Research Media and Publishing</span></a> | NIB: 1111220205313.</p>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js@3.7.1" type="text/javascript" referrerpolicy="strict-origin-when-cross-origin"></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/pako@2.0.4/dist/pako.min.js" type="text/javascript" referrerpolicy="strict-origin-when-cross-origin"></script>
    
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/journal-stats.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
