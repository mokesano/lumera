<?php /* Smarty version 2.6.26, created on 2026-04-04 05:39:07
         compiled from common/footer-parts/footer-user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'common/footer-parts/footer-user.tpl', 26, false),array('modifier', 'escape', 'common/footer-parts/footer-user.tpl', 26, false),array('modifier', 'assign', 'common/footer-parts/footer-user.tpl', 144, false),array('modifier', 'date_format', 'common/footer-parts/footer-user.tpl', 147, false),array('function', 'translate', 'common/footer-parts/footer-user.tpl', 34, false),array('function', 'url', 'common/footer-parts/footer-user.tpl', 132, false),array('function', 'call_hook', 'common/footer-parts/footer-user.tpl', 161, false),array('function', 'get_debug_info', 'common/footer-parts/footer-user.tpl', 180, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "common/chatbox.tpl", 'smarty_include_vars' => array()));
...
/assets/js/sangiastyle.js" type="text/javascript"></script>
        <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/submission-progress.js" type="text/javascript"></script>
