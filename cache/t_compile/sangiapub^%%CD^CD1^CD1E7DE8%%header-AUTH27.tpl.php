<?php /* Smarty version 2.6.26, created on 2026-04-04 05:39:17
         compiled from common/header-AUTH27.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'common/header-AUTH27.tpl', 2, false),array('modifier', 'assign', 'common/header-AUTH27.tpl', 13, false),array('modifier', 'escape', 'common/header-AUTH27.tpl', 21, false),array('function', 'translate', 'common/header-AUTH27.tpl', 13, false),array('function', 'call_hook', 'common/header-AUTH27.tpl', 39, false),array('function', 'url', 'common/header-AUTH27.tpl', 80, false),)), $this); ?>
<!DOCTYPE html>
...
<head>
    <title><?php if (((is_array($_tmp=$this->_tpl_vars['firstName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)) !== ((is_array($_tmp=$this->_tpl_vars['lastName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['firstName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?><?php if ($this->_tpl_vars['middleName']): ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['middleName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['lastName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 - <?php echo $this->_tpl_vars['pageTitleTranslated']; ?>
 | <?php if ($this->_tpl_vars['currentJournal']): ?>Sangia Publishing<?php else: ?><?php echo $this->_tpl_vars['siteTitle']; ?>
<?php endif; ?></title>
