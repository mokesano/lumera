<?php /* Smarty version 2.6.26, created on 2026-04-07 02:47:44
         compiled from about/subscriptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'about/subscriptions.tpl', 25, false),array('modifier', 'strip_tags', 'about/subscriptions.tpl', 26, false),array('modifier', 'string_format', 'about/subscriptions.tpl', 98, false),array('modifier', 'number_format', 'about/subscriptions.tpl', 98, false),array('modifier', 'default', 'about/subscriptions.tpl', 107, false),array('modifier', 'nl2br', 'about/subscriptions.tpl', 126, false),array('modifier', 'strip_unsafe_html', 'about/subscriptions.tpl', 308, false),array('modifier', 'truncate', 'about/subscriptions.tpl', 308, false),array('function', 'translate', 'about/subscriptions.tpl', 64, false),array('function', 'math', 'about/subscriptions.tpl', 110, false),array('function', 'mailto', 'about/subscriptions.tpl', 279, false),array('function', 'url', 'about/subscriptions.tpl', 303, false),array('block', 'iterate', 'about/subscriptions.tpl', 91, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "about.subscriptions"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php endif; ?>" style="width: 100%; max-width: 230px; display: block;" />
            ...
            <picture>
                ...
                <img loading="lazy" class="lazyload journal-cover" src="//assets.sangia.org/img/img-default.jpg" alt="journal cover" style="width: 100%; max-width: 230px; display: block;" />
            </picture>
            <?php endif; ?>
        </div>
 ...
 (Print)</span><?php endif; ?>
                ...
                <div class="Type-2225587032">
                    <dt data-section-outline-level="3"><b data-section-outline-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.subscribeLength"), $this);?>
:</b>
                    </dt>
                    ...
                    <dd data-section-outline-level="3" data-section-layout-level="1">1 Year Subscription with <?php echo ((is_array($_tmp=$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 Issues (plus online access to all articles starting <?php echo ((is_array($_tmp=$this->_tpl_vars['firstYear'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
)</dd>
                </div>
                <div data-section-outline-level="3" class="Type-1803463199" data-section-layout-level="1">
                    <dt data-section-outline-level="3" data-section-layout-level="1"><b data-section-outline-level="3" data-section-layout-level="1"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.accessOptions"), $this);?>
:</b>
                    </dt>
...
<aside role="complementary" data-section-outline-level="2" class="AsideBox-1834393749" data-section-layout-level="2">
    <?php if (! $this->_tpl_vars['individualSubscriptionTypes']->wasEmpty()): ?>
        <?php $this->_tag_stack[] = array('iterate', array('from' => 'individualSubscriptionTypes','item' => 'subscriptionType')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                ...
                <details data-section-outline-level="2" class="Details-2932877531" data-section-layout-level="2" open="">
                    <summary class="subscription-type NoneDetailsMarker-270967514" data-section-outline-level="2" data-section-layout-level="2">
                        <div data-section-outline-level="2" class="SummaryStyle-2218521826" data-section-layout-level="2"><svg width="14px" height="14px" viewBox="0 0 32 32" class="details-marker Marker-1664207171" data-section-outline-level="2" data-section-layout-level="2"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z" data-section-outline-level="2" data-section-layout-level="2"></path></svg>
                            <span data-section-outline-level="2" class="SubscriptionName-411063136" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getSubscriptionTypeName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
                            <span data-section-outline-level="2" class="SummaryPrice-3689769601" data-section-layout-level="2"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCost())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
                        ...
                        <div class="input-field PriceInfoBox-2218521826 checked" style="position: relative" data-section-outline-level="3" data-section-layout-level="3"><input type="radio" id="input-PS-Journal-subscription" class="radio-checked RadioCircle-1664207171" name="subscription-type" value="PS" checked="checked" style="display: none" data-original-index="0" data-section-outline-level="3" data-section-layout-level="4">
                            <label class="price-info Flex-411063136" for="input-PS-Journal-subscription" data-section-outline-level="3" data-section-layout-level="3">
                                <div class="prices-total  TotalPriceRow-3898465696" data-section-outline-level="3" data-section-layout-level="3">
                                    <div data-section-outline-level="3" class="Type-3344151041" data-section-layout-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => $this->_tpl_vars['subscriptionType']->getFormatString()), $this);?>
</div>
                                    <div id="effective-price" data-section-outline-level="3" class="BasketEffectivePriceCell-538306978" data-section-layout-level="3"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCost())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCurrencyStringShort())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
                                    <?php $this->assign('subCost', ((is_array($_tmp=@$this->_tpl_vars['subscriptionType']->getCost())) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                                    <?php $this->assign('issueCount', ((is_array($_tmp=@$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                                    <?php if ($this->_tpl_vars['issueCount'] > 0): ?>
                                        <?php echo smarty_function_math(array('equation' => "x / y",'x' => $this->_tpl_vars['subCost'],'y' => $this->_tpl_vars['issueCount'],'format' => "%.2f",'assign' => 'pricePerIssue'), $this);?>

                                    <?php else: ?>
                                        <?php $this->assign('pricePerIssue', 0); ?>
                                    <?php endif; ?>
                                    <div class="single-issue BasketRegularPriceCell-3978918244" data-section-outline-level="3" data-section-layout-level="3">only <?php echo ((is_array($_tmp=$this->_tpl_vars['pricePerIssue'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCurrencyStringShort())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 per issue</div>
                                </div>
                            </label>
                        </div>
                        <button id="subscribe-submit-Journal-subscription" type="submit" data-track="cart-add" data-track-product="0" data-section-outline-level="3" class="ButtonPrimary-171795905" data-section-layout-level="3"><span data-section-outline-level="3" class="ButtonLabel-1664207171" data-section-layout-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.subscribe"), $this);?>
</span>
                        </button>
                        ...
                        <ul class="usps-list ListInset-3866894855" id="usps" data-section-outline-level="4" data-section-layout-level="2">
                            <?php if ($this->_tpl_vars['alternatePageHeader']): ?>
                            <li data-section-outline-level="4" class="ListElement-1664207171" data-section-layout-level="2">Sinta Score <?php echo $this->_tpl_vars['alternatePageHeader']; ?>
 of this journal</li>
                            <?php endif; ?>
                            <?php if ($this->_tpl_vars['subscriptionType']->getSubscriptionTypeDescription()): ?>
                            <li data-section-outline-level="4" class="ListElement-1664207171" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getSubscriptionTypeDescription())) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</li>
                            <?php endif; ?>
                			...
                			<?php $this->assign('issuePerVolume', $this->_tpl_vars['currentJournal']->getSetting('issuePerVolume')); ?>
                			<?php $this->assign('firstYear', $this->_tpl_vars['currentJournal']->getSetting('initialYear')); ?>
                            <li data-section-outline-level="4" class="ListElement-1282713543" data-section-layout-level="2">1 Year Subscription with <?php echo ((is_array($_tmp=$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 Issues (plus online access to all articles starting <?php echo ((is_array($_tmp=$this->_tpl_vars['firstYear'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
)</li>
                        </ul>
                    </article>
    ...
    <div data-section-outline-level="2" data-section-layout-level="2">
        <form data-reflect-state="true" method="post" data-section-outline-level="2" class="SubscribeForm-3185356244 subscribe-issue" data-section-layout-level="2">
            <details data-section-outline-level="2" class="Details-2932877531" data-section-layout-level="2" open="">
                <summary class="subscription-type NoneDetailsMarker-270967514" data-section-outline-level="2" data-section-layout-level="2">
                    <div data-section-outline-level="2" class="SummaryStyle-2218521826" data-section-layout-level="2"><svg width="14px" height="14px" viewBox="0 0 32 32" class="details-marker Marker-1664207171" data-section-outline-level="2" data-section-layout-level="2"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z" data-section-outline-level="2" data-section-layout-level="2"></path></svg>
                        <span data-section-outline-level="2" class="SubscriptionName-411063136" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.subscriptions"), $this);?>
</span>
                        <?php $this->assign('purchaseFee', ((is_array($_tmp=@$this->_tpl_vars['currentJournal']->getSetting('purchaseIssueFee'))) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                        <?php $this->assign('issueCount', ((is_array($_tmp=@$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                        <?php if ($this->_tpl_vars['issueCount'] > 0): ?>
                            <?php echo smarty_function_math(array('equation' => "x * y",'x' => $this->_tpl_vars['purchaseFee'],'y' => $this->_tpl_vars['issueCount'],'format' => "%.2f",'assign' => 'summaryPrice'), $this);?>

                        <?php else: ?>
                            <?php $this->assign('summaryPrice', 0); ?>
                        <?php endif; ?>
                        <span data-section-outline-level="2" class="SummaryPrice-3689769601" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['summaryPrice'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('currency'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
                    </div>
                </summary>
                <article data-section-outline-level="3" data-section-layout-level="2">
                    <div class="input-field PriceInfoBox-2218521826 checked" style="position: relative" data-section-outline-level="3" data-section-layout-level="3"><input type="radio" id="input-PS-Journal-subscription" class="radio-checked RadioCircle-1664207171" name="subscription-type" value="PS" checked="checked" style="display: none" data-original-index="0" data-section-outline-level="3" data-section-layout-level="4">
                        <label class="price-info Flex-411063136" for="input-PS-Journal-subscription" data-section-outline-level="3" data-section-layout-level="3">
                            <div class="prices-total  TotalPriceRow-3898465696" data-section-outline-level="3" data-section-layout-level="3">
                                <div data-section-outline-level="3" class="Type-3344151041" data-section-layout-level="3"><?php if ($this->_tpl_vars['onlineIssn']): ?> <?php else: ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?>Online<?php else: ?>Online (<i>on proccess</i>)<?php endif; ?><?php endif; ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?> &amp; Print<?php endif; ?></div>
                                <?php $this->assign('purchaseFee', ((is_array($_tmp=@$this->_tpl_vars['currentJournal']->getSetting('purchaseIssueFee'))) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                                <?php $this->assign('issueCount', ((is_array($_tmp=@$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
                                <?php if ($this->_tpl_vars['issueCount'] > 0): ?>
                                    <?php echo smarty_function_math(array('equation' => "x * y",'x' => $this->_tpl_vars['purchaseFee'],'y' => $this->_tpl_vars['issueCount'],'format' => "%.2f",'assign' => 'totalPrice'), $this);?>

                                <?php else: ?>
                                    <?php $this->assign('totalPrice', 0); ?>
                                <?php endif; ?>
                                <div id="effective-price" data-section-outline-level="3" class="BasketEffectivePriceCell-538306978" data-section-layout-level="3"><?php echo ((is_array($_tmp=$this->_tpl_vars['totalPrice'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('currency'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
                                <div class="single-issue BasketRegularPriceCell-3978918244" data-section-outline-level="3" data-section-layout-level="3">only <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('purchaseIssueFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('currency'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 per issue</div>
                            </div>
                        </label>
                    </div>
                    <?php if (((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('currency'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))): ?>
                    <button id="subscribe-submit-Journal-subscription" type="submit" data-track="cart-add" data-track-product="0" data-section-outline-level="3" class="ButtonPrimary-171795905" data-section-layout-level="3"><span data-section-outline-level="3" class="ButtonLabel-1664207171" data-section-layout-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.subscribe"), $this);?>
</span>
                    </button>
                    <?php endif; ?>
 ...
 Issues (plus online access to all articles starting <?php echo ((is_array($_tmp=$this->_tpl_vars['firstYear'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
    ...
    <?php if (! $this->_tpl_vars['institutionalSubscriptionTypes']->wasEmpty()): ?>
    <div data-reflect-state="true" data-section-outline-level="2" class="Institutional-269378647" data-section-layout-level="2">
        <details data-section-outline-level="2" class="Details-3185356244" data-section-layout-level="2">
            <?php $this->_tag_stack[] = array('iterate', array('name' => 'subs','from' => 'institutionalSubscriptionTypes','item' => 'subscriptionType')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
            <summary class="subscription-type NoneDetailsMarker-2932877531" data-section-outline-level="2" data-section-layout-level="2">
                <div data-section-outline-level="2" class="SummaryStyle-270967514" data-section-layout-level="2"><svg width="14px" height="14px" viewBox="0 0 32 32" class="details-marker Marker-2218521826" data-section-outline-level="2" data-section-layout-level="2"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z" data-section-outline-level="2" data-section-layout-level="2"></path></svg>
                    <span data-section-outline-level="2" class="SubscriptionName-171795905" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getSubscriptionTypeName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
...
&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getCurrencyStringShort())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 ...
 per issue</div>
                ...
                <ul class="usps-list ListInset-3866894855" id="usps" data-section-outline-level="4" data-section-layout-level="2">
                    <li data-section-outline-level="4" class="ListElement-411063136" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "subscriptions.institutionalDescription"), $this);?>
</li>
                    <?php if ($this->_tpl_vars['subscriptionType']->getSubscriptionTypeDescription()): ?>
                    <li data-section-outline-level="4" class="ListElement-1664207171" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionType']->getSubscriptionTypeDescription())) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</li>
...
<section class="SubscriberFooter-1037694867">
    <div class="GridLiveArea-2081012695">
        <section data-section-outline-level="3">
            ...
            <p class="u-hide FooterLink-2407621270"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.name"), $this);?>
: <b><?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</b></p>
            <?php endif; ?>
...
: +6285343880383</p>
        	...
        	<p class="Type-269378647"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.fax"), $this);?>
: <?php echo ((is_array($_tmp=$this->_tpl_vars['subscriptionFax'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
            ...
            <p class="Type-851350800"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.mailingAddress"), $this);?>
:<br /><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionMailingAddress'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</p>
            <?php endif; ?>
        ...
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 data-section-outline-level="3" class="Type-1552298965" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "gifts.purchaseGiftSubscription"), $this);?>
</h3>
            <?php if ($this->_tpl_vars['acceptGiftSubscriptionPayments']): ?>
            <p data-section-outline-level="3" class="Type-2407621270" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "gifts.giftSubscriptionsAvailable"), $this);?>
</p>
            <?php else: ?>
            ...
            <?php endif; ?>
            <p data-section-outline-level="3" class="FooterLink-269378647" data-section-layout-level="2">Find out more: <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'gifts','op' => 'purchaseGiftSubscription'), $this);?>
" data-section-outline-level="3" data-section-layout-level="2">sangia.org/gifts</a></p>
        </section>
        <section data-section-outline-level="3" data-section-layout-level="2">
            ...
            <p data-section-outline-level="3" class="Type-2407621270" data-section-layout-level="2"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['subscriptionAdditionalInformation'])) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 227, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 227, "...")); ?>
</p>
            <?php else: ?>
