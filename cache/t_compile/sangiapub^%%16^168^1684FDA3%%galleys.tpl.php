<?php /* Smarty version 2.6.26, created on 2026-04-04 21:33:33
         compiled from file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'plugin_url', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 30, false),array('function', 'translate', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 38, false),array('function', 'url', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 61, false),array('function', 'page_info', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 86, false),array('function', 'page_links', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 87, false),array('block', 'iterate', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 47, false),array('modifier', 'strip_tags', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 61, false),array('modifier', 'to_array', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 62, false),array('modifier', 'cat', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 62, false),array('modifier', 'strip_unsafe_html', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 62, false),array('modifier', 'escape', 'file:/home/sangiaor/public_html/journals/plugins/importexport/datacite/templates/galleys.tpl', 63, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "plugins.importexport.common.export.selectGalley"); ?><?php echo ''; ?><?php $this->assign('pageCrumbTitle', "plugins.importexport.common.export.selectGalley"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" method="post" id="galleysForm">
		...
		<table width="100%" class="listing">
			...
			<?php $this->_tag_stack[] = array('iterate', array('from' => 'galleys','item' => 'galleyData')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				...
				<?php if ($this->_tpl_vars['galley']->getData('datacite::registeredDoi')): ?>
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedTitle())) ? $this->_run_mod_handler('cat', true, $_tmp, ' (') : smarty_modifier_cat($_tmp, ' (')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['galley']->getLabel()) : smarty_modifier_cat($_tmp, $this->_tpl_vars['galley']->getLabel())))) ? $this->_run_mod_handler('cat', true, $_tmp, ', ') : smarty_modifier_cat($_tmp, ', ')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['language']->getName()) : smarty_modifier_cat($_tmp, $this->_tpl_vars['language']->getName())))) ? $this->_run_mod_handler('cat', true, $_tmp, ')') : smarty_modifier_cat($_tmp, ')')))) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)); ?>
					...
					<td align="right"><nobr>
						<?php if ($this->_tpl_vars['hasCredentials']): ?>
							<a href="<?php echo $this->_plugins['function']['plugin_url'][0][0]->smartyPluginUrl(array('path' => 'process','galleyId' => $this->_tpl_vars['galley']->getId(),'params' => $this->_tpl_vars['testMode'],'target' => 'galley','register' => true), $this);?>
" title="<?php echo $this->_tpl_vars['updateOrRegisterDescription']; ?>
" class="action"><?php echo $this->_tpl_vars['updateOrRegister']; ?>
</a>
						<?php endif; ?>
						<a href="<?php echo $this->_plugins['function']['plugin_url'][0][0]->smartyPluginUrl(array('path' => 'process','galleyId' => $this->_tpl_vars['galley']->getId(),'params' => $this->_tpl_vars['testMode'],'target' => 'galley','export' => true), $this);?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.export"), $this);?>
				...
				<?php if ($this->_tpl_vars['galleys']->eof()): ?>
				<tr>
					<td colspan="5" class="<?php if ($this->_tpl_vars['galleys']->eof()): ?>end<?php endif; ?>separator">&nbsp;</td>
				</tr>
				<?php endif; ?>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php if ($this->_tpl_vars['galleys']->wasEmpty()): ?>
				<tr>
					<td colspan="5" class="nodata"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.importexport.common.export.noGalleys"), $this);?>
</td>
				</tr>
				<tr>
			...
			<?php else: ?>
				<tr>
					<td colspan="2" align="left"><?php echo $this->_plugins['function']['page_info'][0][0]->smartyPageInfo(array('iterator' => $this->_tpl_vars['galleys']), $this);?>
</td>
					<td colspan="3" align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'galleys','name' => 'galleys','iterator' => $this->_tpl_vars['galleys']), $this);?>
</td>
				</tr>
			<?php endif; ?>
		</table>
