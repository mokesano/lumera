<?php /* Smarty version 2.6.26, created on 2026-04-14 02:19:30
         compiled from billing/invoice.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'billing/invoice.tpl', 59, false),array('modifier', 'nl2br', 'billing/invoice.tpl', 74, false),array('modifier', 'date_format', 'billing/invoice.tpl', 85, false),array('modifier', 'strip_unsafe_html', 'billing/invoice.tpl', 108, false),array('function', 'url', 'billing/invoice.tpl', 203, false),)), $this); ?>
 ...
 <?php echo $this->_tpl_vars['formattedAmount']; ?>
    ...
    <?php endif; ?>
        ...
        <a class="cancel-action"
           href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'billing','op' => 'cancel','path' => $this->_tpl_vars['securePath']), $this);?>
"
           onclick="return confirm('Apakah Anda yakin ingin membatalkan tagihan ini?');">
            <i class="icon-remove"></i> Cancel Billing
        </a>
        <?php endif; ?>
        <a class="download" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['pdfDownloadUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" target="_blank">
...
";
    const payUrl    = "<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'billing','op' => 'pay','path' => $this->_tpl_vars['securePath']), $this);?>
";
