<?php /* Smarty version 2.6.26, created on 2026-04-04 22:21:30
         compiled from file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'plugin_url', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 30, false),array('function', 'translate', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 30, false),array('function', 'url', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 60, false),array('function', 'page_info', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 89, false),array('function', 'page_links', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 90, false),array('block', 'iterate', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 49, false),array('modifier', 'strip_unsafe_html', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 60, false),array('modifier', 'nl2br', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 60, false),array('modifier', 'date_format', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 61, false),array('modifier', 'default', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 61, false),array('modifier', 'escape', 'file:/home/sangiaor/public_html/journals/plugins/importexport/crossref/templates/issues.tpl', 62, false),)), $this); ?>
...
<div id="issues">
	<div><a class="link-button" href="<?php echo $this->_plugins['function']['plugin_url'][0][0]->smartyPluginUrl(array('path' => 'articles'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.importexport.crossref.manageArticles"), $this);?>
</a></div>
	<br />
...
" method="post" id="issuesForm">
		...
		<table width="100%" class="listing">
			...
			<?php $this->_tag_stack[] = array('iterate', array('from' => 'issues','item' => 'issue')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				...
				<?php if ($this->_tpl_vars['allArticlesRegistered'][$this->_tpl_vars['issueId']]): ?>
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['issue']->getIssueIdentification())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
					...
					<td><?php echo ((is_array($_tmp=$this->_tpl_vars['numArticles'][$this->_tpl_vars['issueId']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
					<td align="right">
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.importexport.crossref.downloadXML"), $this);?>
</a>
							</nobr>
						<?php endif; ?>
					</td>
				</tr>
				<?php if ($this->_tpl_vars['issues']->eof()): ?>
				<tr>
		...
		<?php if (! $this->_tpl_vars['allExcluded']): ?>
			<p>
