<?php /* Smarty version 2.6.26, created on 2026-04-04 21:00:22
         compiled from about/editorialTeamBoard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'call_hook', 'about/editorialTeamBoard.tpl', 16, false),array('function', 'url', 'about/editorialTeamBoard.tpl', 34, false),array('modifier', 'string_format', 'about/editorialTeamBoard.tpl', 25, false),array('modifier', 'escape', 'about/editorialTeamBoard.tpl', 25, false),array('modifier', 'explode', 'about/editorialTeamBoard.tpl', 38, false),array('modifier', 'count', 'about/editorialTeamBoard.tpl', 39, false),array('modifier', 'trim', 'about/editorialTeamBoard.tpl', 41, false),)), $this); ?>
...
<div class="publication-editors">
	...
	<div class="publication-editor-type"><?php echo $this->_tpl_vars['group']->getLocalizedTitle(); ?>
</div>
...
?>
		...
		<div id="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['user']->getId())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%011d") : smarty_modifier_string_format($_tmp, "%011d")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
?as=webp" type="image/webp" loading="lazy" >
			    <img class="lazyload" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
?as=webp" type="image/webp" loading="lazy" />
			...
			<?php endif; ?>
			<?php $this->assign('user', $this->_tpl_vars['member']->getUser()); ?>
			<div class="publication-editor-name cms-person"><?php if ($this->_tpl_vars['user']->getLocalizedBiography() || $this->_tpl_vars['user']->getGoogleScholar() || $this->_tpl_vars['user']->getScopusId() || $this->_tpl_vars['user']->getSintaId()): ?><h3 class="card__title" itemprop="editor" itemscope="name" itemtype="http://schema.org/Person"><a class="card__link" title="View <?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 profile" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialTeamBio','path' => ((is_array($_tmp=$this->_tpl_vars['user']->getId())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%011d") : smarty_modifier_string_format($_tmp, "%011d")),'from' => 'board','anchor' => ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))), $this);?>
"><span class="fullname u-hide"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span><?php if ($this->_tpl_vars['user']->getSalutation()): ?><span class="text degree"><?php echo $this->_tpl_vars['user']->getSalutation(); ?>
...
</span><?php if ($this->_tpl_vars['user']->getSuffix()): ?><span class="text last-degree"><?php echo $this->_tpl_vars['user']->getSuffix(); ?>
</span><?php endif; ?></a><?php if ($this->_tpl_vars['user']->getData('orcid')): ?><span class="orcid"><a title="Go to Orcid profile of <?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" target="_blank"><img class="lazyload" src="//assets.sangia.org/img/orcid_16x16.svg" style="height:16px" alt="orcid" /></a></span><?php endif; ?><?php if ($this->_tpl_vars['user']->getData('sintaId')): ?><span class="sintaid"><a title="Go to Sinta profile of <?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" href="//sinta.kemdiktisaintek.go.id/authors/profile/<?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getData('sintaId'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" target="_blank" class="sintaid"><img class="lazyload" src="//sinta.kemdiktisaintek.go.id/public/assets/img/brand_sinta.png" style="height:18px" alt="sinta" referrerpolicy="strict-origin-when-cross-origin" /></a></span><?php endif; ?><?php if ($this->_tpl_vars['user']->getData('scopusId')): ?><span class="scopus"><a title="Go to Scopus profile of <?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
</span><?php if ($this->_tpl_vars['user']->getSuffix()): ?><span class="text last-degree"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getSuffix())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span><?php endif; ?></h3><?php endif; ?>
			</div>
			<input id="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['user']->getId())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%09d") : smarty_modifier_string_format($_tmp, "%09d")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" type="hidden" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getGender())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" name="gender">
...
<?php if ($this->_tpl_vars['index'] == $this->_tpl_vars['affiliationCount'] - 1 && $this->_tpl_vars['user']->getCountry()): ?><?php $this->assign('countryCode', $this->_tpl_vars['user']->getCountry()); ?><?php $this->assign('country', $this->_tpl_vars['countries'][$this->_tpl_vars['countryCode']]); ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['country'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?>
                        </span>
                    </div>
                    <?php endif; ?>
            ...
            <div class="sc-1mur6on-9 bLswwL publication-editor-interest GooSSiP">
        		...
        		<span class="sc-1q3g1nv-0 sc-1mur6on-13 eTETae fziRAl" itemprop="" itemtype="http://schema.org/Affiliation"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getLocalizedGossip())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
            </div>
            <?php endif; ?>
            ...
            <div class="sc-1mur6on-9 bLswwL publication-editor-interest">
				...
				<span class="sc-1q3g1nv-0 sc-1mur6on-13 eTETae fziRAl"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getInterestString())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
			</div>
			<?php endif; ?>
			<div class="clearfix"></div>		
		</div>
		<?php endforeach; endif; unset($_from); ?>	<div class="clearfix"></div>	
</div>
<?php endforeach; endif; unset($_from); ?>
</section>
</section>
