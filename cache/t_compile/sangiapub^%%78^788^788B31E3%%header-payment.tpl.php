<?php /* Smarty version 2.6.26, created on 2026-04-14 02:27:15
         compiled from common/header-parts/header-payment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'common/header-parts/header-payment.tpl', 2, false),array('modifier', 'assign', 'common/header-parts/header-payment.tpl', 13, false),array('modifier', 'escape', 'common/header-parts/header-payment.tpl', 23, false),array('modifier', 'string_format', 'common/header-parts/header-payment.tpl', 137, false),array('modifier', 'date_format', 'common/header-parts/header-payment.tpl', 164, false),array('function', 'translate', 'common/header-parts/header-payment.tpl', 13, false),array('function', 'call_hook', 'common/header-parts/header-payment.tpl', 39, false),array('function', 'url', 'common/header-parts/header-payment.tpl', 80, false),)), $this); ?>
<!DOCTYPE html>
...
/assets/static/styles/user-home.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/static/styles/email-composer.css" type="text/css" />
...
<div class="journal-content sangia user u-mt-48" role="main">

<div class="live-area-wrapper">
	<div class="u-row row">
    	<div class="sidebar u-js-hide">
			<section class="column medium-3">
				<div id="myAccount" class="block pseudoMenu">
					...
					<ul>
					    <?php if ($this->_tpl_vars['isUserLoggedIn'] && $this->_tpl_vars['user']): ?>
					    <li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => "my-profile",'path' => ((is_array($_tmp=$this->_tpl_vars['userSession']->getUserId())) ? $this->_run_mod_handler('string_format', true, $_tmp, "%011d") : smarty_modifier_string_format($_tmp, "%011d"))), $this);?>
