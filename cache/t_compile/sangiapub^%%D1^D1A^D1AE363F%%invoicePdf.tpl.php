<?php /* Smarty version 2.6.26, created on 2026-04-12 21:35:33
         compiled from checkout/invoicePdf.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'checkout/invoicePdf.tpl', 78, false),array('modifier', 'nl2br', 'checkout/invoicePdf.tpl', 92, false),array('modifier', 'date_format', 'checkout/invoicePdf.tpl', 118, false),array('modifier', 'strip_unsafe_html', 'checkout/invoicePdf.tpl', 135, false),array('modifier', 'upper', 'checkout/invoicePdf.tpl', 189, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<table class="invoice-info" style="margin-bottom: 32px">
    <tr>
        ...
        <td width="30%" class="text-center">
            ...
            <div class="invoice-number">Invoice Number:  <?php echo ((is_array($_tmp=$this->_tpl_vars['wizdamInvoiceNumber'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
        </td>
    </tr>
</table>
...
<table class="publisher-info">
    <tr>
        <td>
            <div class="journal-title"><?php if ($this->_tpl_vars['journal']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?></div>
        </td>
    </tr>
    <tr>
        <td>
            <div style="font-size: 8pt; color: #555;">
                <?php if ($this->_tpl_vars['journal']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getSetting('mailingAddress'))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

                <br>
                <?php endif; ?>
                Mail: <?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getSetting('contactEmail'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<table class="info-billing">
    ...
    <tr>
        <td width="60%" style="vertical-align: top; margin-top: 10px; padding: 8px; ">
            <div class="font-bold" style="font-size: 10pt; "><?php echo ((is_array($_tmp=$this->_tpl_vars['authorName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
            <div style="font-size: 8pt;"><?php echo ((is_array($_tmp=$this->_tpl_vars['authorAffiliation'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</div>
            <div style="font-size: 8pt;">Corespondence email: <?php echo ((is_array($_tmp=$this->_tpl_vars['authorEmail'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
        </td>
        <td width="40%">
            <table class="summary-box">
                <tr><th class="font-bold text-left">AMOUNT DUE</th><th class="font-bold text-right"><?php echo $this->_tpl_vars['currencyCode']; ?>
 <?php echo $this->_tpl_vars['formattedAmount']; ?>
</th></tr>
                <tr><td>Date Billed</td><td class="text-right"><?php echo ((is_array($_tmp=$this->_tpl_vars['dateBilled'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d %B %Y") : smarty_modifier_date_format($_tmp, "%d %B %Y")); ?>
</td></tr>
                <tr><td>Invoice Code</td><td class="text-right"><?php echo ((is_array($_tmp=$this->_tpl_vars['wizdamInvoiceCode'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td></tr>
                <tr><td>Due Date</td><td class="font-bold text-right" style="color: <?php if ($this->_tpl_vars['isPaid']): ?>green<?php else: ?>red<?php endif; ?>;"><?php if ($this->_tpl_vars['isPaid']): ?>LUNAS<?php else: ?>BELUM LUNAS<?php endif; ?></td></tr>
            </table>
        </td>
    </tr>
</table>
...
<table class="item-table">
    ...
    <tr class="trasaction">
        ...
        <td style="word-wrap: break-word;"><?php if ($this->_tpl_vars['articleTitle']): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['articleTitle'])) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['localizedFeeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?></td>
        <td class="text-right"><?php echo $this->_tpl_vars['currencyCode']; ?>
 <?php if ($this->_tpl_vars['formattedFastTrackFee'] != "0.00"): ?><?php echo $this->_tpl_vars['formattedFastTrackFee']; ?>
<?php else: ?><?php echo $this->_tpl_vars['formattedBaseFee']; ?>
<?php endif; ?></td>
        <td class="text-right"><?php echo $this->_tpl_vars['currencyCode']; ?>
 <?php if ($this->_tpl_vars['formattedFastTrackFee'] != "0.00"): ?><?php echo $this->_tpl_vars['formattedFastTrackFee']; ?>
<?php else: ?><?php echo $this->_tpl_vars['formattedBaseFee']; ?>
...
<table class="summary-table">
 ...
 <?php echo $this->_tpl_vars['formattedDiscount']; ?>
    ...
    <tr class="sub-total">   
        ...
        <td width="20%" class="text-right"><?php echo $this->_tpl_vars['currencyCode']; ?>
 ...
 <?php echo $this->_tpl_vars['formattedDiscount']; ?>
    ...
    <tr class="tax">
        <td class="text-right">Tax/VAT (<?php echo $this->_tpl_vars['taxPercentage']; ?>
%) <small><?php if ($this->_tpl_vars['isTaxInclusive']): ?>Inclusive<?php else: ?>Exclusive<?php endif; ?></small></td>
        <td class="text-right"><?php echo $this->_tpl_vars['currencyCode']; ?>
...
<table class="item-table" style="margin-top: 5px; font-size: 10pt;">
    ...
    <tr class="trasaction">
        <td class="text-center"><?php echo ((is_array($_tmp=$this->_tpl_vars['datePaid'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y %H:%M:%S") : smarty_modifier_date_format($_tmp, "%d-%m-%Y %H:%M:%S")); ?>
</td>
