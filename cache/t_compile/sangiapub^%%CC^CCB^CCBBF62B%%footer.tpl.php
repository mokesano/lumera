<?php /* Smarty version 2.6.26, created on 2026-04-04 05:48:05
         compiled from article/footer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'article/footer.tpl', 51, false),array('function', 'url', 'article/footer.tpl', 157, false),array('function', 'call_hook', 'article/footer.tpl', 183, false),array('function', 'get_debug_info', 'article/footer.tpl', 254, false),array('modifier', 'strip_unsafe_html', 'article/footer.tpl', 60, false),array('modifier', 'nl2br', 'article/footer.tpl', 60, false),array('modifier', 'strip_tags', 'article/footer.tpl', 64, false),array('modifier', 'escape', 'article/footer.tpl', 64, false),array('modifier', 'assign', 'article/footer.tpl', 165, false),array('modifier', 'date_format', 'article/footer.tpl', 166, false),array('modifier', 'to_array', 'article/footer.tpl', 229, false),)), $this); ?>
...
<?php echo ''; ?><?php if ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')); ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('printIssn')); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
...
"><span class="anchor-text"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
                    ...
                    <?php endif; ?>            
                        <p class="srm-lisensing u-hide" style="margin-bottom: 0;"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 <?php if ($this->_tpl_vars['printIssn']): ?><?php else: ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?>ISSN: <a class="anchor" href="https://issn.org/resource/issn/<?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
</span></a> (Print) <?php endif; ?>ISSN: <?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><a class="anchor" href="https://issn.org/resource/issn/<?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
</span></a> (Online)<?php else: ?>on proccess (Online)<?php endif; ?>. <?php endif; ?> <?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.openJournalSystems"), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'applicationName') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'applicationName'));?>
<span class="srm-lisensing">Powered by <a class="anchor" href="https://pkp.sfu.ca/ojs/" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['applicationName']; ?>
</span></a> and <a class="anchor" href="https://github.com/masonpublishing/OJS-Theme" target="_blank"><span class="anchor-text">Mason Publishing</span></a> theme.</span></p>
                        <p class="srm-footer-copyright" style="margin-bottom:0">Copyright © 2017-<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y")); ?>
 <a class="anchor" href="https://www.sangia.org" target="_blank"><span class="anchor-text">Sangia Publishing</span></a> unless otherwise stated. Part of <a class="anchor" href="//www.insw.go.id/nib" target="_blank"><span class="anchor-text">Sangia Research Media and Publishing (SRM™)</span> | NIB: 1111220205313</a>.</p>
...
<?php echo '\')");
    ...
    <script src="//content.readcube.com/ping?doi=<?php echo $this->_tpl_vars['article']->getPubId('doi'); ?>
&amp;format=js" async="" type="text/javascript" referrerpolicy="strict-origin-when-cross-origin"></script>
    <?php endif; ?>
    
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/lazyload.js" defer></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/WizdamCitedby.js" defer></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/sangiastyle.js" defer></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/Wizdam-Article.js" defer></script>
