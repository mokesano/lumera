...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'about/index.tpl', 26, false),array('modifier', 'strip_tags', 'about/index.tpl', 27, false),array('modifier', 'string_format', 'about/index.tpl', 103, false),array('modifier', 'number_format', 'about/index.tpl', 103, false),array('modifier', 'nl2br', 'about/index.tpl', 156, false),array('function', 'translate', 'about/index.tpl', 70, false),array('function', 'math', 'about/index.tpl', 111, false),array('function', 'url', 'about/index.tpl', 212, false),array('function', 'call_hook', 'about/index.tpl', 218, false),array('block', 'iterate', 'about/index.tpl', 214, false),)), $this); ?>
...
<div data-section-outline-level="1">
    <div class="meta MetaFlex-1552298965">
        <div data-section-outline-level="1" data-section-layout-level="1"> 
            ...
            <?php $this->assign('coverLocale', $this->_tpl_vars['currentJournal']->getLocalizedSetting($this->_tpl_vars['coverLocale'])); ?>
            <?php if ($this->_tpl_vars['showToc'] && $this->_tpl_vars['currentJournal']->getLocalizedSetting($this->_tpl_vars['coverLocale'])): ?>
            <picture>
...
?as=webp" type="image/webp">
                <img loading="lazy" class="lazyload journal-cover" src="<?php echo $this->_tpl_vars['publicFilesDir']; ?>
/<?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getLocalizedFileName())) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'url')); ?>
" alt="journal cover <?php if ($this->_tpl_vars['currentJournal']->getLocalizedTitle()): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<?php endif; ?>" style="width: 100%; max-width: 230px; display: block;" />
            </picture>
...
<?php endif; ?>" style="width: 100%; max-width: 230px; display: block;" />
        ...
        <div data-section-outline-level="2" data-section-layout-level="1">
            <h2 class="Type-2932877531"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</h2>
            ...
            <dl class="MetaGrid-2932877531">
                <div data-section-outline-level="3"class="Type-270967514" data-section-layout-level="1">
                    ...
                    <dd data-section-outline-level="3">
		                <?php if ($this->_tpl_vars['onlineIssn']): ?> <?php else: ?>
						<?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><span class="item"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
 (Online)</span><?php else: ?><span class="item"><i>on proccess</i> (Online)</span><?php endif; ?>
						<?php endif; ?>
						<?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?>
						<br data-section-outline-level="3"><span class="item"><?php echo $this->_tpl_vars['currentJournal']->getSetting('printIssn'); ?>
 (Print)</span><?php endif; ?>
                    </dd>
                </div>
                <div data-section-outline-level="3" class="Type-2225587032" data-section-layout-level="1">
                    <dt data-section-outline-level="3"><b data-section-outline-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.publicationFrequency"), $this);?>
:</b>
                    </dt>
                    ...
                    <dd data-section-outline-level="3" data-section-layout-level="1">1 Year Publication with <?php echo ((is_array($_tmp=$this->_tpl_vars['issuePerVolume'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 Issues (online to all articles starting <?php echo ((is_array($_tmp=$this->_tpl_vars['firstYear'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
)</dd>
                </div>
                <div data-section-outline-level="3" class="Type-1803463199" data-section-layout-level="1">
                    <dt data-section-outline-level="3" data-section-layout-level="1"><b data-section-outline-level="3" data-section-layout-level="1"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.publicationFrequency"), $this);?>
:</b>
                    </dt>
                    <dd data-section-outline-level="3" data-section-layout-level="1"><?php if ($this->_tpl_vars['onlineIssn']): ?> <?php else: ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?>Online<?php else: ?>Online (<i>on proccess</i>)<?php endif; ?><?php endif; ?><?php if ($this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?> &amp; Print<?php endif; ?></dd>
                </div>         
            </dl>
        </div>
    </div>
    <article style="clear: left" data-section-outline-level="2" data-section-layout-level="1">
        ...
        <p data-section-outline-level="2" class="Type-2678154903" data-section-layout-level="1"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('focusScopeDesc'))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</p>
        <?php else: ?>
        <p data-section-outline-level="2" class="Type-2678154903" data-section-layout-level="1"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 is a NEW journal an bring to index in national and international databases, your published article can be read and cited by researchers worldwide.</p>
        <?php endif; ?>
    </article>
</div>
...
<aside role="complementary" data-section-outline-level="2" class="AsideBox-1834393749" data-section-layout-level="2">
    <div data-section-outline-level="2" data-section-layout-level="2">
        <form data-reflect-state="true" method="post" data-section-outline-level="2" class="SubscribeForm-3185356244" data-section-layout-level="2">
            <?php if ($this->_tpl_vars['currentJournal']->getSetting('publicationFeeName')): ?>
            <details data-section-outline-level="2" class="Details-2932877531" data-section-layout-level="2" open="">
                <summary class="subscription-type NoneDetailsMarker-270967514" data-section-outline-level="2" data-section-layout-level="2">
                    <div data-section-outline-level="2" class="SummaryStyle-2218521826" data-section-layout-level="2"><svg width="14px" height="14px" viewBox="0 0 32 32" class="details-marker Marker-1664207171" data-section-outline-level="2" data-section-layout-level="2"><path fill="inherit" fill-rule="evenodd" d="M11.5 28c-0.38 0-0.76-0.142-1.052-0.432-0.59-0.58-0.598-1.528-0.016-2.118l10.166-9.492-10.162-9.404c-0.584-0.588-0.58-1.538 0.008-2.118 0.59-0.588 1.54-0.578 2.122 0.008l10.86 10.104c0.772 0.776 0.774 2.028 0.006 2.808l-10.862 10.196c-0.294 0.298-0.682 0.448-1.070 0.448z" data-section-outline-level="2" data-section-layout-level="2"></path></svg>
                        <span data-section-outline-level="2" class="SubscriptionName-411063136" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "payment.type.publication"), $this);?>
</span>
                        <span data-section-outline-level="2" class="SummaryPrice-3689769601" data-section-layout-level="2"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('publicationFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
&nbsp;<?php if ($this->_tpl_vars['currentJournal']->getSetting('currency')): ?><?php echo $this->_tpl_vars['currentJournal']->getSetting('currency'); ?>
                    ...
                    <div class="input-field PriceInfoBox-2218521826 checked" style="position: relative" data-section-outline-level="3" data-section-layout-level="3"><input type="radio" id="input-PS-Journal-subscription" class="radio-checked RadioCircle-1664207171" name="subscription-type" value="PS" checked="checked" style="display: none" data-original-index="0" data-section-outline-level="3" data-section-layout-level="4">
                        <label class="price-info Flex-411063136" for="input-PS-Journal-subscription" data-section-outline-level="3" data-section-layout-level="3">
                            <div class="prices-total  TotalPriceRow-3898465696" data-section-outline-level="3" data-section-layout-level="3">
                                ...
                                <div id="effective-price" data-section-outline-level="3" class="BasketEffectivePriceCell-538306978" data-section-layout-level="3"><?php echo ((is_array($_tmp=smarty_function_math(array('equation' => "x + y",'x' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('publicationFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")),'y' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('submissionFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f"))), $this))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", "."));?>
&nbsp;<?php if ($this->_tpl_vars['currentJournal']->getSetting('currency')): ?><?php echo $this->_tpl_vars['currentJournal']->getSetting('currency'); ?>
<?php else: ?>€<?php endif; ?></div>
                                <div class="single-article BasketRegularPriceCell-3978918244" data-section-outline-level="3" data-section-layout-level="3">only <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('submissionFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
&nbsp;<?php if ($this->_tpl_vars['currentJournal']->getSetting('currency')): ?><?php echo $this->_tpl_vars['currentJournal']->getSetting('currency'); ?>
<?php else: ?>€<?php endif; ?> per article</div>
                            </div>
                        </label>
                    </div>
                    <?php if ($this->_tpl_vars['currentJournal']->getSetting('currency')): ?>
                    <button id="subscribe-submit-Journal-subscription" type="submit" data-track="cart-add" data-track-product="0" data-section-outline-level="3" class="ButtonPrimary-171795905" data-section-layout-level="3">
                        <span data-section-outline-level="3" class="ButtonLabel-1664207171" data-section-layout-level="3"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "payment.payNow"), $this);?>
</span>
                    </button>
                    <?php endif; ?>
                    ...
                    <ul class="usps-list ListInset-3866894855" id="usps" data-section-outline-level="4" data-section-layout-level="2">
                        <?php if ($this->_tpl_vars['alternatePageHeader']): ?>
                        <li data-section-outline-level="4" class="ListElement-1664207171" data-section-layout-level="2">Sinta Score <b><?php echo $this->_tpl_vars['alternatePageHeader']; ?>
</b> of this journal</li>
                        <?php endif; ?>
                        ...
                        <li data-section-outline-level="4" class="ListElement-3689769601" data-section-layout-level="2">Total Fees is acumulate of <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('submissionFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
, <?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('publicationFeeName')): ?>plus <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('publicationFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php else: ?>Article Publication<?php endif; ?></li>
                    </ul>
                </article>
            </details>
            <?php endif; ?>
            ...
            <article data-section-outline-level="3" data-section-layout-level="2">
                <div class="input-field PriceInfoBox-2218521826 checked" style="position: relative" data-section-outline-level="3" data-section-layout-level="3"><input type="radio" id="input-PS-Journal-subscription" class="radio-checked RadioCircle-1664207171" name="subscription-type" value="PS" checked="checked" style="display: none" data-original-index="0" data-section-outline-level="3" data-section-layout-level="4">
                    <label class="price-info Flex-411063136" for="input-PS-Journal-subscription" data-section-outline-level="3" data-section-layout-level="3">
                        <div class="prices-total  TotalPriceRow-3898465696" data-section-outline-level="3" data-section-layout-level="3">
                            <div data-section-outline-level="3" class="Type-3344151041" data-section-layout-level="3">Total Fees</div>
                            <div id="effective-price" data-section-outline-level="3" class="BasketEffectivePriceCell-538306978" data-section-layout-level="3"><?php echo ((is_array($_tmp=smarty_function_math(array('equation' => "x + y + z",'x' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('fastTrackFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")),'y' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('submissionFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")),'z' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('submissionFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f"))), $this))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", "."));?>
&nbsp;<?php echo $this->_tpl_vars['currentJournal']->getSetting('currency'); ?>
</div>
                            <div class="single-article BasketRegularPriceCell-3978918244" data-section-outline-level="3" data-section-layout-level="3">only <?php echo ((is_array($_tmp=smarty_function_math(array('equation' => "x - y - z",'x' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('fastTrackFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")),'y' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('publicationFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")),'z' => ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getSetting('submissionFee'))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f"))), $this))) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", "."));?>
&nbsp;<?php echo $this->_tpl_vars['currentJournal']->getSetting('currency'); ?>
 per article</div>
                        </div>
                    </label>
                ...
                <ul class="usps-list ListInset-3866894855" id="usps" data-section-outline-level="4" data-section-layout-level="2">
                    <li data-section-outline-level="4" class="ListElement-1282713543" data-section-layout-level="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('fastTrackFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 coverage for all cost article publication</li>
                    <li data-section-outline-level="4" class="ListElement-4106162086" data-section-layout-level="2"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('fastTrackFeeDescription'))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</li>
                    <li data-section-outline-level="4" class="ListElement-3689769601" data-section-layout-level="2">Total Fees is acumulate of <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('submissionFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
, <?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('publicationFeeName')): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('publicationFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
, <?php else: ?>Article Publication, <?php endif; ?> plus <?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('fastTrackFeeName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</li>
                </ul>                    
            </article>
            <?php else: ?>
...
<?php $this->assign('journalDescription', $this->_tpl_vars['currentJournal']->getLocalizedDescription()); ?>
<?php $this->assign('additionalHomeContent', $this->_tpl_vars['currentJournal']->getLocalizedSetting('additionalHomeContent')); ?>
<?php if ($this->_tpl_vars['currentJournal']->getLocalizedDescription() || $this->_tpl_vars['currentJournal']->getLocalizedSetting('additionalHomeContent')): ?>
<article style="clear:left" data-section-outline-level="2" data-section-layout-level="1" class="descript u-mt-32">
    ...
    <p data-section-outline-level="2" class="Type-2678154903" data-section-layout-level="1"><?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedDescription())) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</p>
    <?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('additionalHomeContent')): ?>
    <p data-section-outline-level="2" class="Type-2678154903" data-section-layout-level="1"><?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('additionalHomeContent'))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</p>
    <?php endif; ?>
</article>
<?php endif; ?>
...
<section class="SubscriberFooter-1037694867">
    <div class="GridLiveArea-2081012695">
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 class="Type-1552298965"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.about"), $this);?>
 <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.people"), $this);?>
</h3>
            <ul class="AboutLink">
            	<li id="editorialTeamLink" class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialTeam'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.editorialTeam"), $this);?>
            	...
            	<?php if ($this->_tpl_vars['peopleGroups']): ?>
            		...
            		<li id="editorialTeamLink" class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'displayMembership','path' => $this->_tpl_vars['peopleGroup']->getId()), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['peopleGroup']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
            	...
            	<?php if (! ( empty ( $this->_tpl_vars['journalSettings']['mailingAddress'] ) && empty ( $this->_tpl_vars['journalSettings']['contactName'] ) && empty ( $this->_tpl_vars['journalSettings']['contactAffiliation'] ) && empty ( $this->_tpl_vars['journalSettings']['contactMailingAddress'] ) && empty ( $this->_tpl_vars['journalSettings']['contactPhone'] ) && empty ( $this->_tpl_vars['journalSettings']['contactFax'] ) && empty ( $this->_tpl_vars['journalSettings']['contactEmail'] ) && empty ( $this->_tpl_vars['journalSettings']['supportName'] ) && empty ( $this->_tpl_vars['journalSettings']['supportPhone'] ) && empty ( $this->_tpl_vars['journalSettings']['supportEmail'] ) )): ?>
            		<li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'contact'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.contact.supportContact"), $this);?>
</a></li>
            	<?php endif; ?>
        	</ul>
        	<h3 class="Type-1552298965"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.contact.supportContact"), $this);?>
</h3>
        	<p class="FooterLink-2407621270"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.email"), $this);?>
: <a href="mailto:journals@sangia.org" data-section-outline-level="3" data-section-layout-level="2">journals@sangia.org</a></p>
        	<p class="Type-269378647"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.phone"), $this);?>
: +6285343880383</p>
            <p data-section-outline-level="3" class="Type-851350800" data-section-layout-level="2">Hours: 24 hours a day, 7 days a week</p>
        </section>
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 data-section-outline-level="3" class="Type-1552298965" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.editorialPolicies"), $this);?>
</h3>
            <ul class="Link">
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('focusScopeDesc') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'focusAndScope'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.focusAndScope"), $this);?>
</a></li><?php endif; ?>
            	<li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'sectionPolicies'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.sectionPolicies"), $this);?>
</a></li>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('reviewPolicy') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'peerReviewProcess'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.peerReviewProcess"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('pubFreqPolicy') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'publicationFrequency'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.publicationFrequency"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getSetting('publishingMode') == @PUBLISHING_MODE_OPEN && $this->_tpl_vars['currentJournal']->getLocalizedSetting('openAccessPolicy') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'openAccessPolicy'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.openAccessPolicy"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['journalSettings']['enableLockss'] && $this->_tpl_vars['currentJournal']->getLocalizedSetting('lockssLicense') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'archiving'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.archiving"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['paymentConfigured'] && $this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['membershipFeeEnabled'] && $this->_tpl_vars['journalSettings']['membershipFee'] > 0): ?><li class="u-hide Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'memberships'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.memberships"), $this);?>
            	...
            	<?php if ($this->_tpl_vars['currentJournal']->getSetting('publishingMode') == @PUBLISHING_MODE_SUBSCRIPTION): ?>
            		<li class="u-hide Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.subscriptions"), $this);?>
</a></li>
            		<?php if (! empty ( $this->_tpl_vars['journalSettings']['enableAuthorSelfArchive'] )): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'authorSelfArchivePolicy'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.authorSelfArchive"), $this);?>
</a></li><?php endif; ?>
            		<?php if (! empty ( $this->_tpl_vars['journalSettings']['enableDelayedOpenAccess'] )): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'delayedOpenAccessPolicy'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.delayedOpenAccess"), $this);?>
</a></li><?php endif; ?>
            		<?php if ($this->_tpl_vars['paymentConfigured'] && $this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['acceptSubscriptionPayments'] && $this->_tpl_vars['journalSettings']['purchaseIssueFeeEnabled'] && $this->_tpl_vars['journalSettings']['purchaseIssueFee'] > 0): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'purchaseIssue'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.purchaseIssue"), $this);?>
</a></li><?php endif; ?>
            		<?php if ($this->_tpl_vars['paymentConfigured'] && $this->_tpl_vars['journalSettings']['journalPaymentsEnabled'] && $this->_tpl_vars['journalSettings']['acceptSubscriptionPayments'] && $this->_tpl_vars['journalSettings']['purchaseArticleFeeEnabled'] && $this->_tpl_vars['journalSettings']['purchaseArticleFee'] > 0): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'purchaseArticle'), $this);?>
...
?>
            		<?php if ($this->_tpl_vars['customAboutItem']['title'] != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => "custom-".($this->_tpl_vars['key'])), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['customAboutItem']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
        ...
        <section data-section-outline-level="3" data-section-layout-level="2">
            <h3 data-section-outline-level="3" class="Type-1552298965" data-section-layout-level="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.submissions"), $this);?>
</h3>
            <ul class="Link">
            	<li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'onlineSubmissions'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.onlineSubmissions"), $this);?>
</a></li>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('authorGuidelines') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'authorGuidelines'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.authorGuidelines"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('copyrightNotice') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'copyrightNotice'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.copyrightNotice"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('privacyStatement') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'privacyStatement'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getSetting('journalPaymentsEnabled') && ( $this->_tpl_vars['currentJournal']->getSetting('submissionFeeEnabled') || $this->_tpl_vars['currentJournal']->getSetting('fastTrackFeeEnabled') || $this->_tpl_vars['currentJournal']->getSetting('publicationFeeEnabled') )): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'authorFees'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.authorFees"), $this);?>
            ...
            <h3 class="Type-1552298965"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.other"), $this);?>
</h3>
            <ul class="Link">
            	<?php if (! ( $this->_tpl_vars['currentJournal']->getSetting('publisherInstitution') == '' && $this->_tpl_vars['currentJournal']->getLocalizedSetting('publisherNote') == '' && $this->_tpl_vars['currentJournal']->getLocalizedSetting('contributorNote') == '' && empty ( $this->_tpl_vars['journalSettings']['contributors'] ) && $this->_tpl_vars['currentJournal']->getLocalizedSetting('sponsorNote') == '' && empty ( $this->_tpl_vars['journalSettings']['sponsors'] ) )): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'journalSponsorship'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.journalSponsorship"), $this);?>
</a></li><?php endif; ?>
            	<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('history') != ''): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'history'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.history"), $this);?>
</a></li><?php endif; ?>
            	<li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'sitemap'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.siteMap"), $this);?>
</a></li>
            	<li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'insights'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.journalInsight"), $this);?>
</a></li>
            	<?php if ($this->_tpl_vars['publicStatisticsEnabled']): ?><li class="Link-2407621270"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'statistics'), $this);?>
...
<section class="u-hide content">
    <div id="aboutPeople">
        <h2><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.people"), $this);?>
</h2>
        <ul>
        	<?php if (! ( empty ( $this->_tpl_vars['journalSettings']['mailingAddress'] ) && empty ( $this->_tpl_vars['journalSettings']['contactName'] ) && empty ( $this->_tpl_vars['journalSettings']['contactAffiliation'] ) && empty ( $this->_tpl_vars['journalSettings']['contactMailingAddress'] ) && empty ( $this->_tpl_vars['journalSettings']['contactPhone'] ) && empty ( $this->_tpl_vars['journalSettings']['contactFax'] ) && empty ( $this->_tpl_vars['journalSettings']['contactEmail'] ) && empty ( $this->_tpl_vars['journalSettings']['supportName'] ) && empty ( $this->_tpl_vars['journalSettings']['supportPhone'] ) && empty ( $this->_tpl_vars['journalSettings']['supportEmail'] ) )): ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['peopleGroup']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
    ...
    <div id="aboutPolicies">
        <h2><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.policies"), $this);?>
</h2>
        <ul>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['customAboutItem']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
    ...
    <div id="aboutSubmissions">
        <h2><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.submissions"), $this);?>
</h2>
        <ul>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.authorFees"), $this);?>
    ...
    <div id="aboutOther">
        <h2><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.other"), $this);?>
</h2>
        <ul>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.siteMap"), $this);?>
        	...
        	<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'insights'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.journalInsight"), $this);?>
</a></li>
