<?php /* Smarty version 2.6.26, created on 2026-04-12 01:12:10
         compiled from admin/paymentSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'admin/paymentSettings.tpl', 15, false),array('modifier', 'escape', 'admin/paymentSettings.tpl', 17, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "payment.gatewaySettings"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'admin','op' => "save-payment-settings"), $this);?>
">
