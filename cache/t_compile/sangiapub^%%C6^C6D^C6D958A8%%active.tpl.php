<?php /* Smarty version 2.6.26, created on 2026-04-04 14:22:02
         compiled from author/active.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_heading', 'author/active.tpl', 15, false),array('function', 'translate', 'author/active.tpl', 16, false),array('function', 'url', 'author/active.tpl', 33, false),array('function', 'page_info', 'author/active.tpl', 99, false),array('function', 'page_links', 'author/active.tpl', 100, false),array('block', 'iterate', 'author/active.tpl', 23, false),array('modifier', 'escape', 'author/active.tpl', 28, false),array('modifier', 'date_format', 'author/active.tpl', 29, false),array('modifier', 'truncate', 'author/active.tpl', 31, false),array('modifier', 'strip_tags', 'author/active.tpl', 33, false),array('modifier', 'strip_unsafe_html', 'author/active.tpl', 80, false),array('modifier', 'nl2br', 'author/active.tpl', 80, false),)), $this); ?>
<div id="submissions">
...
" class="action"><?php if ($this->_tpl_vars['submission']->getLocalizedTitle()): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : PKPString::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.untitled"), $this);?>
<?php endif; ?></a></td>
