<?php /* Smarty version 2.6.26, created on 2026-04-04 06:08:33
         compiled from common/header-HOME.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'common/header-HOME.tpl', 2, false),array('modifier', 'assign', 'common/header-HOME.tpl', 13, false),array('modifier', 'escape', 'common/header-HOME.tpl', 22, false),array('modifier', 'strip_tags', 'common/header-HOME.tpl', 26, false),array('modifier', 'nl2br', 'common/header-HOME.tpl', 26, false),array('function', 'translate', 'common/header-HOME.tpl', 13, false),array('function', 'call_hook', 'common/header-HOME.tpl', 48, false),array('function', 'url', 'common/header-HOME.tpl', 93, false),)), $this); ?>
<!DOCTYPE html>
...
" />
    <?php if (((is_array($_tmp=$this->_tpl_vars['metaSearchDescription'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))): ?>
...
" />
	...
	<meta name="description" content="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['journalDescription'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
" />
	<?php endif; ?>
	<?php if (((is_array($_tmp=$this->_tpl_vars['metaSearchKeywords'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))): ?>
...
" />
    ...
    <?php if ($this->_tpl_vars['metaCustomHeaders']): ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/priceupdate.js"></script>
