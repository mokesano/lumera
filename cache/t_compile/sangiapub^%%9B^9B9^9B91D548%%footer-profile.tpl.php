<?php /* Smarty version 2.6.26, created on 2026-04-04 05:39:18
         compiled from common/footer-parts/footer-profile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'call_hook', 'common/footer-parts/footer-profile.tpl', 21, false),array('function', 'translate', 'common/footer-parts/footer-profile.tpl', 25, false),array('function', 'url', 'common/footer-parts/footer-profile.tpl', 161, false),array('function', 'get_debug_info', 'common/footer-parts/footer-profile.tpl', 209, false),array('modifier', 'escape', 'common/footer-parts/footer-profile.tpl', 25, false),array('modifier', 'regex_replace', 'common/footer-parts/footer-profile.tpl', 25, false),array('modifier', 'strip_unsafe_html', 'common/footer-parts/footer-profile.tpl', 49, false),array('modifier', 'nl2br', 'common/footer-parts/footer-profile.tpl', 49, false),array('modifier', 'strip_tags', 'common/footer-parts/footer-profile.tpl', 53, false),array('modifier', 'assign', 'common/footer-parts/footer-profile.tpl', 173, false),array('modifier', 'date_format', 'common/footer-parts/footer-profile.tpl', 176, false),)), $this); ?>
...
<?php endif; ?></p>
            ...
            <div class="u-mt-16 u-mb-16">
                <div class="u-container">
                    <p class="c-meta u-ma-0">Top headline image: <?php if ($this->_tpl_vars['homepageImageAltText'] != ''): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['homepageImageAltText'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
        ...
        <div class="c-corporate-footer u-font-sans" role="contentinfo"> 
            <div id="pageFooter" class="u-container">
                <div class="sangia-footer text-xs u-padding-l-ver ">
                    <div class="sangia-footer-sangia u-margin-m-bottom u-margin-0-bottom-from-md u-margin-s-right u-margin-m-right-from-md u-margin-l-right-from-lg">
                        <picture>
                            ...
                            <img loading="lazy" src="//assets.sangia.org/img/sangia-mono-branded-72x89-v2.svg" alt="Sangia Publishing Group" width="68" height="auto" />
                        </picture>
                    </div>
                    <div id="standardFooter" class="sangia-footer-content u-margin-l-right-from-lg u-margin-m-right-from-md">
                        ...
                        <p class="sangia-ads">We use cookies to enhance our service and ads. By using this website, you agree to our <a class="anchor" href="/ISLE/pages/view/Terms%20and%20Conditions"><span class="anchor-text">Terms and Conditions</span></a>, <a class="anchor" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','anchor' => 'privacyStatement'), $this);?>
"><span class="anchor-text"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
</span></a> and <a class="anchor" href="/ISLE/pages/view/Cookies"><span class="anchor-text">Cookies</span></a> policy.</p>
                        ...
                        <p class="sangia-lisensing u-hide" style="margin-bottom:0">
                            <?php if ($this->_tpl_vars['currentJuornal']): ?>
...
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
 ...
 <a class="anchor" href="//publishing.sangia.org" target="_blank"><span class="anchor-text">Sangia Publishing</span></a> unless otherwise stated. Part of <a class="anchor" href="//www.insw.go.id/nib" target="_blank"><span class="anchor-text">Sangia Research Media and Publishing</span></a> | NIB: 1111220205313.</p>
    ...
    <button class="StickySideButton StickySideButton--feedback lazyload" onclick="FreshWidget.show();">Support<img loading="lazy" alt="" src="//assets.sangia.org/image/classical/freshdesk-support.png" /></button>

    <script src="https://cdn.jsdelivr.net/npm/chart.js" type="text/javascript" referrerpolicy="strict-origin-when-cross-origin"></script>
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js" type="text/javascript" referrerpolicy="strict-origin-when-cross-origin"></script>
    
    <script src="//sangia.org/assets/js/chart.js" type="text/javascript"></script>
    
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/sintaScore.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/editor_scopus.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/lazyload.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/sangiastyle.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/assets/js/editorgender.js" type="text/javascript"></script>
