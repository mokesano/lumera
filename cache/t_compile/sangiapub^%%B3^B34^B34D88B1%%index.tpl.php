<?php /* Smarty version 2.6.26, created on 2026-04-05 22:28:23
         compiled from user/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/index.tpl', 25, false),array('function', 'translate', 'user/index.tpl', 25, false),array('function', 'call_hook', 'user/index.tpl', 34, false),array('modifier', 'escape', 'user/index.tpl', 95, false),array('modifier', 'assign', 'user/index.tpl', 256, false),array('modifier', 'date_format', 'user/index.tpl', 923, false),)), $this); ?>
            ...
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Manage Editorial Systems" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => 'index','page' => $this->_tpl_vars['isSiteAdmin']->getRolePath()), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => $this->_tpl_vars['isSiteAdmin']->getRoleName()), $this);?>
</a>
                        </h2>
...
?>
        ...
        <?php if ($this->_tpl_vars['currentJournal']): ?><?php if ($this->_tpl_vars['isValid']['JournalManager'][$this->_tpl_vars['journalId']]): ?>
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Manage Editorial Systems" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'manager'), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.manager"), $this);?>
</a>
                        </h2>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Manage Editorial Systems" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'subscriptionManager'), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.subscriptionManager"), $this);?>
</a>
                        </h2>
...
<section class="old-dashboard account-container__section<?php if ($this->_tpl_vars['currentJournal']): ?> u-js-hide<?php endif; ?>">
<div id="myJournals" class="block">
<?php if (! $this->_tpl_vars['currentJournal']): ?><h3 class="u-h2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.myJournals"), $this);?>
</h3><?php endif; ?>

<?php $_from = $this->_tpl_vars['userJournals']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['journal']):
?>
	<div id="<?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getPath())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="block">
	<?php $this->assign('hasRole', 1); ?>
	<?php if (! $this->_tpl_vars['currentJournal']): ?><h4 class="u-h2"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journal']->getPath(),'page' => 'user'), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<?php else: ?><h3 class="u-h2"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'index'), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</a></h3><?php endif; ?>
    	...
    	<ul class="account-container__grid">
            ...
            <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
                <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                    <div class="eds-c-card-composable__body">
                        <div class="eds-c-card-composable__content">
                            <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'become','path' => 'author','source' => $this->_tpl_vars['submitUrl']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticle"), $this);?>
            ...
            <?php else: ?>            <li><article class="eds-c-card-composable">
                <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                    <div class="eds-c-card-composable__body">
                        <div class="eds-c-card-composable__content">
                            <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="javascript:void(0)"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticle"), $this);?>
</a>
                            </h3>
                            <p class="eds-c-card-composable__summary"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticleRegClosed"), $this);?>
</p>
                        </div>
                    </div>
                    <div class="eds-c-card-composable__icon-container"><svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 3H8.2C7.0799 3 6.51984 3 6.09202 3.21799C5.71569 3.40973 5.40973 3.71569 5.21799 4.09202C5 4.51984 5 5.0799 5 6.2V17.8C5 18.9201 5 19.4802 5.21799 19.908C5.40973 20.2843 5.71569 20.5903 6.09202 20.782C6.51984 21 7.0799 21 8.2 21H10M13 3L19 9M13 3V7.4C13 7.96005 13 8.24008 13.109 8.45399C13.2049 8.64215 13.3578 8.79513 13.546 8.89101C13.7599 9 14.0399 9 14.6 9H19M19 9V10M14 21L16.025 20.595C16.2015 20.5597 16.2898 20.542 16.3721 20.5097C16.4452 20.4811 16.5147 20.4439 16.579 20.399C16.6516 20.3484 16.7152 20.2848 16.8426 20.1574L21 16C21.5523 15.4477 21.5523 14.5523 21 14C20.4477 13.4477 19.5523 13.4477 19 14L14.8426 18.1574C14.7152 18.2848 14.6516 18.3484 14.601 18.421C14.5561 18.4853 14.5189 18.5548 14.4903 18.6279C14.458 18.7102 14.4403 18.7985 14.405 18.975L14 21Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticle"), $this);?>
            ...
            <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
                <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                    <div class="eds-c-card-composable__body">
                        <div class="eds-c-card-composable__content">
                            <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'become','path' => 'reviewer','source' => $this->_tpl_vars['userHomeUrl']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.regReviewer"), $this);?>
            ...
            <?php else: ?>            <li><article class="eds-c-card-composable">
                <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                    <div class="eds-c-card-composable__body">
                        <div class="eds-c-card-composable__content">
                            <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="javascript:void(0)"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.regReviewer"), $this);?>
</a>
                            </h3>
                            <p class="eds-c-card-composable__summary"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.regReviewerClosed"), $this);?>
</p>
                        </div>
                    </div>
                    <div class="eds-c-card-composable__icon-container"><svg class="eds-c-card-composable__icon" aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="currentColor"><path d="M9 1a5 5 0 1 1 0 10A5 5 0 0 1 9 1Zm6 0a5 5 0 0 1 0 10 1 1 0 0 1-.117-1.993L15 9a3 3 0 0 0 0-6 1 1 0 0 1 0-2ZM9 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm8.857 9.545a7.99 7.99 0 0 1 2.651 1.715A8.31 8.31 0 0 1 23 20.134V21a1 1 0 0 1-1 1h-3a1 1 0 0 1 0-2h1.995l-.005-.153a6.307 6.307 0 0 0-1.673-3.945l-.204-.209a5.99 5.99 0 0 0-1.988-1.287 1 1 0 1 1 .732-1.861Zm-3.349 1.715A8.31 8.31 0 0 1 17 20.134V21a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-.877c.044-4.343 3.387-7.908 7.638-8.115a7.908 7.908 0 0 1 5.87 2.252ZM9.016 14l-.285.006c-3.104.15-5.58 2.718-5.725 5.9L3.004 20h11.991l-.005-.153a6.307 6.307 0 0 0-1.673-3.945l-.204-.209A5.924 5.924 0 0 0 9.3 14.008L9.016 14Z" /></svg>
...
<?php if ($this->_tpl_vars['hasRole'] && $this->_tpl_vars['currentJournal']): ?>
<?php $_from = $this->_tpl_vars['userJournals']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['journal']):
?>
    ...
    <ul class="account-container__grid">
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Editorial tasks" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor'), $this);?>
">Editorial tasks</a>
                        </h3>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissions','path' => 'submissionsUnassigned'), $this);?>
" target="_blank">Submission Unassigned</a>
                        </h3>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissions','path' => 'submissionsInReview'), $this);?>
" target="_blank">Submission In Review</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published articles and access performance metrics and readership statistics.</p>
                    </div>
                </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissions','path' => 'submissionsInEditing'), $this);?>
">Submission In Editing</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published articles and access performance metrics and readership statistics.</p>
                    </div>
                </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'createIssue'), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.issues.createIssue"), $this);?>
</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published articles and access performance metrics and readership statistics.</p>
                    </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'notifyUsers'), $this);?>
" target="_blank"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.notifyUsers"), $this);?>
</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published articles and access performance metrics and readership statistics.</p>
                    </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Editorial tasks" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.sectionEditor"), $this);?>
 tasks</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">Oversee editorial decisions, manage submissions, and coordinate the peer review process.</p>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsInReview'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.sectionEditor"), $this);?>
: <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInReview"), $this);?>
</a>
                        </h3>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsInEditing'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.sectionEditor"), $this);?>
: <?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInEditing"), $this);?>
</a>
                        </h3>
        ...
        <?php endif; ?>
        <?php endif; ?>        <?php if ($this->_tpl_vars['isValid']['LayoutEditor'][$this->_tpl_vars['journalId']]): ?>
        <?php $this->assign('layoutEditorSubmissionsCount', $this->_tpl_vars['submissionsCount']['LayoutEditor'][$this->_tpl_vars['journalId']]); ?>
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Editorial tasks" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'layoutEditor'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.layoutEditor"), $this);?>
 tasks:</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">Oversee editorial decisions, manage submissions, and coordinate the peer review process.</p>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Editorial tasks" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'copyeditor'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.copyeditor"), $this);?>
 tasks:</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">Oversee editorial decisions, manage submissions, and coordinate the peer review process.</p>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'proofreader'), $this);?>
">Proofread</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published<?php if ($this->_tpl_vars['proofreaderSubmissionsCount'][0]): ?> <?php echo $this->_tpl_vars['proofreaderSubmissionsCount'][0]; ?>
<?php endif; ?> articles and access performance metrics and readership statistics.</p>
                    </div>
                </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer'), $this);?>
">Peer review</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">Manage assigned <?php if ($this->_tpl_vars['reviewerSubmissionsCount'][0]): ?><?php echo $this->_tpl_vars['reviewerSubmissionsCount'][0]; ?>
 <?php endif; ?>manuscript reviews and submit your expert evaluations and recommendations.</p>
                    </div>
                </div>
                <div class="eds-c-card-composable__icon-container"><svg class="eds-c-card-composable__icon" aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="currentColor"><path d="M9 1a5 5 0 1 1 0 10A5 5 0 0 1 9 1Zm6 0a5 5 0 0 1 0 10 1 1 0 0 1-.117-1.993L15 9a3 3 0 0 0 0-6 1 1 0 0 1 0-2ZM9 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm8.857 9.545a7.99 7.99 0 0 1 2.651 1.715A8.31 8.31 0 0 1 23 20.134V21a1 1 0 0 1-1 1h-3a1 1 0 0 1 0-2h1.995l-.005-.153a6.307 6.307 0 0 0-1.673-3.945l-.204-.209a5.99 5.99 0 0 0-1.988-1.287 1 1 0 1 1 .732-1.861Zm-3.349 1.715A8.31 8.31 0 0 1 17 20.134V21a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-.877c.044-4.343 3.387-7.908 7.638-8.115a7.908 7.908 0 0 1 5.87 2.252ZM9.016 14l-.285.006c-3.104.15-5.58 2.718-5.725 5.9L3.004 20h11.991l-.005-.153a6.307 6.307 0 0 0-1.673-3.945l-.204-.209A5.924 5.924 0 0 0 9.3 14.008L9.016 14Z" /></svg>
                </div>
...
<?php $this->assign('authorSubmissionsCount', $this->_tpl_vars['submissionsCount']['Author'][$this->_tpl_vars['journalId']]); ?>
<section class="account-container__section">
    <h2 class="u-h2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.author"), $this);?>
 work: <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author'), $this);?>
">Dashboard</a></h2>
    <ul class="account-container__grid">
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Submission in progress" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'path' => 'active','page' => 'author'), $this);?>
">Submission in progress</a>
                        </h3>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Track your research" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author'), $this);?>
">Track your research</a>
                        </h2>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Published work" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'path' => 'completed','page' => 'author'), $this);?>
" target="_blank">Published work</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">View your published <?php echo $this->_tpl_vars['authorSubmissionsCount'][1]; ?>
 articles and access performance metrics and readership statistics.</p>
                    </div>
                </div>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Your work" data-track-value="Peer review" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','op' => 'submit'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit"), $this);?>
</a>
                        </h3>
                        <p class="eds-c-card-composable__summary">Manage assigned manuscript reviews and submit your expert evaluations and recommendations.</p>
...
<?php endif; ?>
<div class="account-container__section">
    <h1 class="u-h2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.myAccount"), $this);?>
</h1>
    <ul class="account-container__grid">
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Manage your account" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => "update-profile"), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.editMyProfile"), $this);?>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h3 class="eds-c-card-composable__title"><a data-track="click_manage_your_account_item" data-track-context="my-profile_manage-your-account" data-track-label="Settings" data-track-value="Password" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'changePassword'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.changeMyPassword"), $this);?>
        ...
        <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
            <div class="eds-c-card-composable__body">
                <div class="eds-c-card-composable__content">
                    <h3 class="eds-c-card-composable__title"><a data-track="click_manage_your_account_item" data-track-context="my-profile_manage-your-account" data-track-label="Settings" data-track-value="Linked accounts" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => "linked-accounts"), $this);?>
" >Linked accounts</a>
                    </h3>
        ...
        <?php if ($this->_tpl_vars['currentJournal']): ?><?php if ($this->_tpl_vars['subscriptionsEnabled']): ?>
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Subscription and purchases" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'subscriptions'), $this);?>
">Subscriptions and purchases</a>
                        </h2>
        ...
        <?php endif; ?><?php endif; ?>
        <?php if ($this->_tpl_vars['currentJournal']): ?><?php if ($this->_tpl_vars['acceptGiftPayments']): ?>
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Subscription and purchases" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'gifts'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "gifts.manageMyGifts"), $this);?>
        ...
        <li><article class="eds-c-card-composable eds-c-card-composable--faux-link">
            <div class="eds-c-card-composable__container eds-c-card-composable__container--with-sidebar">
                <div class="eds-c-card-composable__body">
                    <div class="eds-c-card-composable__content">
                        <h2 class="eds-c-card-composable__title"><a data-track="click_myprofile_homepage" data-track-context="my-profile_homepage" data-track-label="Account" data-track-value="Subscription and purchases" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'payMembership'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "payment.membership.renewMembership"), $this);?>
</a>
                        </h2>
                        <p class="eds-c-card-composable__summary">(<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "payment.membership.ends"), $this);?>
