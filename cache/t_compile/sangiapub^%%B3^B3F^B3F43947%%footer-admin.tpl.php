<?php /* Smarty version 2.6.26, created on 2026-04-04 14:38:18
         compiled from common/footer-parts/footer-admin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'common/footer-parts/footer-admin.tpl', 21, false),array('modifier', 'escape', 'common/footer-parts/footer-admin.tpl', 21, false),array('modifier', 'assign', 'common/footer-parts/footer-admin.tpl', 140, false),array('modifier', 'date_format', 'common/footer-parts/footer-admin.tpl', 143, false),array('function', 'translate', 'common/footer-parts/footer-admin.tpl', 29, false),array('function', 'url', 'common/footer-parts/footer-admin.tpl', 128, false),array('function', 'call_hook', 'common/footer-parts/footer-admin.tpl', 157, false),array('function', 'get_debug_info', 'common/footer-parts/footer-admin.tpl', 173, false),)), $this); ?>
        </div>
    </main>
...
" target="_blank"><span class="anchor-text"><?php echo $this->_tpl_vars['currentJournal']->getSetting('onlineIssn'); ?>
 ...
 <a class="anchor" href="//www.publishing.sangia.org" target="_blank"><span class="anchor-text">Sangia Publishing</span></a> unless otherwise stated. Part of <a class="anchor" href="//www.insw.go.id/nib" target="_blank"><span class="anchor-text">Sangia Research Media and Publishing</span></a> | NIB: 1111220205313.</p>
                    ...
                    <div class="sangia-footer u-margin-0-top u-margin-m-top-from-xs u-margin-0-top-from-md"><a aria-label="Sangia Research Media home page (opens in a new tab)" href="//www.publishing.sangia.org/" target="_blank" rel="nofollow"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="93px" height="22px" viewBox="0 0 93 22" enable-background="new 0 0 93 22" xml:space="preserve"><image id="image0" width="93" height="22" x="0" y="0" href="//assets.sangia.org/image/sangia.png" class="lazyload" /></svg></a></div>
                </div>
            </div>
        </div>
