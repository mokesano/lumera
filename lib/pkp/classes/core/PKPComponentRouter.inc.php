...
class PKPComponentRouter extends PKPRouter {
    ...
    public function getRequestedComponent($request) {
        if (is_null($this->_component)) {
            ...
            $rpcServiceEndpointParts = $this->_getValidatedServiceEndpointParts($request);
    ...
    public function _getValidatedServiceEndpointParts($request) {
        if ($this->_rpcServiceEndpointParts === false) {
            ...
            $rpcServiceEndpointParts = $this->_retrieveServiceEndpointParts($request);
            if (is_null($rpcServiceEndpointParts)) {
            ...
            $rpcServiceEndpointParts = $this->_validateServiceEndpointParts($rpcServiceEndpointParts);
            if (is_null($rpcServiceEndpointParts)) {
                // Invalid request
                return null;
            }
