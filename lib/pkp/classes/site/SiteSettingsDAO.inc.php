...
class SiteSettingsDAO extends DAO {
    ...
    public function SiteSettingsDAO() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::SiteSettingsDAO(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
     ...
     * @return string
     */
    public function _performReplacement($rawInput, $paramArray = array()) {
     ...
     * @return void
     */
    public function installSettings($filename, $paramArray = array()) {
