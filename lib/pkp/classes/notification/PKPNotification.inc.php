...
class PKPNotification extends DataObject {
     ...
     * @param string $dateCreated string (YYYY-MM-DD HH:MM:SS)
     */
     ...
     * @param string $dateRead string (YYYY-MM-DD HH:MM:SS)
     */
