 ...
 *
 * @brief Handle requests for journal article submission.
 *
 * [WIZDAM] Dipindahkan dari pages/author/SubmitHandler.inc.php ke
 * pages/submission/ -- skema URL yang lebih rasional dan agnostik
 * terhadap peran (submission bukan konsep eksklusif milik role
 * "author" semata).
 */
